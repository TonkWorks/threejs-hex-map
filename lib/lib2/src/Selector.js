define(["require", "exports", "three", "./util"], function (require, exports, three_1, util_1) {
    ...
    exports.WhiteOutline = exports.LightOfGod = exports.Selectors = void 0;
    exports.Selectors = [];
        ...
        radiusTop = 0.2, radiusBottom = .2) {
            ...
            for (let i = 0; i < shaftCount; i++) {
                ...
                const material = new three_1.MeshBasicMaterial({
                    ...
                    blending: three_1.AdditiveBlending, // Helps get a nice “light” look
    ...
    class WhiteOutline {
        constructor() {
            this.group = new three_1.Group();
            const selector = new three_1.Mesh(new three_1.RingBufferGeometry(0.9, 1, 6, -.6), new three_1.MeshStandardMaterial({
                color: 0xffffff,
                transparent: true,
                opacity: 0.75,
                emissive: 0xffffff,
    ...
    exports.WhiteOutline = WhiteOutline;
