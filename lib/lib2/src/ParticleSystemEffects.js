define(["require", "exports", "three", "./ParticleSystem"], function (require, exports, three_1, ParticleSystem_1) {
    ...
    exports.MeshSurfaceSampler = exports.createSpotlightEffect = exports.NuclearExplosion = exports.Rocket = exports.Explosion = void 0;
    ...
    verticalDrift = 0.2 // Base upward speed for the initial dust kick
    ) {
        ...
        const selectParticle = new ParticleSystem_1.ParticleSystem(scene, {
            ...
            onSpawn: (system, deltaTime) => {
                ...
                for (let i = 0; i < spawnCount; i++) {
                    ...
                    const initialVelocity = new three_1.Vector3((Math.random() - 0.5) * 0.2, // random horizontal (x)
                    ...
                    system.addParticle({
                        ...
                        startColor: new three_1.Color(1, 1, 0.8),
