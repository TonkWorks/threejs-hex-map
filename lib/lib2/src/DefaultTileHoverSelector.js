define(["require", "exports", "three"], function (require, exports, three_1) {
    ...
    exports.AttackArrow = exports.DefaultTileHoverSelector = exports.hoverSelectorMaterial = void 0;
    ...
    class AttackArrow {
        ...
        createCurveMesh() {
            ...
            const curveGeometry = new three_1.ExtrudeGeometry(shape, {
                steps: this.steps,
                bevelEnabled: false,
                extrudePath: new three_1.CatmullRomCurve3(points.slice(0, -1)), // Stop before the final point
            });
            // Create material and mesh
            const curveMaterial = new three_1.MeshBasicMaterial({
                color: this.color,
                // map: texture,
                // transparent: true,
