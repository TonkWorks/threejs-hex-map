    ...
    class MapView {
        ...
        endTurn() {
            ...
            for (const [key, number] of Object.entries(resources)) {
                player.gold += Units_1.ResourceMap[key].gold * number;
            }
