...
define(["require", "exports", "three"], function (require, exports, THREE) {
    ...
    class ThickLine extends THREE.Mesh {
        ...
        constructor(points, parameters = {}) {
            ...
            const resolution = parameters.resolution !== undefined
                ? parameters.resolution
                : new THREE.Vector2(window.innerWidth, window.innerHeight);
            const color = parameters.color !== undefined ? new THREE.Color(parameters.color) : new THREE.Color(0xffffff);
    ...
    exports.ThickLine = ThickLine;
});
//# sourceMappingURL=thickLine.js.map
//# sourceMappingURL=thickLine.js.map