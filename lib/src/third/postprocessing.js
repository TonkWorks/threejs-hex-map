...
var POSTPROCESSING = (() => {
    ...
    var GlitchEffect = class extends Effect {
        constructor({ blendFunction = BlendFunction.NORMAL, chromaticAberrationOffset = null, delay = new import_three41.Vector2(1.5, 3.5), duration = new import_three41.Vector2(0.6, 1), strength = new import_three41.Vector2(0.3, 1), columns = 0.05, ratio = 0.85, perturbationMap = null, dtSize = 64 } = {}) {
    ...
    var ShockWaveEffect = class extends Effect {
        constructor(camera, epicenter = new import_three51.Vector3(), { speed = 2, maxRadius = 1, waveSize = 0.2, amplitude = 0.05 } = {}) {
