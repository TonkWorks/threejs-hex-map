define(["require", "exports"], function (require, exports) {
    ...
    class Toastify {
        constructor(options) {
            ...
            const instance = Object.create(Toastify.lib);
    ...
    Toastify.lib = {
        ...
        init: function (options) {
            ...
            this.options.style = options.style || Object.assign({}, Toastify.defaults.style);
            if (options.backgroundColor) {
                this.options.style = Object.assign(Object.assign({}, this.options.style), { background: options.backgroundColor });
            }
            return this;
        },
        buildToast: function () {
        ...
        showToast: function () {
            ...
            if (typeof this.options.selector === "string") {
                ...
                this.options.selector instanceof window.ShadowRoot) {
                rootElement = this.options.selector;
            }
            else {
