                ...
                */
                ...
                function getConstOrRandomVector(constValOrRandomizer, returnNullIfUndefined) {
                    if (!constValOrRandomizer)
                        return (returnNullIfUndefined) ? null : new THREE.Vector3();
                    if (constValOrRandomizer.generate)
                ...
                function getConstOrRandomColor(constValOrRandomizer, returnNullIfUndefined) {
                    if (!constValOrRandomizer)
                        return (returnNullIfUndefined) ? null : new THREE.Color(1, 1, 1);
                    if (constValOrRandomizer.generate)
                        return constValOrRandomizer.generate();
                    return constValOrRandomizer.clone();
                }
                ...
                */
                ...
                module.exports = {
                    ...
                    getRandomColorBetween: function (colMin, colMax) {
                        ...
                        return new THREE.Color(this.getRandomBetween(colMin.r, colMax.r), this.getRandomBetween(colMin.g, colMax.g), this.getRandomBetween(colMin.b, colMax.b));
                    },
                    /**
                    ...
                    getRandomVectorBetween: function (vecMin, vecMax) {
                        if (!vecMax) {
                            return vecMin ? vecMin.clone() : new THREE.Vector3();
                        }
                        return new THREE.Vector3(this.getRandomBetween(vecMin.x, vecMax.x), this.getRandomBetween(vecMin.y, vecMax.y), this.getRandomBetween(vecMin.z, vecMax.z));
                    },
                    /**
