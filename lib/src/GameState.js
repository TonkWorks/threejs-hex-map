define(["require", "exports"], function (require, exports) {
    ...
    function cloneGameState(original) {
        ...
        for (const key in original.players) {
            ...
            cloned.players[key] = Object.assign({}, player, { units: {}, improvements: {} // Reset or ignore the improvements
             });
            for (const [unitKey, _] of Object.entries(player.units)) {
                cloned.players[key].units[unitKey] = Object.assign({}, player.units[unitKey], { model: null, selector: null });
            }
            for (const [improvementKey, _] of Object.entries(player.improvements)) {
                cloned.players[key].improvements[improvementKey] = Object.assign({}, player.improvements[improvementKey], { model: null });
            }
        }
        return cloned;
    }
