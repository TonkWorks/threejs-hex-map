...
define(["require", "exports", "three", "./QuadTree", "./coords", "./MapMesh", "./BoundingBox", "./util"], function (require, exports, three_1, QuadTree_1, coords_1, MapMesh_1, BoundingBox_1, util_1) {
    ...
    class ChunkedLazyMapMesh extends three_1.Object3D {
        constructor(tileGrid, options) {
            ...
            const chunks = util_1.range(numChunksX).map(x => util_1.range(numChunksY).map(_ => []));
        ...
        updateVisibility(camera) {
            const min = coords_1.screenToWorld(0, 0, camera);
            const max = coords_1.screenToWorld(window.innerWidth, window.innerHeight, camera);
        ...
        getTile(q, r) {
            const xy = coords_1.qrToWorld(q, r);
    ...
    class MapThunk extends three_1.Object3D {
        ...
        computeCenter() {
            ...
            sphere.setFromPoints(this.tiles.map(tile => new three_1.Vector3(coords_1.qrToWorldX(tile.q, tile.r), coords_1.qrToWorldY(tile.q, tile.r))));
