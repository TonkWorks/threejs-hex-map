...
define(["require", "exports", "three", "./MapMesh", "./interfaces", "./util", "./Grid", "./DefaultTileSelector", "./DefaultTileHoverSelector", "./Units", "./DefaultMapViewController", "./coords", "./ChunkedLazyMapMesh", "./Units", "./GameState", "./CSS2DRenderer", "./AI", "./toastify"], function (require, exports, three_1, MapMesh_1, interfaces_1, util_1, Grid_1, DefaultTileSelector_1, DefaultTileHoverSelector_1, Units_1, DefaultMapViewController_1, coords_1, ChunkedLazyMapMesh_1, Units_2, GameState_1, CSS2DRenderer_1, AI_1, toastify_1) {
    ...
    class MapView {
        ...
        getClosestUnoccupiedTile(tile) {
            ...
            while (q) {
                let current = q.shift();
                if (current.unit === undefined && !interfaces_1.isMountain(current.height) && (current.improvement === undefined || current.improvement.owner === owner)) {
                    return current;
                }
