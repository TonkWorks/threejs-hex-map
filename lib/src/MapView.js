...
define(["require", "exports", "three", "./MapMesh", "./interfaces", "./util", "./Grid", "./DefaultTileSelector", "./DefaultTileHoverSelector", "./Units", "./DefaultMapViewController", "./coords", "./ChunkedLazyMapMesh", "./Units", "./GameState", "./CSS3DRenderer", "./AI", "./toastify", "./Nations"], function (require, exports, three_1, MapMesh_1, interfaces_1, util_1, Grid_1, DefaultTileSelector_1, DefaultTileHoverSelector_1, Units_1, DefaultMapViewController_1, coords_1, ChunkedLazyMapMesh_1, Units_2, GameState_1, CSS3DRenderer_1, AI_1, toastify_1, Nations_1) {
    ...
    class MapView {
        ...
        getRandomTile(cityEligibile) {
            ...
            const q = util_1.getRandomInt(-1 * (this._tileGrid.width / 2) + 2, this._tileGrid.width / 2 - 2);
            const r = util_1.getRandomInt(-1 * (this._tileGrid.width / 2) + 2, this._tileGrid.height / 2 - 2);
            const randomTile = this._tileGrid.get(util_1.getRandomInt(0, q), util_1.getRandomInt(0, r));
            return randomTile;
        }
