define(["require", "exports", "../../../build/three.module.js", "../geometries/LightningStrike.js"], function (require, exports, three_module_js_1, LightningStrike_js_1) {
    "use strict";
    ...
    */
    var LightningStorm = function (stormParams) {
        ...
        this.lightningParameters = LightningStrike_js_1.LightningStrike.copyParameters(stormParams.lightningParameters, stormParams.lightningParameters);
        this.lightningParameters.isEternal = false;
        this.lightningMaterial = stormParams.lightningMaterial !== undefined ? stormParams.lightningMaterial : new three_module_js_1.MeshBasicMaterial({ color: 0xB0FFFF });
        if (stormParams.onRayPosition !== undefined) {
            ...
            this.onRayPosition = function (source, dest) {
                ...
                var height = three_module_js_1.MathUtils.lerp(stormParams.minHeight, stormParams.maxHeight, Math.random());
        ...
        for (var i = 0; i < this.stormParams.maxLightnings; i++) {
            var lightning = new LightningStrike_js_1.LightningStrike(LightningStrike_js_1.LightningStrike.copyParameters({}, this.lightningParameters));
            var mesh = new three_module_js_1.Mesh(lightning, this.lightningMaterial);
            this.deadLightningsMeshes.push(mesh);
        }
    };
    exports.LightningStorm = LightningStorm;
    LightningStorm.prototype = Object.create(three_module_js_1.Object3D.prototype);
    ...
    LightningStorm.prototype.update = function (time) {
        ...
        if (time >= this.nextLightningTime) {
            ...
            if (lightningMesh) {
                var lightningParams1 = LightningStrike_js_1.LightningStrike.copyParameters(lightningMesh.geometry.rayParameters, this.lightningParameters);
                lightningParams1.birthTime = time;
                lightningParams1.deathTime = time + three_module_js_1.MathUtils.lerp(this.stormParams.lightningMinDuration, this.stormParams.lightningMaxDuration, Math.random());
        ...
        while (i < il) {
            ...
            if (prevState === LightningStrike_js_1.LightningStrike.RAY_PROPAGATING && lightning.state > prevState) {
                if (this.onLightningDown) {
                    this.onLightningDown(lightning);
                }
            }
            if (lightning.state === LightningStrike_js_1.LightningStrike.RAY_EXTINGUISHED) {
    ...
    LightningStorm.prototype.getNextLightningTime = function (currentTime) {
        return currentTime + three_module_js_1.MathUtils.lerp(this.stormParams.lightningMinPeriod, this.stormParams.lightningMaxPeriod, Math.random()) / (this.stormParams.maxLightnings + 1);
    };
    LightningStorm.prototype.copy = function (source) {
        three_module_js_1.Object3D.prototype.copy.call(this, source);
        ...
        this.lightningParameters = LightningStrike_js_1.LightningStrike.copyParameters({}, source.lightningParameters);
        this.lightningMaterial = source.stormParams.lightningMaterial;
        this.onLightningDown = source.onLightningDown;
        return this;
    };
    LightningStrike_js_1.LightningStrike.prototype.clone = function () {
