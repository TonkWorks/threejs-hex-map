define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var LightProbeGenerator = {
        ...
        fromCubeTexture: function (cubeTexture) {
            ...
            var coord = new three_module_js_1.Vector3();
            var dir = new three_module_js_1.Vector3();
            var color = new three_module_js_1.Color();
            var shBasis = [0, 0, 0, 0, 0, 0, 0, 0, 0];
            var sh = new three_module_js_1.SphericalHarmonics3();
            ...
            for (var faceIndex = 0; faceIndex < 6; faceIndex++) {
                ...
                for (var i = 0, il = data.length; i < il; i += 4) { // RGBA assumed
                    ...
                    three_module_js_1.SphericalHarmonics3.getBasisAt(dir, shBasis);
                    // accummuulate
                    for (var j = 0; j < 9; j++) {
            ...
            return new three_module_js_1.LightProbe(sh);
        },
