define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    ParametricGeometries.TubeGeometry = function (path, segments, radius, segmentsRadius, closed) {
        ...
        three_module_js_1.ParametricGeometry.call(this, ParametricTube, segments, segmentsRadius);
    };
    ParametricGeometries.TubeGeometry.prototype = Object.create(three_module_js_1.Geometry.prototype);
    ...
    ParametricGeometries.TorusKnotGeometry = function (radius, tube, segmentsT, segmentsR, p, q) {
        ...
        TorusKnotCurve.prototype = Object.create(three_module_js_1.Curve.prototype);
    ...
    ParametricGeometries.TorusKnotGeometry.prototype = Object.create(three_module_js_1.Geometry.prototype);
    ...
    ParametricGeometries.SphereGeometry = function (size, u, v) {
        ...
        three_module_js_1.ParametricGeometry.call(this, sphere, u, v);
    };
    ParametricGeometries.SphereGeometry.prototype = Object.create(three_module_js_1.Geometry.prototype);
    ...
    ParametricGeometries.PlaneGeometry = function (width, depth, segmentsWidth, segmentsDepth) {
        ...
        three_module_js_1.ParametricGeometry.call(this, plane, segmentsWidth, segmentsDepth);
    };
    ParametricGeometries.PlaneGeometry.prototype = Object.create(three_module_js_1.Geometry.prototype);
