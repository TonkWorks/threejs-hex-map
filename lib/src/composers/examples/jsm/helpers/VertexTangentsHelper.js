define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    function VertexTangentsHelper(object, size, hex) {
        ...
        var positions = new three_module_js_1.Float32BufferAttribute(nTangents * 2 * 3, 3);
        geometry.setAttribute('position', positions);
        three_module_js_1.LineSegments.call(this, geometry, new three_module_js_1.LineBasicMaterial({ color: color, toneMapped: false }));
    ...
    VertexTangentsHelper.prototype = Object.create(three_module_js_1.LineSegments.prototype);
