define(["require", "exports", "../../../../build/three.module.js", "./NodeUniform.js", "./NodeUtils.js", "./NodeLib.js", "./FunctionNode.js", "./ConstNode.js", "./StructNode.js", "../inputs/Vector2Node.js", "../inputs/Vector3Node.js", "../inputs/Vector4Node.js", "../inputs/TextureNode.js", "../inputs/CubeTextureNode.js", "../misc/TextureCubeNode.js"], function (require, exports, three_module_js_1, NodeUniform_js_1, NodeUtils_js_1, NodeLib_js_1, FunctionNode_js_1, ConstNode_js_1, StructNode_js_1, Vector2Node_js_1, Vector3Node_js_1, Vector4Node_js_1, TextureNode_js_1, CubeTextureNode_js_1, TextureCubeNode_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var elements = NodeUtils_js_1.NodeUtils.elements, constructors = ['float', 'vec2', 'vec3', 'vec4'], convertFormatToType = {
        float: 'f',
        vec2: 'v2',
        vec3: 'v3',
        vec4: 'v4',
    ...
    NodeBuilder.prototype = {
        ...
        createUniform: function (shader, type, node, ns, needsUpdate, label) {
            ...
            var uniform = new NodeUniform_js_1.NodeUniform({
                type: type,
        ...
        include: function (node, parent, source) {
            var includesStruct;
            node = typeof node === 'string' ? NodeLib_js_1.NodeLib.get(node) : node;
            if (this.context.include === false) {
                return node.name;
            }
            if (node instanceof FunctionNode_js_1.FunctionNode) {
                includesStruct = this.includes.functions;
            }
            else if (node instanceof ConstNode_js_1.ConstNode) {
                includesStruct = this.includes.consts;
            }
            else if (node instanceof StructNode_js_1.StructNode) {
            ...
            if (node) {
                ...
                if (node instanceof FunctionNode_js_1.FunctionNode && parent && includes[parent.name] && includes[parent.name].deps.indexOf(node) == -1) {
                ...
                if (nodeCandidate !== undefined) {
                    if (nodeCandidate.isNode) {
                        ...
                        switch (nodeCandidate.mapping) {
                            case three_module_js_1.CubeReflectionMapping:
                            case three_module_js_1.CubeRefractionMapping:
                                return new CubeTextureNode_js_1.CubeTextureNode(nodeCandidate);
                                break;
                            case three_module_js_1.CubeUVReflectionMapping:
                            case three_module_js_1.CubeUVRefractionMapping:
                                return new TextureCubeNode_js_1.TextureCubeNode(new TextureNode_js_1.TextureNode(nodeCandidate));
                                break;
                            default:
                                return new TextureNode_js_1.TextureNode(nodeCandidate);
                        }
                    }
                    else if (nodeCandidate.isVector2) {
                        return new Vector2Node_js_1.Vector2Node(nodeCandidate);
                    }
                    else if (nodeCandidate.isVector3) {
                        return new Vector3Node_js_1.Vector3Node(nodeCandidate);
                    }
                    else if (nodeCandidate.isVector4) {
                        return new Vector4Node_js_1.Vector4Node(nodeCandidate);
                    }
                }
            }
        },
        ...
        getTextureEncodingFromMap: function (map) {
            var encoding;
            if (!map) {
                encoding = three_module_js_1.LinearEncoding;
            }
            ...
            if (encoding === three_module_js_1.LinearEncoding && this.context.gamma) {
                encoding = three_module_js_1.GammaEncoding;
            }
            return encoding;
        }
    };
