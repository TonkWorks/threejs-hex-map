define(["require", "exports", "../../../../build/three.module.js", "../core/NodeBuilder.js", "../inputs/ColorNode.js", "../accessors/PositionNode.js", "./nodes/RawNode.js"], function (require, exports, three_module_js_1, NodeBuilder_js_1, ColorNode_js_1, PositionNode_js_1, RawNode_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function NodeMaterial(vertex, fragment) {
        three_module_js_1.ShaderMaterial.call(this);
        this.vertex = vertex || new RawNode_js_1.RawNode(new PositionNode_js_1.PositionNode(PositionNode_js_1.PositionNode.PROJECTION));
        this.fragment = fragment || new RawNode_js_1.RawNode(new ColorNode_js_1.ColorNode(0xFF0000));
        this.updaters = [];
    }
    exports.NodeMaterial = NodeMaterial;
    NodeMaterial.prototype = Object.create(three_module_js_1.ShaderMaterial.prototype);
    ...
    NodeMaterial.prototype.build = function (params) {
        params = params || {};
        var builder = params.builder || new NodeBuilder_js_1.NodeBuilder();
        ...
        this.transparent = builder.requires.transparent || this.blending > three_module_js_1.NormalBlending;
        return this;
    };
    ...
    NodeMaterial.prototype.toJSON = function (meta) {
        ...
        if (!meta.materials[this.uuid]) {
            ...
            if (this.blending !== three_module_js_1.NormalBlending)
                data.blending = this.blending;
            if (this.flatShading === true)
                data.flatShading = this.flatShading;
            if (this.side !== three_module_js_1.FrontSide)
                data.side = this.side;
            if (this.vertexColors !== three_module_js_1.NoColors)
                data.vertexColors = this.vertexColors;
            if (this.depthFunc !== three_module_js_1.LessEqualDepth)
