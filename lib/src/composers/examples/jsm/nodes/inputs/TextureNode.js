define(["require", "exports", "../core/InputNode.js", "../accessors/UVNode.js", "../utils/ColorSpaceNode.js", "../core/ExpressionNode.js"], function (require, exports, InputNode_js_1, UVNode_js_1, ColorSpaceNode_js_1, ExpressionNode_js_1) {
    "use strict";
    ...
    TextureNode.prototype = Object.create(InputNode_js_1.InputNode.prototype);
    ...
    TextureNode.prototype.getTexture = function (builder, output) {
        return InputNode_js_1.InputNode.prototype.generate.call(this, builder, output, this.value.uuid, 't');
    };
