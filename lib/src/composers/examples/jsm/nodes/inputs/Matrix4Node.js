define(["require", "exports", "../../../../build/three.module.js", "../core/InputNode.js"], function (require, exports, three_module_js_1, InputNode_js_1) {
    ...
    function Matrix4Node(matrix) {
        InputNode_js_1.InputNode.call(this, 'm4');
        this.value = matrix || new three_module_js_1.Matrix4();
    }
    exports.Matrix4Node = Matrix4Node;
    Matrix4Node.prototype = Object.create(InputNode_js_1.InputNode.prototype);
...
//# sourceMappingURL=Matrix4Node.js.map