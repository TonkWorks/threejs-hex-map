define(["require", "exports", "../../../../build/three.module.js", "../core/TempNode.js", "../core/FunctionNode.js", "../inputs/FloatNode.js", "../inputs/Vector2Node.js", "../accessors/UVNode.js"], function (require, exports, three_module_js_1, TempNode_js_1, FunctionNode_js_1, FloatNode_js_1, Vector2Node_js_1, UVNode_js_1) {
    "use strict";
    ...
    function BlurNode(value, uv, radius, size) {
        ...
        this.radius = radius || new Vector2Node_js_1.Vector2Node(1, 1);
        this.size = size;
        this.blurX = true;
        this.blurY = true;
        this.horizontal = new FloatNode_js_1.FloatNode(1 / 64);
        this.vertical = new FloatNode_js_1.FloatNode(1 / 64);
    }
    exports.BlurNode = BlurNode;
    BlurNode.Nodes = (function () {
        var blurX = new FunctionNode_js_1.FunctionNode([
        ...
        var blurY = new FunctionNode_js_1.FunctionNode([
    ...
    BlurNode.prototype = Object.create(TempNode_js_1.TempNode.prototype);
    ...
    BlurNode.prototype.copy = function (source) {
        ...
        if (source.size !== undefined)
            this.size = new three_module_js_1.Vector2(source.size.x, source.size.y);
...
//# sourceMappingURL=BlurNode.js.map