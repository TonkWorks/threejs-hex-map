define(["require", "exports", "../core/TempNode.js", "../inputs/FloatNode.js", "../core/FunctionNode.js", "../accessors/NormalNode.js", "../accessors/PositionNode.js"], function (require, exports, TempNode_js_1, FloatNode_js_1, FunctionNode_js_1, NormalNode_js_1, PositionNode_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function BumpMapNode(value, scale) {
        TempNode_js_1.TempNode.call(this, 'v3');
        this.value = value;
        this.scale = scale || new FloatNode_js_1.FloatNode(1);
        this.toNormalMap = false;
    }
    exports.BumpMapNode = BumpMapNode;
    BumpMapNode.Nodes = (function () {
        var dHdxy_fwd = new FunctionNode_js_1.FunctionNode([
        ...
        var perturbNormalArb = new FunctionNode_js_1.FunctionNode([
        ...
        var bumpToNormal = new FunctionNode_js_1.FunctionNode([
    ...
    BumpMapNode.prototype = Object.create(TempNode_js_1.TempNode.prototype);
