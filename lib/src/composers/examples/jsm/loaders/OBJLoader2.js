 ...
 */
define(["require", "exports", "../../../build/three.module.js", "./obj2/OBJLoader2Parser.js", "./obj2/shared/MeshReceiver.js", "./obj2/shared/MaterialHandler.js"], function (require, exports, three_module_js_1, OBJLoader2Parser_js_1, MeshReceiver_js_1, MaterialHandler_js_1) {
    "use strict";
    ...
    const OBJLoader2 = function (manager) {
        ...
        this.parser = new OBJLoader2Parser_js_1.OBJLoader2Parser();
        this.modelName = '';
        this.instanceNo = 0;
        this.baseObject3d = new three_module_js_1.Object3D();
        this.materialHandler = new MaterialHandler_js_1.MaterialHandler();
        this.meshReceiver = new MeshReceiver_js_1.MeshReceiver(this.materialHandler);
    ...
    OBJLoader2.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
        ...
        load: function (url, onLoad, onFileLoadProgress, onError, onMeshAlter) {
            ...
            const fileLoader = new three_module_js_1.FileLoader(this.manager);
