define(["require", "exports", "../../../build/three.module.js", "../libs/jszip.module.min.js"], function (require, exports, three_module_js_1, jszip_module_min_js_1) {
    "use strict";
    ...
    ThreeMFLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
        ...
        parse: function (data) {
            ...
            function loadDocument(data) {
                ...
                var otherParts = {};
                try {
                    zip = new jszip_module_min_js_1.JSZip(data); // eslint-disable-line no-undef
                }
                catch (e) {
                ...
                var relsFileText = three_module_js_1.LoaderUtils.decodeText(relsView);
                ...
                for (var i = 0; i < modelPartNames.length; i++) {
                    ...
                    var fileText = three_module_js_1.LoaderUtils.decodeText(view);
            ...
            function parseColorGroupNode(colorGroupNode) {
                ...
                var colors = [];
                var colorObject = new three_module_js_1.Color();
            ...
            function buildTexture(texture2dgroup, objects, modelData, textureData) {
                ...
                if (texture2d) {
                    ...
                    texture.encoding = three_module_js_1.sRGBEncoding;
                    // texture parameters
                    switch (texture2d.tilestyleu) {
                        case 'wrap':
                            ...
                            break;
                        case 'mirror':
                            texture.wrapS = three_module_js_1.MirroredRepeatWrapping;
                            break;
                        case 'none':
                        case 'clamp':
                    ...
                    switch (texture2d.tilestylev) {
                        case 'wrap':
                            ...
                            break;
                        case 'mirror':
                            texture.wrapT = three_module_js_1.MirroredRepeatWrapping;
                            break;
                        case 'none':
                        case 'clamp':
                    ...
                    switch (texture2d.filter) {
                        case 'auto':
                            ...
                            texture.minFilter = three_module_js_1.LinearMipmapLinearFilter;
                            break;
                        case 'linear':
                            texture.magFilter = three_module_js_1.LinearFilter;
            ...
            function buildBasematerialsMeshes(basematerials, triangleProperties, modelData, meshData, textureData, objectData) {
                ...
                for (var i = 0, l = keys.length; i < l; i++) {
                    ...
                    geometry.setAttribute('position', new three_module_js_1.Float32BufferAttribute(positionData, 3));
                    //
            ...
            function buildTexturedMesh(texture2dgroup, triangleProperties, modelData, meshData, textureData, objectData) {
                ...
                geometry.setAttribute('position', new three_module_js_1.Float32BufferAttribute(positionData, 3));
                geometry.setAttribute('uv', new three_module_js_1.Float32BufferAttribute(uvData, 2));
                // material
                var texture = getBuild(texture2dgroup, objects, modelData, textureData, objectData, buildTexture);
                var material = new three_module_js_1.MeshPhongMaterial({ map: texture, flatShading: true });
                // mesh
                var mesh = new three_module_js_1.Mesh(geometry, material);
                return mesh;
            }
            function buildVertexColorMesh(colorgroup, triangleProperties, modelData, meshData, objectData) {
                ...
                geometry.setAttribute('position', new three_module_js_1.Float32BufferAttribute(positionData, 3));
                geometry.setAttribute('color', new three_module_js_1.Float32BufferAttribute(colorData, 3));
                // material
                var material = new three_module_js_1.MeshPhongMaterial({ vertexColors: true, flatShading: true });
                // mesh
                var mesh = new three_module_js_1.Mesh(geometry, material);
                return mesh;
            }
            function buildDefaultMesh(meshData) {
                var geometry = new three_module_js_1.BufferGeometry();
                geometry.setIndex(new three_module_js_1.BufferAttribute(meshData['triangles'], 1));
                geometry.setAttribute('position', new three_module_js_1.BufferAttribute(meshData['vertices'], 3));
                var material = new three_module_js_1.MeshPhongMaterial({ color: 0xaaaaff, flatShading: true });
                var mesh = new three_module_js_1.Mesh(geometry, material);
                return mesh;
            }
            ...
            function buildBasematerial(materialData, objects, modelData) {
                ...
                if (displaypropertiesid !== null && pbmetallicdisplayproperties[displaypropertiesid] !== undefined) {
                    ...
                    material = new three_module_js_1.MeshStandardMaterial({ flatShading: true, roughness: metallicData.roughness, metalness: metallicData.metallicness });
                }
                else {
                    // otherwise use PhongMaterial
                    material = new three_module_js_1.MeshPhongMaterial({ flatShading: true });
                }
            ...
            function buildComposite(compositeData, objects, modelData, textureData) {
                var composite = new three_module_js_1.Group();
