...
define(["require", "exports", "../../../build/three.module.js", "../nodes/Nodes.js"], function (require, exports, three_module_js_1, Nodes) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Nodes = __importStar(Nodes);
    var NodeMaterialLoader = function (manager, library) {
        this.manager = (manager !== undefined) ? manager : three_module_js_1.DefaultLoadingManager;
        this.nodes = {};
        this.materials = {};
        this.passes = {};
        this.names = {};
