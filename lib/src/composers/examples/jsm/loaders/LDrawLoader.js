define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
	...
	`;
        var tempVec0 = new three_module_js_1.Vector3();
        var tempVec1 = new three_module_js_1.Vector3();
        ...
        function createObject(elements, elementSize, isConditionalSegments) {
            ...
            bufferGeometry.setAttribute('position', new three_module_js_1.Float32BufferAttribute(positions, 3));
            if (elementSize === 3) {
                bufferGeometry.setAttribute('normal', new three_module_js_1.Float32BufferAttribute(normals, 3));
            }
            var object3d = null;
            if (elementSize === 2) {
                object3d = new three_module_js_1.LineSegments(bufferGeometry, materials);
            }
            else if (elementSize === 3) {
                object3d = new three_module_js_1.Mesh(bufferGeometry, materials);
            }
            if (isConditionalSegments) {
                ...
                bufferGeometry.setAttribute('control0', new three_module_js_1.BufferAttribute(controlArray0, 3, false));
                bufferGeometry.setAttribute('control1', new three_module_js_1.BufferAttribute(controlArray1, 3, false));
                bufferGeometry.setAttribute('direction', new three_module_js_1.BufferAttribute(directionArray, 3, false));
            }
            return object3d;
        }
        //
        ...
        LDrawLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
            ...
            load: function (url, onLoad, onProgress, onError) {
                ...
                var scope = this;
                var fileLoader = new three_module_js_1.FileLoader(this.manager);
            ...
            newParseScopeLevel: function (materials) {
                ...
                var newParseScope = {
                    ...
                    currentMatrix: new three_module_js_1.Matrix4(),
            ...
            parseColourMetaDirective: function (lineParser) {
                ...
                switch (finishType) {
                    case LDrawLoader.FINISH_TYPE_DEFAULT:
                        material = new three_module_js_1.MeshStandardMaterial({ color: colour, roughness: 0.3, envMapIntensity: 0.3, metalness: 0 });
                        break;
                    case LDrawLoader.FINISH_TYPE_PEARLESCENT:
                        // Try to imitate pearlescency by setting the specular to the complementary of the color, and low shininess
                        var specular = new three_module_js_1.Color(colour);
                        var hsl = specular.getHSL({ h: 0, s: 0, l: 0 });
                        hsl.h = (hsl.h + 0.5) % 1;
                        hsl.l = Math.min(1, hsl.l + (1 - hsl.l) * 0.7);
                        specular.setHSL(hsl.h, hsl.s, hsl.l);
                        material = new three_module_js_1.MeshPhongMaterial({ color: colour, specular: specular, shininess: 10, reflectivity: 0.3 });
                        break;
                    case LDrawLoader.FINISH_TYPE_CHROME:
                        // Mirror finish surface
                        material = new three_module_js_1.MeshStandardMaterial({ color: colour, roughness: 0, metalness: 1 });
                        break;
                    case LDrawLoader.FINISH_TYPE_RUBBER:
                        // Rubber finish
                        material = new three_module_js_1.MeshStandardMaterial({ color: colour, roughness: 0.9, metalness: 0 });
                        canHaveEnvMap = false;
                        break;
                    case LDrawLoader.FINISH_TYPE_MATTE_METALLIC:
                        // Brushed metal finish
                        material = new three_module_js_1.MeshStandardMaterial({ color: colour, roughness: 0.8, metalness: 0.4 });
                        break;
                    case LDrawLoader.FINISH_TYPE_METAL:
                        // Average metal finish
                        material = new three_module_js_1.MeshStandardMaterial({ color: colour, roughness: 0.2, metalness: 0.85 });
                        break;
                    default:
                        // Should not happen
                        break;
                ...
                if (!edgeMaterial) {
                    ...
                    edgeMaterial = new three_module_js_1.LineBasicMaterial({
                        color: edgeColour,
                    ...
                    edgeMaterial.userData.conditionalEdgeMaterial = new three_module_js_1.ShaderMaterial({
                        vertexShader: conditionalLineVertShader,
                        fragmentShader: conditionalLineFragShader,
                        uniforms: {
                            diffuse: {
                                value: new three_module_js_1.Color(edgeColour)
                            },
                            opacity: {
                                value: alpha
                            }
            ...
            objectParse: function (text) {
                ...
                function parseVector(lp) {
                    var v = new three_module_js_1.Vector3(parseFloat(lp.getToken()), parseFloat(lp.getToken()), parseFloat(lp.getToken()));
                ...
                for (lineIndex = 0; lineIndex < numLines; lineIndex++) {
                    ...
                    switch (lineType) {
                                ...
                                switch (meta) {
                                    case '!LDRAW_ORG':
                                        ...
                                        if (isRoot || scope.separateObjects && !isPrimitiveType(type)) {
                                            currentParseScope.groupObject = new three_module_js_1.Group();
                                            currentParseScope.groupObject.userData.startingConstructionStep = currentParseScope.startingConstructionStep;
                                        }
                                        // If the scale of the object is negated then the triangle winding order
                                        // needs to be flipped.
                                        var matrix = currentParseScope.matrix;
                                        if (matrix.determinant() < 0 && (scope.separateObjects && isPrimitiveType(type) ||
                        ...
                        case '1':
                            ...
                            var matrix = new three_module_js_1.Matrix4().set(m0, m1, m2, posX, m3, m4, m5, posY, m6, m7, m8, posZ, 0, 0, 0, 1);
                        ...
                        case '3':
                            ...
                            faceNormal = new three_module_js_1.Vector3()
            ...
            processObject: function (text, onProcessed, subobject, url) {
                ...
                function loadSubobject(subobject) {
                    ...
                    var fileLoader = new three_module_js_1.FileLoader(scope.manager);
