define(["require", "exports", "../../../build/three.module.js", "../libs/chevrotain.module.min.js"], function (require, exports, three_module_js_1, chevrotain_module_min_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var VRMLLoader = (function () {
        // dependency check
        if (typeof chevrotain_module_min_js_1.chevrotain === 'undefined') { // eslint-disable-line no-undef
        ...
        VRMLLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
            ...
            parse: function (data, path) {
                ...
                function createTokens() {
                    var createToken = chevrotain_module_min_js_1.chevrotain.createToken; // eslint-disable-line no-undef
                    ...
                    var Comment = createToken({
                        name: 'Comment',
                        pattern: /#.*/,
                        group: chevrotain_module_min_js_1.chevrotain.Lexer.SKIPPED // eslint-disable-line no-undef
                    });
                ...
                function parseTree(tree) {
                    ...
                    for (var i = 0, l = nodes.length; i < l; i++) {
                        ...
                        if (object instanceof three_module_js_1.Object3D)
                            scene.add(object);
                ...
                function buildGroupingNode(node) {
                    var object = new three_module_js_1.Group();
                    //
                    var fields = node.fields;
                    for (var i = 0, l = fields.length; i < l; i++) {
                        var field = fields[i];
                        ...
                        switch (fieldName) {
                            ...
                            case 'collide':
                                ...
                                break;
                            case 'rotation':
                                var axis = new three_module_js_1.Vector3(fieldValues[0], fieldValues[1], fieldValues[2]);
                ...
                function buildBackgroundNode(node) {
                    ...
                    // sky
                    if (skyColor) {
                        var skyGeometry = new three_module_js_1.SphereBufferGeometry(radius, 32, 16);
                        var skyMaterial = new three_module_js_1.MeshBasicMaterial({ fog: false, side: three_module_js_1.BackSide, depthWrite: false, depthTest: false });
                        ...
                        var sky = new three_module_js_1.Mesh(skyGeometry, skyMaterial);
                        group.add(sky);
                    }
                    // ground
                    if (groundColor) {
                        if (groundColor.length > 0) {
                            var groundGeometry = new three_module_js_1.SphereBufferGeometry(radius, 32, 16, 0, 2 * Math.PI, 0.5 * Math.PI, 1.5 * Math.PI);
                            var groundMaterial = new three_module_js_1.MeshBasicMaterial({ fog: false, side: three_module_js_1.BackSide, vertexColors: true, depthWrite: false, depthTest: false });
                            paintFaces(groundGeometry, radius, groundAngle, toColorArray(groundColor), false);
                            var ground = new three_module_js_1.Mesh(groundGeometry, groundMaterial);
                            group.add(ground);
                        }
                    }
                ...
                function buildShapeNode(node) {
                    ...
                    var material = new three_module_js_1.MeshBasicMaterial({ color: 0x000000 });
                    var geometry;
                    for (var i = 0, l = fields.length; i < l; i++) {
                        var field = fields[i];
                        var fieldName = field.name;
                    ...
                    if (geometry && geometry.attributes.position) {
                        ...
                        if (type === 'points') { // points
                            var pointsMaterial = new three_module_js_1.PointsMaterial({ color: 0xffffff });
                            ...
                            object = new three_module_js_1.Points(geometry, pointsMaterial);
                        }
                        else if (type === 'line') { // lines
                            var lineMaterial = new three_module_js_1.LineBasicMaterial({ color: 0xffffff });
                            if (geometry.attributes.color !== undefined) {
                            ...
                            object = new three_module_js_1.LineSegments(geometry, lineMaterial);
                        }
                        else { // consider meshes
                            // check "solid" hint (it's placed in the geometry but affects the material)
                            if (geometry._solid !== undefined) {
                                material.side = (geometry._solid) ? three_module_js_1.FrontSide : three_module_js_1.DoubleSide;
                            }
                            // check for vertex colors
                            if (geometry.attributes.color !== undefined) {
                                material.vertexColors = true;
                            }
                            object = new three_module_js_1.Mesh(geometry, material);
                        }
                    }
                    else {
                        object = new three_module_js_1.Object3D();
                ...
                function buildAppearanceNode(node) {
                    var material = new three_module_js_1.MeshPhongMaterial();
                    var transformData;
                    var fields = node.fields;
                    for (var i = 0, l = fields.length; i < l; i++) {
                        var field = fields[i];
                        ...
                        switch (fieldName) {
                            case 'material':
                                if (fieldValues[0] !== null) {
                                    ...
                                    material = new three_module_js_1.MeshBasicMaterial({ color: 0x000000 });
                                }
                                break;
                            case 'texture':
                    ...
                    for (var i = 0, l = fields.length; i < l; i++) {
                        ...
                        switch (fieldName) {
                            case 'ambientIntensity':
                                ...
                                break;
                            case 'diffuseColor':
                                materialData.diffuseColor = new three_module_js_1.Color(fieldValues[0], fieldValues[1], fieldValues[2]);
                                break;
                            case 'emissiveColor':
                                materialData.emissiveColor = new three_module_js_1.Color(fieldValues[0], fieldValues[1], fieldValues[2]);
                                break;
                            case 'shininess':
                ...
                function buildPixelTextureNode(node) {
                    var texture;
                    var wrapS = three_module_js_1.RepeatWrapping;
                    var wrapT = three_module_js_1.RepeatWrapping;
                    var fields = node.fields;
                    for (var i = 0, l = fields.length; i < l; i++) {
                        var field = fields[i];
                        var fieldName = field.name;
                        ...
                        switch (fieldName) {
                            case 'image':
                                ...
                                texture = new three_module_js_1.DataTexture(data, width, height, (useAlpha === true) ? three_module_js_1.RGBAFormat : three_module_js_1.RGBFormat);
                                texture.__type = textureType; // needed for material modifications
                                break;
                            case 'repeatS':
                                if (fieldValues[0] === false)
                                    wrapS = three_module_js_1.ClampToEdgeWrapping;
                                break;
                            case 'repeatT':
                                if (fieldValues[0] === false)
                                    wrapT = three_module_js_1.ClampToEdgeWrapping;
                                break;
                            default:
                                console.warn('THREE.VRMLLoader: Unknown field:', fieldName);
                                break;
                ...
                function buildTextureTransformNode(node) {
                    var transformData = {
                        center: new three_module_js_1.Vector2(),
                        rotation: new three_module_js_1.Vector2(),
                        scale: new three_module_js_1.Vector2(),
                        translation: new three_module_js_1.Vector2()
                    };
                    var fields = node.fields;
                    for (var i = 0, l = fields.length; i < l; i++) {
                        var field = fields[i];
                ...
                function buildIndexedFaceSetNode(node) {
                    ...
                    if (coordIndex === undefined) {
                        ...
                        return new three_module_js_1.BufferGeometry(); // handle VRML files with incomplete geometry definition
                    }
                    ...
                    if (color) {
                        if (colorPerVertex === true) {
                            if (colorIndex && colorIndex.length > 0) {
                                ...
                                colorAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new three_module_js_1.Float32BufferAttribute(color, 3));
                            }
                        }
                        else {
                            if (colorIndex && colorIndex.length > 0) {
                    ...
                    if (normal) {
                        if (normalPerVertex === true) {
                            ...
                            if (normalIndex && normalIndex.length > 0) {
                                ...
                                normalAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new three_module_js_1.Float32BufferAttribute(normal, 3));
                            }
                        }
                        else {
                    ...
                    if (texCoord) {
                        ...
                        if (texCoordIndex && texCoordIndex.length > 0) {
                            ...
                            uvAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new three_module_js_1.Float32BufferAttribute(texCoord, 2));
                        }
                    }
                    var geometry = new three_module_js_1.BufferGeometry();
                    positionAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new three_module_js_1.Float32BufferAttribute(coord, 3));
                ...
                function buildIndexedLineSetNode(node) {
                    ...
                    if (color) {
                        if (colorPerVertex === true) {
                            if (colorIndex.length > 0) {
                                ...
                                colorAttribute = toNonIndexedAttribute(expandedLineIndex, new three_module_js_1.Float32BufferAttribute(color, 3));
                            }
                        }
                        else {
                            if (colorIndex.length > 0) {
                    ...
                    //
                    var geometry = new three_module_js_1.BufferGeometry();
                    var positionAttribute = toNonIndexedAttribute(expandedLineIndex, new three_module_js_1.Float32BufferAttribute(coord, 3));
                    geometry.setAttribute('position', positionAttribute);
                    if (colorAttribute)
                        geometry.setAttribute('color', colorAttribute);
                    geometry._type = 'line';
                ...
                function buildPointSetNode(node) {
                    ...
                    var geometry = new three_module_js_1.BufferGeometry();
                    geometry.setAttribute('position', new three_module_js_1.Float32BufferAttribute(coord, 3));
                    if (color)
                        geometry.setAttribute('color', new three_module_js_1.Float32BufferAttribute(color, 3));
                    geometry._type = 'points';
                    return geometry;
                }
                function buildBoxNode(node) {
                    var size = new three_module_js_1.Vector3(2, 2, 2);
                    var fields = node.fields;
                    for (var i = 0, l = fields.length; i < l; i++) {
                        var field = fields[i];
                        var fieldName = field.name;
                    ...
                    var geometry = new three_module_js_1.BoxBufferGeometry(size.x, size.y, size.z);
                    return geometry;
                }
                function buildConeNode(node) {
                    ...
                    var geometry = new three_module_js_1.ConeBufferGeometry(radius, height, 16, 1, openEnded);
                    return geometry;
                }
                function buildCylinderNode(node) {
                    ...
                    var geometry = new three_module_js_1.CylinderBufferGeometry(radius, radius, height, 16, 1);
                    return geometry;
                }
                function buildSphereNode(node) {
                    ...
                    var geometry = new three_module_js_1.SphereBufferGeometry(radius, 16, 16);
                    return geometry;
                }
                function buildElevationGridNode(node) {
                    ...
                    //
                    var positionAttribute = toNonIndexedAttribute(indices, new three_module_js_1.Float32BufferAttribute(vertices, 3));
                    var uvAttribute = toNonIndexedAttribute(indices, new three_module_js_1.Float32BufferAttribute(uvs, 2));
                    var colorAttribute;
                    var normalAttribute;
                    // color attribute
                    if (color) {
                        if (colorPerVertex === false) {
                            ...
                            colorAttribute = new three_module_js_1.Float32BufferAttribute(colors, 3);
                        }
                        else {
                            colorAttribute = toNonIndexedAttribute(indices, new three_module_js_1.Float32BufferAttribute(colors, 3));
                        }
                    }
                    // normal attribute
                    if (normal) {
                        if (normalPerVertex === false) {
                            ...
                            normalAttribute = new three_module_js_1.Float32BufferAttribute(normals, 3);
                        }
                        else {
                            normalAttribute = toNonIndexedAttribute(indices, new three_module_js_1.Float32BufferAttribute(normals, 3));
                        }
                    }
                    else {
                ...
                function buildExtrusionNode(node) {
                    ...
                    // vertices
                    var vertices = [];
                    var spineVector = new three_module_js_1.Vector3();
                    var scaling = new three_module_js_1.Vector3();
                    var axis = new three_module_js_1.Vector3();
                    var vertex = new three_module_js_1.Vector3();
                    ...
                    if (beginCap === true || endCap === true) {
                        ...
                        for (var i = 0, l = crossSection.length; i < l; i += 2) {
                            contour.push(new three_module_js_1.Vector2(crossSection[i], crossSection[i + 1]));
                        }
                        var faces = three_module_js_1.ShapeUtils.triangulateShape(contour, []);
                        var capIndices = [];
                ...
                var vA = new three_module_js_1.Vector3();
                var vB = new three_module_js_1.Vector3();
                var vC = new three_module_js_1.Vector3();
                var uvA = new three_module_js_1.Vector2();
                var uvB = new three_module_js_1.Vector2();
                var uvC = new three_module_js_1.Vector2();
                function computeAttributeFromIndexedData(coordIndex, index, data, itemSize) {
                    ...
                    return new three_module_js_1.Float32BufferAttribute(array, itemSize);
                }
                function computeAttributeFromFaceData(index, faceData) {
                    ...
                    return new three_module_js_1.Float32BufferAttribute(array, 3);
                }
                ...
                function toNonIndexedAttribute(indices, attribute) {
                    ...
                    return new three_module_js_1.Float32BufferAttribute(array2, itemSize);
                }
                var ab = new three_module_js_1.Vector3();
                var cb = new three_module_js_1.Vector3();
                function computeNormalAttribute(index, coord, creaseAngle) {
                    ...
                    return new three_module_js_1.Float32BufferAttribute(normals, 3);
                }
                function weightedNormal(normals, vector, creaseAngle) {
                    var normal = new three_module_js_1.Vector3();
                    if (creaseAngle === 0) {
                        normal.copy(vector);
                    }
                    else {
                ...
                function toColorArray(colors) {
                    ...
                    for (var i = 0, l = colors.length; i < l; i += 3) {
                        array.push(new three_module_js_1.Color(colors[i], colors[i + 1], colors[i + 2]));
                    }
                    return array;
                }
                /**
                ...
                function paintFaces(geometry, radius, angles, colors, topDown) {
                    ...
                    var colorAttribute = new three_module_js_1.BufferAttribute(new Float32Array(geometry.attributes.position.count * 3), 3);
                    var position = new three_module_js_1.Vector3();
                    var color = new three_module_js_1.Color();
                ...
                //
                var textureLoader = new three_module_js_1.TextureLoader(this.manager);
        ...
        function VRMLLexer(tokens) {
            this.lexer = new chevrotain_module_min_js_1.chevrotain.Lexer(tokens); // eslint-disable-line no-undef
        }
        VRMLLexer.prototype = {
        ...
        function VRMLParser(tokenVocabulary) {
            chevrotain_module_min_js_1.chevrotain.Parser.call(this, tokenVocabulary); // eslint-disable-line no-undef
            var $ = this;
        ...
        VRMLParser.prototype = Object.create(chevrotain_module_min_js_1.chevrotain.Parser.prototype); // eslint-disable-line no-undef
        VRMLParser.prototype.constructor = VRMLParser;
        function Face(a, b, c) {
            this.a = a;
            this.b = b;
            this.c = c;
            this.normal = new three_module_js_1.Vector3();
        }
        var TEXTURE_TYPE = {
            INTENSITY: 1,
            INTENSITY_ALPHA: 2,
