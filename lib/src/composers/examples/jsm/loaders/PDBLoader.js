define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    PDBLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
        ...
        parse: function (text) {
            ...
            function buildGeometry() {
                var build = {
                    geometryAtoms: new three_module_js_1.BufferGeometry(),
                    geometryBonds: new three_module_js_1.BufferGeometry(),
                    json: {
                        atoms: atoms
                    }
                };
                ...
                // build geometry
                geometryAtoms.setAttribute('position', new three_module_js_1.Float32BufferAttribute(verticesAtoms, 3));
                geometryAtoms.setAttribute('color', new three_module_js_1.Float32BufferAttribute(colorsAtoms, 3));
                geometryBonds.setAttribute('position', new three_module_js_1.Float32BufferAttribute(verticesBonds, 3));
                return build;
            }
