 ...
 *
 **/
define(["require", "exports", "../../../../build/three.module.js", "./LWO2Parser.js", "./LWO3Parser.js"], function (require, exports, three_module_js_1, LWO2Parser_js_1, LWO3Parser_js_1) {
    "use strict";
    ...
    IFFParser.prototype = {
        ...
        parse: function (buffer) {
            ...
            if (this.tree.format === 'LWO2') {
                this.parser = new LWO2Parser_js_1.LWO2Parser(this);
                while (!this.reader.endOfFile())
                    this.parser.parseBlock();
            }
            else if (this.tree.format === 'LWO3') {
                this.parser = new LWO3Parser_js_1.LWO3Parser(this);
                while (!this.reader.endOfFile())
                    this.parser.parseBlock();
            }
    ...
    DataViewReader.prototype = {
        ...
        getString: function (size) {
            ...
            if (size) {
                ...
                if (!isEven(len + 1))
                    this.getUint8(); // if string with terminating nullbyte is uneven, extra nullbyte is added
            }
    ...
    Debugger.prototype = {
        ...
        log: function () {
            ...
            console.log("| ".repeat(this.depth) +
                nodeType, this.nodeID, `( ${this.offset} ) -> ( ${this.dataOffset + this.length} )`, ((this.node == 0) ? " {" : ""), ((this.skipped) ? "SKIPPED" : ""), ((this.node == 0 && this.skipped) ? "}" : ""));
    ...
    function printBuffer(buffer, from, to) {
        console.log(three_module_js_1.LoaderUtils.decodeText(new Uint8Array(buffer, from, to)));
    }
});
