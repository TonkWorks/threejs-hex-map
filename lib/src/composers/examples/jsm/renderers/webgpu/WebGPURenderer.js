...
define(["require", "exports", "./constants.js", "./WebGPUObjects.js", "./WebGPUAttributes.js", "./WebGPUGeometries.js", "./WebGPUInfo.js", "./WebGPUProperties.js", "./WebGPURenderPipelines.js", "./WebGPUComputePipelines.js", "./WebGPUBindings.js", "./WebGPURenderLists.js", "./WebGPUTextures.js", "./WebGPUBackground.js", "../../../../build/three.module.js"], function (require, exports, constants_js_1, WebGPUObjects_js_1, WebGPUAttributes_js_1, WebGPUGeometries_js_1, WebGPUInfo_js_1, WebGPUProperties_js_1, WebGPURenderPipelines_js_1, WebGPUComputePipelines_js_1, WebGPUBindings_js_1, WebGPURenderLists_js_1, WebGPUTextures_js_1, WebGPUBackground_js_1, three_module_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    WebGPUObjects_js_1 = __importDefault(WebGPUObjects_js_1);
    WebGPUAttributes_js_1 = __importDefault(WebGPUAttributes_js_1);
    WebGPUGeometries_js_1 = __importDefault(WebGPUGeometries_js_1);
    WebGPUInfo_js_1 = __importDefault(WebGPUInfo_js_1);
    WebGPUProperties_js_1 = __importDefault(WebGPUProperties_js_1);
    WebGPURenderPipelines_js_1 = __importDefault(WebGPURenderPipelines_js_1);
    WebGPUComputePipelines_js_1 = __importDefault(WebGPUComputePipelines_js_1);
    WebGPUBindings_js_1 = __importDefault(WebGPUBindings_js_1);
    WebGPURenderLists_js_1 = __importDefault(WebGPURenderLists_js_1);
    WebGPUTextures_js_1 = __importDefault(WebGPUTextures_js_1);
    WebGPUBackground_js_1 = __importDefault(WebGPUBackground_js_1);
    console.info('THREE.WebGPURenderer: Modified Matrix4.makePerspective() and Matrix4.makeOrtographic() to work with WebGPU, see https://github.com/mrdoob/three.js/issues/20276.');
    three_module_js_1.Matrix4.prototype.makePerspective = function (left, right, top, bottom, near, far) {
    ...
    three_module_js_1.Matrix4.prototype.makeOrthographic = function (left, right, top, bottom, near, far) {
        const te = this.elements;
    ...
    const _frustum = new three_module_js_1.Frustum();
    const _projScreenMatrix = new three_module_js_1.Matrix4();
    const _vector3 = new three_module_js_1.Vector3();
    class WebGPURenderer {
        constructor(parameters = {}) {
            ...
            this._clearAlpha = 1;
            this._clearColor = new three_module_js_1.Color(0x000000);
            this._clearDepth = 1;
        ...
        init() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const adapter = yield navigator.gpu.requestAdapter(adapterOptions);
                const deviceDescriptor = {
                    extensions: parameters.extensions,
                    limits: parameters.limits
                };
                const device = yield adapter.requestDevice(deviceDescriptor);
                const glslang = yield new Promise((resolve_1, reject_1) => { require(['https://cdn.jsdelivr.net/npm/@webgpu/glslang@0.0.15/dist/web-devel/glslang.js'], resolve_1, reject_1); }).then(__importStar);
                const compiler = yield glslang.default();
                const context = (parameters.context !== undefined) ? parameters.context : this.domElement.getContext('gpupresent');
                const swapChain = context.configureSwapChain({
                    device: device,
                    format: constants_js_1.GPUTextureFormat.BRGA8Unorm // this is the only valid swap chain format right now (r121)
                });
                this._adapter = adapter;
                this._device = device;
                this._context = context;
                this._swapChain = swapChain;
                this._info = new WebGPUInfo_js_1.default();
                this._properties = new WebGPUProperties_js_1.default();
                this._attributes = new WebGPUAttributes_js_1.default(device);
                this._geometries = new WebGPUGeometries_js_1.default(this._attributes, this._info);
                this._textures = new WebGPUTextures_js_1.default(device, this._properties, this._info, compiler);
                this._objects = new WebGPUObjects_js_1.default(this._geometries, this._info);
                this._renderPipelines = new WebGPURenderPipelines_js_1.default(this, this._properties, device, compiler, parameters.sampleCount);
                this._computePipelines = new WebGPUComputePipelines_js_1.default(device, compiler);
                this._bindings = new WebGPUBindings_js_1.default(device, this._info, this._properties, this._textures, this._renderPipelines, this._computePipelines, this._attributes);
                this._renderLists = new WebGPURenderLists_js_1.default();
                this._background = new WebGPUBackground_js_1.default(this);
                //
                this._renderPassDescriptor = {
                    ...
                    depthStencilAttachment: {
                        attachment: null,
                        depthStoreOp: constants_js_1.GPUStoreOp.Store,
                        stencilStoreOp: constants_js_1.GPUStoreOp.Store
                    }
                };
        ...
        _setupIndexBuffer(index, encoder) {
            ...
            const indexFormat = (index.array instanceof Uint16Array) ? constants_js_1.GPUIndexFormat.Uint16 : constants_js_1.GPUIndexFormat.Uint32;
        ...
        _setupColorBuffer() {
            ...
            if (device) {
                ...
                this._colorBuffer = this._device.createTexture({
                    ...
                    format: constants_js_1.GPUTextureFormat.BRGA8Unorm,
