define(["require", "exports", "three", "../shaders/CopyShader.js", "../postprocessing/ShaderPass.js", "../postprocessing/MaskPass.js", "../postprocessing/MaskPass.js"], function (require, exports, three_1, CopyShader_js_1, ShaderPass_js_1, MaskPass_js_1, MaskPass_js_2) {
    "use strict";
    ...
    Object.assign(EffectComposer.prototype, {
        ...
        reset: function (renderTarget) {
            if (renderTarget === undefined) {
                var size = this.renderer.getSize(new three_1.Vector2());
    ...
    Pass.FullScreenQuad = (function () {
        var camera = new three_1.OrthographicCamera(-1, 1, 1, -1, 0, 1);
