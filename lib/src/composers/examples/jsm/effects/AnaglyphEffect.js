define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var AnaglyphEffect = function (renderer, width, height) {
        ...
        this.colorMatrixLeft = new three_module_js_1.Matrix3().fromArray([
        ...
        //		red						green 						blue  						in
        this.colorMatrixRight = new three_module_js_1.Matrix3().fromArray([
        ...
        if (height === undefined)
            height = 512;
        var _renderTargetL = new three_module_js_1.WebGLRenderTarget(width, height, _params);
        var _renderTargetR = new three_module_js_1.WebGLRenderTarget(width, height, _params);
        ...
        var _mesh = new three_module_js_1.Mesh(new three_module_js_1.PlaneBufferGeometry(2, 2), _material);
        _scene.add(_mesh);
