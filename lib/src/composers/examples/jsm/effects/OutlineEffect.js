define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var OutlineEffect = function (renderer, parameters) {
        ...
        var defaultColor = new three_module_js_1.Color().fromArray(parameters.defaultColor !== undefined ? parameters.defaultColor : [0, 0, 0]);
        ...
        function createMaterial() {
            return new three_module_js_1.ShaderMaterial({
                ...
                uniforms: three_module_js_1.UniformsUtils.merge([
                    ...
                    three_module_js_1.UniformsLib['displacementmap'],
                    uniformsOutline
                ]),
