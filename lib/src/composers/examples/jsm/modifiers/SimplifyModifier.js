define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    (function () {
        var cb = new three_module_js_1.Vector3(), ab = new three_module_js_1.Vector3();
        ...
        SimplifyModifier.prototype.modify = function (geometry, count) {
            if (geometry.isBufferGeometry) {
                geometry = new three_module_js_1.Geometry().fromBufferGeometry(geometry);
            }
            ...
            //
            var simplifiedGeometry = new three_module_js_1.BufferGeometry();
            var position = [];
            var index = [];
            //
            ...
            //
            simplifiedGeometry.setAttribute('position', new three_module_js_1.Float32BufferAttribute(position, 3));
