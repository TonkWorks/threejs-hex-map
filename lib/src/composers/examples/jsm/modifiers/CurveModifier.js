define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    function initSplineTexture(numberOfCurves = 1) {
        ...
        const dataTexture = new three_module_js_1.DataTexture(dataArray, TEXTURE_WIDTH, TEXTURE_HEIGHT * numberOfCurves, three_module_js_1.RGBFormat, three_module_js_1.FloatType);
        dataTexture.wrapS = three_module_js_1.RepeatWrapping;
        dataTexture.wrapY = three_module_js_1.RepeatWrapping;
        dataTexture.magFilter = three_module_js_1.NearestFilter;
    ...
    class Flow {
        ...
        constructor(mesh, numberOfCurves = 1) {
            ...
            obj3D.traverse(function (child) {
                if (child instanceof three_module_js_1.Mesh ||
                    child instanceof three_module_js_1.InstancedMesh) {
    ...
    exports.Flow = Flow;
    const matrix = new three_module_js_1.Matrix4();
    /**
    ...
    class InstancedFlow extends Flow {
        ...
        constructor(count, curveCount, geometry, material) {
            const mesh = new three_module_js_1.InstancedMesh(geometry, material, count);
            mesh.instanceMatrix.setUsage(three_module_js_1.DynamicDrawUsage);
