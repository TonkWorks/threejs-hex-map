define(["require", "exports", "./WebGLUniforms.js", "./WebGLShader.js", "../shaders/ShaderChunk.js", "../../constants.js"], function (require, exports, WebGLUniforms_js_1, WebGLShader_js_1, ShaderChunk_js_1, constants_js_1) {
    ...
    function getEncodingComponents(encoding) {
        switch (encoding) {
            ...
            case constants_js_1.LogLuvEncoding:
                return ['LogLuv', '( value )'];
            default:
    ...
    function getToneMappingFunction(functionName, toneMapping) {
        ...
        switch (toneMapping) {
            ...
            case constants_js_1.CineonToneMapping:
                ...
                break;
            case constants_js_1.ACESFilmicToneMapping:
                toneMappingName = 'ACESFilmic';
                break;
            case constants_js_1.CustomToneMapping:
    ...
    function includeReplacer(match, include) {
        const string = ShaderChunk_js_1.ShaderChunk[include];
        if (string === undefined) {
    ...
    function generateShadowMapTypeDefine(parameters) {
        ...
        else if (parameters.shadowMapType === constants_js_1.VSMShadowMap) {
    ...
    function WebGLProgram(renderer, cacheKey, parameters, bindingStates) {
        ...
        if (parameters.isRawShaderMaterial) {
            ...
            prefixFragment = [
                ...
                ShaderChunk_js_1.ShaderChunk['encodings_pars_fragment'],
        ...
        if (parameters.isWebGL2 && parameters.isRawShaderMaterial !== true) {
            ...
            prefixFragment = [
                '#define varying in',
                (parameters.glslVersion === constants_js_1.GLSL3) ? '' : 'out highp vec4 pc_fragColor;',
                (parameters.glslVersion === constants_js_1.GLSL3) ? '' : '#define gl_FragColor pc_fragColor',
        ...
        const glVertexShader = WebGLShader_js_1.WebGLShader(gl, gl.VERTEX_SHADER, vertexGlsl);
        const glFragmentShader = WebGLShader_js_1.WebGLShader(gl, gl.FRAGMENT_SHADER, fragmentGlsl);
        ...
        this.getUniforms = function () {
            if (cachedUniforms === undefined) {
                cachedUniforms = new WebGLUniforms_js_1.WebGLUniforms(gl, program);
            }
