define(["require", "exports", "../../math/Vector3.js", "../core/Curve.js"], function (require, exports, Vector3_js_1, Curve_js_1) {
    ...
    */
    ...
    //
    const tmp = new Vector3_js_1.Vector3();
    ...
    CatmullRomCurve3.prototype = Object.create(Curve_js_1.Curve.prototype);
    ...
    CatmullRomCurve3.prototype.fromJSON = function (json) {
        ...
        for (let i = 0, l = json.points.length; i < l; i++) {
            ...
            this.points.push(new Vector3_js_1.Vector3().fromArray(point));
        }
