define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    MorphBlendMesh.prototype = Object.assign(Object.create(three_module_js_1.Mesh.prototype), {
        ...
        update: function (delta) {
            for (var i = 0, il = this.animationsList.length; i < il; i++) {
                ...
                var keyframe = animation.start + three_module_js_1.MathUtils.clamp(Math.floor(animation.time / frameTime), 0, animation.length - 1);
