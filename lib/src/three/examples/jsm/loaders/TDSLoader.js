define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    TDSLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
        ...
        parse: function (arraybuffer, path) {
            this.group = new three_module_js_1.Group();
            this.position = 0;
            this.materials = [];
            this.meshes = [];
        ...
        readMaterialEntry: function (data, path) {
            ...
            while (next !== 0) {
                if (next === MAT_NAME) {
                    ...
                    material.blending = three_module_js_1.AdditiveBlending;
                }
        ...
        readMap: function (data, path) {
            ...
            var next = this.nextChunk(data, chunk);
            var texture = {};
            var loader = new three_module_js_1.TextureLoader(this.manager);
