...
define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    MDDLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
        ...
        parse: function (data) {
            ...
            var track = new three_module_js_1.NumberKeyframeTrack('.morphTargetInfluences', times, values);
            var clip = new three_module_js_1.AnimationClip('default', times[times.length - 1], [track]);
            // morph targets
            var morphTargets = [];
            for (var i = 0; i < totalFrames; i++) {
                ...
                var attribute = new three_module_js_1.BufferAttribute(morphTarget, 3);
