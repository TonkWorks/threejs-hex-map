define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    Rhino3dmLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
        ...
        _createMaterial: function (material) {
            if (material === undefined) {
                return new three_module_js_1.MeshStandardMaterial({
                    color: new three_module_js_1.Color(1, 1, 1),
                    metalness: 0.8,
                    name: 'default',
                    side: 2
                });
            ...
            var diffusecolor = new three_module_js_1.Color(_diffuseColor.r / 255.0, _diffuseColor.g / 255.0, _diffuseColor.b / 255.0);
            ...
            var mat = new three_module_js_1.MeshStandardMaterial({
                color: diffusecolor,
                name: material.name,
                side: 2,
            ...
            var textureLoader = new three_module_js_1.TextureLoader();
        ...
        _createGeometry: function (data) {
            // console.log(data);
            var object = new three_module_js_1.Object3D();
            ...
            for (var i = 0; i < instanceDefinitions.length; i++) {
                ...
                for (var j = 0; j < instanceReferences.length; j++) {
                    ...
                    if (iRef.geometry.parentIdefId === iDef.attributes.id) {
                        var iRefObject = new three_module_js_1.Object3D();
        ...
        _createObject: function (obj, mat) {
            var loader = new three_module_js_1.BufferGeometryLoader();
            var attributes = obj.attributes;
            switch (obj.objectType) {
                case 'Point':
                case 'PointSet':
                    ...
                    var color = new three_module_js_1.Color(_color.r / 255.0, _color.g / 255.0, _color.b / 255.0);
                    var material = new three_module_js_1.PointsMaterial({ color: color, sizeAttenuation: false, size: 2 });
                    if (geometry.attributes.hasOwnProperty('color')) {
                        material.vertexColors = true;
                    }
                    material = this._compareMaterials(material);
                    var points = new three_module_js_1.Points(geometry, material);
                ...
                case 'SubD':
                    ...
                    var mesh = new three_module_js_1.Mesh(geometry, mat);
                    ...
                    return mesh;
                case 'Brep':
                    var brepObject = new three_module_js_1.Object3D();
                ...
                case 'Curve':
                    ...
                    var _color = attributes.drawColor;
                    var color = new three_module_js_1.Color(_color.r / 255.0, _color.g / 255.0, _color.b / 255.0);
                    var material = new three_module_js_1.LineBasicMaterial({ color: color });
                    material = this._compareMaterials(material);
                    var lines = new three_module_js_1.Line(geometry, material);
                ...
                case 'TextDot':
                    ...
                    var texture = new three_module_js_1.CanvasTexture(ctx.canvas);
                    ...
                    var material = new three_module_js_1.SpriteMaterial({ map: texture, depthTest: false });
                    var sprite = new three_module_js_1.Sprite(material);
                ...
                case 'Light':
                    ...
                    if (geometry.isDirectionalLight) {
                        ...
                        light = new three_module_js_1.RectAreaLight();
                        var width = Math.abs(geometry.width[2]);
                        var height = Math.abs(geometry.length[0]);
                        light.position.set(geometry.location[0] - (height / 2), geometry.location[1], geometry.location[2] - (width / 2));
                        light.height = height;
                        light.width = width;
                        light.lookAt(new three_module_js_1.Vector3(geometry.direction[0], geometry.direction[1], geometry.direction[2]));
                    }
        ...
        _initLibrary: function () {
            if (!this.libraryPending) {
                ...
                var jsLoader = new three_module_js_1.FileLoader(this.manager);
                jsLoader.setPath(this.libraryPath);
                var jsContent = new Promise((resolve, reject) => {
                    jsLoader.load('rhino3dm.js', resolve, undefined, reject);
                });
                // Load rhino3dm WASM binary.
                var binaryLoader = new three_module_js_1.FileLoader(this.manager);
