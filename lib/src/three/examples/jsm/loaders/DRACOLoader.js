define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    DRACOLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
        ...
        _createGeometry: function (geometryData) {
            ...
            if (geometryData.index) {
                geometry.setIndex(new three_module_js_1.BufferAttribute(geometryData.index.array, 1));
            }
            for (var i = 0; i < geometryData.attributes.length; i++) {
                ...
                geometry.setAttribute(name, new three_module_js_1.BufferAttribute(array, itemSize));
            }
            return geometry;
        },
