define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var a = {
        c: null,
        u: [new three_module_js_1.Vector3(), new three_module_js_1.Vector3(), new three_module_js_1.Vector3()],
        e: [] // half width
    };
    var b = {
        c: null,
    ...
    var AbsR = [[], [], []];
    var t = [];
    var xAxis = new three_module_js_1.Vector3();
    var yAxis = new three_module_js_1.Vector3();
    var zAxis = new three_module_js_1.Vector3();
    var v1 = new three_module_js_1.Vector3();
    var size = new three_module_js_1.Vector3();
    var closestPoint = new three_module_js_1.Vector3();
    var rotationMatrix = new three_module_js_1.Matrix3();
    var aabb = new three_module_js_1.Box3();
    var matrix = new three_module_js_1.Matrix4();
    var inverse = new three_module_js_1.Matrix4();
    var localRay = new three_module_js_1.Ray();
    // OBB
    function OBB(center = new three_module_js_1.Vector3(), halfSize = new three_module_js_1.Vector3(), rotation = new three_module_js_1.Matrix3()) {
        this.center = center;
    ...
    Object.assign(OBB.prototype, {
        ...
        */
        clampPoint: function (point, result) {
            ...
            var x = three_module_js_1.MathUtils.clamp(v1.dot(xAxis), -halfSize.x, halfSize.x);
            result.add(xAxis.multiplyScalar(x));
            var y = three_module_js_1.MathUtils.clamp(v1.dot(yAxis), -halfSize.y, halfSize.y);
            result.add(yAxis.multiplyScalar(y));
            var z = three_module_js_1.MathUtils.clamp(v1.dot(zAxis), -halfSize.z, halfSize.z);
