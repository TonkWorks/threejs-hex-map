    ...
    var ConvexHull = (function () {
        ...
        Object.assign(ConvexHull.prototype, {
                        ...
                        if (geometry.isGeometry) {
                            ...
                            if (attribute !== undefined) {
                                for (i = 0, l = attribute.count; i < l; i++) {
                                    point = new three_module_js_1.Vector3();
            ...
            computeExtremes: function () {
                var min = new three_module_js_1.Vector3();
                var max = new three_module_js_1.Vector3();
                var minVertices = [];
                var maxVertices = [];
                var i, l, j;
            ...
            computeInitialHull: function () {
                ...
                return function computeInitialHull() {
                    if (line3 === undefined) {
                        line3 = new three_module_js_1.Line3();
                        plane = new three_module_js_1.Plane();
                        closestPoint = new three_module_js_1.Vector3();
                    }
        ...
        function Face() {
            ...
            this.midpoint = new three_module_js_1.Vector3();
            this.area = 0;
            ...
            compute: function () {
                ...
                return function compute() {
                    if (triangle === undefined)
                        triangle = new three_module_js_1.Triangle();
