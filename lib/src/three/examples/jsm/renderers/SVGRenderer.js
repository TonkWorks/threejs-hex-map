define(["require", "exports", "../../../build/three.module.js", "../renderers/Projector.js", "../renderers/Projector.js", "../renderers/Projector.js", "../renderers/Projector.js"], function (require, exports, three_module_js_1, Projector_js_1, Projector_js_2, Projector_js_3, Projector_js_4) {
    "use strict";
    ...
    SVGObject.prototype = Object.create(three_module_js_1.Object3D.prototype);
    SVGObject.prototype.constructor = SVGObject;
    var SVGRenderer = function () {
        var _this = this, _renderData, _elements, _lights, _projector = new Projector_js_1.Projector(), _svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg'), _svgWidth, _svgHeight, _svgWidthHalf, _svgHeightHalf, _v1, _v2, _v3, _clipBox = new three_module_js_1.Box2(), _elemBox = new three_module_js_1.Box2(), _color = new three_module_js_1.Color(), _diffuseColor = new three_module_js_1.Color(), _ambientLight = new three_module_js_1.Color(), _directionalLights = new three_module_js_1.Color(), _pointLights = new three_module_js_1.Color(), _clearColor = new three_module_js_1.Color(), _vector3 = new three_module_js_1.Vector3(), // Needed for PointLight
        _centroid = new three_module_js_1.Vector3(), _normal = new three_module_js_1.Vector3(), _normalViewMatrix = new three_module_js_1.Matrix3(), _viewMatrix = new three_module_js_1.Matrix4(), _viewProjectionMatrix = new three_module_js_1.Matrix4(), _svgPathPool = [], _svgNode, _pathCount = 0, _currentPath, _currentStyle, _quality = 1, _precision = null;
        ...
        this.render = function (scene, camera) {
            if (camera instanceof three_module_js_1.Camera === false) {
