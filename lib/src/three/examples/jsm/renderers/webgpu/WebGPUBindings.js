...
define(["require", "exports", "./WebGPUUniformsGroup.js", "./WebGPUUniform.js", "./WebGPUSampler.js", "./WebGPUSampledTexture.js"], function (require, exports, WebGPUUniformsGroup_js_1, WebGPUUniform_js_1, WebGPUSampler_js_1, WebGPUSampledTexture_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    WebGPUUniformsGroup_js_1 = __importDefault(WebGPUUniformsGroup_js_1);
    WebGPUSampler_js_1 = __importDefault(WebGPUSampler_js_1);
    class WebGPUBindings {
        ...
        _getMeshBasicBindings() {
            ...
            // UBOs
            // model
            const modelViewUniform = new WebGPUUniform_js_1.Matrix4Uniform('modelMatrix');
            const modelViewMatrixUniform = new WebGPUUniform_js_1.Matrix4Uniform('modelViewMatrix');
            const normalMatrixUniform = new WebGPUUniform_js_1.Matrix3Uniform('normalMatrix');
            const modelGroup = new WebGPUUniformsGroup_js_1.default('modelUniforms');
            ...
            const opacityUniform = new WebGPUUniform_js_1.FloatUniform('opacity', 1);
            const opacityGroup = new WebGPUUniformsGroup_js_1.default('opacityUniforms');
            ...
            // sampler
            const diffuseSampler = new WebGPUSampler_js_1.default('map');
            // texture
            const diffuseTexture = new WebGPUSampledTexture_js_1.WebGPUSampledTexture('map');
        ...
        _setupSharedUniformsGroups() {
            const projectionMatrixUniform = new WebGPUUniform_js_1.Matrix4Uniform('projectionMatrix');
            const viewMatrixUniform = new WebGPUUniform_js_1.Matrix4Uniform('viewMatrix');
            const cameraGroup = new WebGPUUniformsGroup_js_1.default('cameraUniforms');
    ...
    exports.default = WebGPUBindings;
});
//# sourceMappingURL=WebGPUBindings.js.map