define(["require", "exports", "../core/TempNode.js", "./PositionNode.js", "./NormalNode.js"], function (require, exports, TempNode_js_1, PositionNode_js_1, NormalNode_js_1) {
    "use strict";
    ...
    ReflectNode.prototype = Object.create(TempNode_js_1.TempNode.prototype);
        ...
        if (builder.isShader('fragment')) {
            ...
            switch (this.scope) {
                case ReflectNode.VECTOR:
                    var viewNormalNode = new NormalNode_js_1.NormalNode(NormalNode_js_1.NormalNode.VIEW);
                    var roughnessNode = builder.context.roughness;
                    var viewNormal = viewNormalNode.build(builder, 'v3');
                    var viewPosition = new PositionNode_js_1.PositionNode(PositionNode_js_1.PositionNode.VIEW).build(builder, 'v3');
...
//# sourceMappingURL=ReflectNode.js.map