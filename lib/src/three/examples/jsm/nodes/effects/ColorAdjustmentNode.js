define(["require", "exports", "../core/TempNode.js", "../core/FunctionNode.js", "./LuminanceNode.js"], function (require, exports, TempNode_js_1, FunctionNode_js_1, LuminanceNode_js_1) {
    "use strict";
    ...
    ColorAdjustmentNode.Nodes = (function () {
        var hue = new FunctionNode_js_1.FunctionNode([
        ...
        var saturation = new FunctionNode_js_1.FunctionNode([
            // Algorithm from Chapter 16 of OpenGL Shading Language
            "vec3 saturation(vec3 rgb, float adjustment) {",
            "	vec3 intensity = vec3( luminance( rgb ) );",
            "	return mix( intensity, rgb, adjustment );",
            "}"
        ].join("\n"), [LuminanceNode_js_1.LuminanceNode.Nodes.luminance]); // include LuminanceNode function
        var vibrance = new FunctionNode_js_1.FunctionNode([
    ...
    ColorAdjustmentNode.prototype = Object.create(TempNode_js_1.TempNode.prototype);
...
//# sourceMappingURL=ColorAdjustmentNode.js.map