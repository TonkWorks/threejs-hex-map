define(["require", "exports", "../core/TempNode.js", "../core/ConstNode.js", "../core/FunctionNode.js"], function (require, exports, TempNode_js_1, ConstNode_js_1, FunctionNode_js_1) {
    "use strict";
    ...
    LuminanceNode.Nodes = (function () {
        var LUMA = new ConstNode_js_1.ConstNode("vec3 LUMA vec3( 0.2125, 0.7154, 0.0721 )");
        var luminance = new FunctionNode_js_1.FunctionNode([
    ...
    LuminanceNode.prototype = Object.create(TempNode_js_1.TempNode.prototype);
...
//# sourceMappingURL=LuminanceNode.js.map