define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var DecalGeometry = function (mesh, position, orientation, size) {
        ...
        var uvs = [];
        // helpers
        var plane = new three_module_js_1.Vector3();
        // this matrix represents the transformation of the decal projector
        var projectorMatrix = new three_module_js_1.Matrix4();
        projectorMatrix.makeRotationFromEuler(orientation);
        projectorMatrix.setPosition(position);
        var projectorMatrixInverse = new three_module_js_1.Matrix4().getInverse(projectorMatrix);
        // generate buffers
        generate();
        // build geometry
        ...
        function clip(v0, v1, p, s) {
            ...
            var s0 = d0 / (d0 - d1);
            var v = new DecalVertex(new three_module_js_1.Vector3(v0.position.x + s0 * (v1.position.x - v0.position.x), v0.position.y + s0 * (v1.position.y - v0.position.y), v0.position.z + s0 * (v1.position.z - v0.position.z)), new three_module_js_1.Vector3(v0.normal.x + s0 * (v1.normal.x - v0.normal.x), v0.normal.y + s0 * (v1.normal.y - v0.normal.y), v0.normal.z + s0 * (v1.normal.z - v0.normal.z)));
    ...
    DecalGeometry.prototype = Object.create(three_module_js_1.BufferGeometry.prototype);
