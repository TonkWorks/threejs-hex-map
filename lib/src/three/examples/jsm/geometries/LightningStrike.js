define(["require", "exports", "../../../build/three.module.js", "../math/SimplexNoise.js"], function (require, exports, three_module_js_1, SimplexNoise_js_1) {
    "use strict";
    ...
    */
    ...
    LightningStrike.prototype = Object.create(three_module_js_1.BufferGeometry.prototype);
    ...
    LightningStrike.copyParameters = function (dest, source) {
        ...
        dest.sourceOffset = source.sourceOffset !== undefined ? vecCopy(source.sourceOffset) : new three_module_js_1.Vector3(0, 100, 0),
            dest.destOffset = source.destOffset !== undefined ? vecCopy(source.destOffset) : new three_module_js_1.Vector3(0, 0, 0),
            ...
            dest.up0 = source.up0 !== undefined ? vecCopy(source.up0) : new three_module_js_1.Vector3(0, 0, 1);
        dest.up1 = source.up1 !== undefined ? vecCopy(source.up1) : new three_module_js_1.Vector3(0, 0, 1),
    ...
    LightningStrike.prototype.init = function (rayParameters) {
        ...
        this.simplexX = new SimplexNoise_js_1.SimplexNoise(this.seedGenerator);
        this.simplexY = new SimplexNoise_js_1.SimplexNoise(this.seedGenerator);
        this.simplexZ = new SimplexNoise_js_1.SimplexNoise(this.seedGenerator);
        // Temp vectors
        this.forwards = new three_module_js_1.Vector3();
        this.forwardsFill = new three_module_js_1.Vector3();
        this.side = new three_module_js_1.Vector3();
        this.down = new three_module_js_1.Vector3();
        this.middlePos = new three_module_js_1.Vector3();
        this.middleLinPos = new three_module_js_1.Vector3();
        this.newPos = new three_module_js_1.Vector3();
        this.vPos = new three_module_js_1.Vector3();
        this.cross1 = new three_module_js_1.Vector3();
    };
    LightningStrike.prototype.createMesh = function () {
        ...
        // Populate the mesh
        this.fillMesh(0);
        this.setIndex(new three_module_js_1.Uint32BufferAttribute(this.indices, 1));
        this.positionAttribute = new three_module_js_1.Float32BufferAttribute(this.vertices, 3);
        this.setAttribute('position', this.positionAttribute);
        if (this.generateUVs) {
            this.uvsAttribute = new three_module_js_1.Float32BufferAttribute(new Float32Array(this.uvs), 2);
            this.setAttribute('uv', this.uvsAttribute);
        }
        if (!this.isStatic) {
            this.index.usage = three_module_js_1.DynamicDrawUsage;
            this.positionAttribute.usage = three_module_js_1.DynamicDrawUsage;
            if (this.generateUVs) {
                this.uvsAttribute.usage = three_module_js_1.DynamicDrawUsage;
            }
        }
    ...
    LightningStrike.prototype.fractalRay = function (time, segmentCallback) {
        ...
        for (var subrayIndex = 0; subrayIndex < this.numSubrays; subrayIndex++) {
            ...
            subray.endPropagationTime = three_module_js_1.MathUtils.lerp(subray.birthTime, subray.deathTime, subray.propagationTimeFactor);
            subray.beginVanishingTime = three_module_js_1.MathUtils.lerp(subray.deathTime, subray.birthTime, 1 - subray.vanishingTimeFactor);
    ...
    LightningStrike.prototype.createDefaultSubrayCreationCallbacks = function () {
        ...
        this.onDecideSubrayCreation = function (segment, lightningStrike) {
            ...
            var phase0 = (lightningStrike.rayParameters.isEternal && subray.recursion == 0) ? -random1() * period : three_module_js_1.MathUtils.lerp(subray.birthTime, subray.endPropagationTime, segment.fraction0) - random1() * period;
        ...
        var vec1Pos = new three_module_js_1.Vector3();
        var vec2Forward = new three_module_js_1.Vector3();
        var vec3Side = new three_module_js_1.Vector3();
        var vec4Up = new three_module_js_1.Vector3();
    ...
    LightningStrike.prototype.createSubray = function () {
        return {
            ...
            maxIterations: 0,
            recursion: 0,
            pos0: new three_module_js_1.Vector3(),
            pos1: new three_module_js_1.Vector3(),
            linPos0: new three_module_js_1.Vector3(),
            linPos1: new three_module_js_1.Vector3(),
            up0: new three_module_js_1.Vector3(),
            up1: new three_module_js_1.Vector3(),
            radius0: 0,
            radius1: 0,
            birthTime: 0,
            deathTime: 0,
    ...
    LightningStrike.prototype.copy = function (source) {
        three_module_js_1.BufferGeometry.prototype.copy.call(this, source);
