define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var TeapotBufferGeometry = function (size, segments, bottom, lid, body, fitLid, blinn) {
        ...
        // Bezier form
        var ms = new three_module_js_1.Matrix4();
        ...
        var sdir = [];
        var tdir = [];
        var norm = new three_module_js_1.Vector3();
        var tcoord;
        var sstep, tstep;
        var vertPerRow;
        var s, t, sval, tval, p;
        var dsval = 0;
        var dtval = 0;
        var normOut = new three_module_js_1.Vector3();
        var v1, v2, v3, v4;
        var gmx = new three_module_js_1.Matrix4();
        var tmtx = new three_module_js_1.Matrix4();
        var vsp = new three_module_js_1.Vector4();
        var vtp = new three_module_js_1.Vector4();
        var vdsp = new three_module_js_1.Vector4();
        var vdtp = new three_module_js_1.Vector4();
        var vsdir = new three_module_js_1.Vector3();
        var vtdir = new three_module_js_1.Vector3();
        var mst = ms.clone();
        mst.transpose();
        ...
        for (i = 0; i < 3; i++) {
            mgm[i] = new three_module_js_1.Matrix4();
        }
        ...
        this.setIndex(new three_module_js_1.BufferAttribute(indices, 1));
        this.setAttribute('position', new three_module_js_1.BufferAttribute(vertices, 3));
        this.setAttribute('normal', new three_module_js_1.BufferAttribute(normals, 3));
        this.setAttribute('uv', new three_module_js_1.BufferAttribute(uvs, 2));
        this.computeBoundingSphere();
    };
    exports.TeapotBufferGeometry = TeapotBufferGeometry;
    TeapotBufferGeometry.prototype = Object.create(three_module_js_1.BufferGeometry.prototype);
    TeapotBufferGeometry.prototype.constructor = TeapotBufferGeometry;
});
//# sourceMappingURL=TeapotBufferGeometry.js.map