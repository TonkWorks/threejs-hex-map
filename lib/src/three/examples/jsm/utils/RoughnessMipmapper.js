...
define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var _mesh = new three_module_js_1.Mesh(new three_module_js_1.PlaneBufferGeometry(2, 2), _mipmapMaterial);
    var _flatCamera = new three_module_js_1.OrthographicCamera(0, 1, 0, 1, 0, 1);
    ...
    RoughnessMipmapper.prototype = {
        ...
        generateMipmaps: function (material) {
            ...
            if (!three_module_js_1.MathUtils.isPowerOfTwo(width) || !three_module_js_1.MathUtils.isPowerOfTwo(height))
                return;
            ...
            if (_tempTarget === null || _tempTarget.width !== width || _tempTarget.height !== height) {
                if (_tempTarget !== null)
                    _tempTarget.dispose();
                _tempTarget = new three_module_js_1.WebGLRenderTarget(width, height, { depthBuffer: false });
            ...
            if (width !== roughnessMap.image.width || height !== roughnessMap.image.height) {
                ...
                var newRoughnessTarget = new three_module_js_1.WebGLRenderTarget(width, height, params);
            ...
            var position = new three_module_js_1.Vector2(0, 0);
    ...
    function _getMipmapMaterial() {
        var shaderMaterial = new three_module_js_1.RawShaderMaterial({
            uniforms: {
                roughnessMap: { value: null },
                normalMap: { value: null },
                texelSize: { value: new three_module_js_1.Vector2(1, 1) }
            },
            vertexShader: /* glsl */ `
