define(["require", "exports", "../../../build/three.module.js", "../animation/CCDIKSolver.js", "../animation/MMDPhysics.js"], function (require, exports, three_module_js_1, CCDIKSolver_js_1, MMDPhysics_js_1) {
    "use strict";
    ...
    var MMDAnimationHelper = (function () {
        ...
        function MMDAnimationHelper(params) {
            ...
            this.meshes = [];
            this.camera = null;
            this.cameraTarget = new three_module_js_1.Object3D();
        ...
        MMDAnimationHelper.prototype = {
            ...
            _setupMeshAnimation: function (mesh, animation) {
                ...
                if (animation !== undefined) {
                    var animations = Array.isArray(animation)
                        ? animation : [animation];
                    objects.mixer = new three_module_js_1.AnimationMixer(mesh);
            ...
            _setupCameraAnimation: function (camera, animation) {
                ...
                objects.mixer = new three_module_js_1.AnimationMixer(camera);
                for (var i = 0, il = animations.length; i < il; i++) {
                    objects.mixer.clipAction(animations[i]).play();
                }
            },
            _setupMeshPhysics: function (mesh, params) {
                ...
                if (params.world === undefined && this.sharedPhysics) {
                    ...
                    if (masterPhysics !== null)
                        world = masterPhysics.world; // eslint-disable-line no-undef
                }
            ...
            _createCCDIKSolver: function (mesh) {
                if (CCDIKSolver_js_1.CCDIKSolver === undefined) {
                    throw new Error('THREE.MMDAnimationHelper: Import CCDIKSolver.');
                }
                return new CCDIKSolver_js_1.CCDIKSolver(mesh, mesh.geometry.userData.MMD.iks);
            },
            _createMMDPhysics: function (mesh, params) {
                if (MMDPhysics_js_1.MMDPhysics === undefined) {
                    throw new Error('THREE.MMDPhysics: Import MMDPhysics.');
                }
                return new MMDPhysics_js_1.MMDPhysics(mesh, mesh.geometry.userData.MMD.rigidBodies, mesh.geometry.userData.MMD.constraints, params);
            },
            /*
