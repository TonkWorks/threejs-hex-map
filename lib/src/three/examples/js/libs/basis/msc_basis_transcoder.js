var MSC_TRANSCODER = (function () {
    ...
    return (function (MSC_TRANSCODER) {
        ...
        var wasmMemory;
        var wasmTable = new WebAssembly.Table({ "initial": 70, "maximum": 70 + 0, "element": "anyfunc" });
        var ABORT = false;
        var EXITSTATUS = 0;
        ...
        var DYNAMIC_BASE = 5568704, DYNAMICTOP_PTR = 325664;
        ...
        function createWasm() { var info = { "env": asmLibraryArg, "wasi_snapshot_preview1": asmLibraryArg }; function receiveInstance(instance, module) { var exports = instance.exports; Module["asm"] = exports; removeRunDependency("wasm-instantiate"); } addRunDependency("wasm-instantiate"); function receiveInstantiatedSource(output) { receiveInstance(output["instance"]); } function instantiateArrayBuffer(receiver) { return getBinaryPromise().then(function (binary) { return WebAssembly.instantiate(binary, info); }).then(receiver, function (reason) { err("failed to asynchronously prepare wasm: " + reason); abort(reason); }); } function instantiateAsync() { if (!wasmBinary && typeof WebAssembly.instantiateStreaming === "function" && !isDataURI(wasmBinaryFile) && typeof fetch === "function") {
        ...
        function _roundf(d) { d = +d; return d >= +0 ? +Math_floor(d + +.5) : +Math_ceil(d - +.5); }
        ...
        var dynCall_viiiiiii = Module["dynCall_viiiiiii"] = function () { return Module["asm"]["X"].apply(null, arguments); };
        ...
        var dynCall_iiii = Module["dynCall_iiii"] = function () { return Module["asm"]["_"].apply(null, arguments); };
        ...
        var dynCall_viiiii = Module["dynCall_viiiii"] = function () { return Module["asm"]["da"].apply(null, arguments); };
...
if (typeof exports === 'object' && typeof module === 'object')
    ...
    define([], function () { return MSC_TRANSCODER; });
else if (typeof exports === 'object')
    exports["MSC_TRANSCODER"] = MSC_TRANSCODER;
//# sourceMappingURL=msc_basis_transcoder.js.map