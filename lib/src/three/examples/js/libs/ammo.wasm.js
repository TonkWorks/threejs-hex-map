...
var Ammo = (function () {
    ...
    return (function (Ammo) {
        ...
        var ba;
        b.ready = new Promise(function (a) { ba = a; });
        var ca = {}, da;
        for (da in b)
        ...
        var ja = "", ka, la, ma, na;
        if (ha)
            ja = fa ? require("path").dirname(ja) + "/" : __dirname + "/", ka = function (a, c) { ma || (ma = require("fs")); na || (na = require("path")); a = na.normalize(a); return ma.readFileSync(a, c ? null : "utf8"); }, la = function (a) { a = ka(a, !0); a.buffer || (a = new Uint8Array(a)); assert(a.buffer); return a; }, 1 < process.argv.length && process.argv[1].replace(/\\/g, "/"), process.argv.slice(2), process.on("uncaughtException", function (a) { throw a; }), process.on("unhandledRejection", oa), b.inspect = function () { return "[Emscripten Module object]"; };
        else if (ia)
            "undefined" !=
                typeof read && (ka = function (a) { return read(a); }), la = function (a) { if ("function" === typeof readbuffer)
                return new Uint8Array(readbuffer(a)); a = read(a, "binary"); assert("object" === typeof a); return a; }, "undefined" !== typeof print && ("undefined" === typeof console && (console = {}), console.log = print, console.warn = console.error = "undefined" !== typeof printErr ? printErr : print);
        else if (ea || fa)
            fa ? ja = self.location.href : document.currentScript && (ja = document.currentScript.src), _scriptDir && (ja = _scriptDir), ja = 0 !== ja.indexOf("blob:") ?
                ja.substr(0, ja.lastIndexOf("/") + 1) : "", ka = function (a) { var c = new XMLHttpRequest; c.open("GET", a, !1); c.send(null); return c.responseText; }, fa && (la = function (a) { var c = new XMLHttpRequest; c.open("GET", a, !1); c.responseType = "arraybuffer"; c.send(null); return new Uint8Array(c.response); });
        ...
        b.preloadedImages = {};
        b.preloadedAudios = {};
        function oa(a) { if (b.onAbort)
            b.onAbort(a); a += ""; pa(a); qa(a); va = !0; throw new WebAssembly.RuntimeError("abort(" + a + "). Build with -s ASSERTIONS=1 for more info."); }
        ...
        function Ua() { return ra || !ea && !fa || "function" !== typeof fetch || Pa("file://") ? new Promise(function (a) { a(Ta()); }) : fetch(Qa, { credentials: "same-origin" }).then(function (a) { if (!a.ok)
            throw "failed to load wasm binary file at '" + Qa + "'"; return a.arrayBuffer(); }).catch(function () { return Ta(); }); }
        var Va = { 1960: function (a, c, d, e, g, n, F, aa) { a = b.getCache(b.ConcreteContactResultCallback)[a]; if (!a.hasOwnProperty("addSingleResult"))
                throw "a JSImplementation must implement all functions, you forgot ConcreteContactResultCallback::addSingleResult."; return a.addSingleResult(c, d, e, g, n, F, aa); }, 2520: function (a, c, d, e) { a = b.getCache(b.DebugDrawer)[a]; if (!a.hasOwnProperty("drawLine"))
                throw "a JSImplementation must implement all functions, you forgot DebugDrawer::drawLine."; a.drawLine(c, d, e); }, 2745: function (a, c, d, e, g, n) { a = b.getCache(b.DebugDrawer)[a]; if (!a.hasOwnProperty("drawContactPoint"))
                throw "a JSImplementation must implement all functions, you forgot DebugDrawer::drawContactPoint."; a.drawContactPoint(c, d, e, g, n); }, 3002: function (a, c) { a = b.getCache(b.DebugDrawer)[a]; if (!a.hasOwnProperty("reportErrorWarning"))
                throw "a JSImplementation must implement all functions, you forgot DebugDrawer::reportErrorWarning."; a.reportErrorWarning(c); }, 3249: function (a, c, d) {
                ...
                a.draw3dText(c, d);
            }, 3476: function (a, c) { a = b.getCache(b.DebugDrawer)[a]; if (!a.hasOwnProperty("setDebugMode"))
                throw "a JSImplementation must implement all functions, you forgot DebugDrawer::setDebugMode."; a.setDebugMode(c); }, 3705: function (a) { a = b.getCache(b.DebugDrawer)[a]; if (!a.hasOwnProperty("getDebugMode"))
                throw "a JSImplementation must implement all functions, you forgot DebugDrawer::getDebugMode."; return a.getDebugMode(); } };
        Ha.push({ Xy: function () { Wa(); } });
        var Xa = [];
        function Ya(a, c) { Xa.length = 0; var d; for (c >>= 2; d = za[a++];)
            Xa.push(105 > d ? Ca[++c >> 1] : Aa[c]), ++c; return Xa; }
        var Za = { f: function () { oa(); }, c: function (a, c, d) { c = Ya(c, d); return Va[a].apply(null, c); }, a: function (a, c, d) { c = Ya(c, d); return Va[a].apply(null, c); }, d: function (a, c, d) { za.copyWithin(a, c, c + d); }, e: function () { oa("OOM"); }, b: function (a) { var c = Date.now(); Aa[a >> 2] = c / 1E3 | 0; Aa[a + 4 >> 2] = c % 1E3 * 1E3 | 0; return 0; }, memory: sa, table: ua };
        (function () {
            ...
            (function () { if (ra || "function" !== typeof WebAssembly.instantiateStreaming || Ra() || Pa("file://") || "function" !== typeof fetch)
                return d(c); fetch(Qa, { credentials: "same-origin" }).then(function (g) { return WebAssembly.instantiateStreaming(g, e).then(c, function (n) { qa("wasm streaming compile failed: " + n); qa("falling back to ArrayBuffer instantiation"); return d(c); }); }); })();
            return {};
        })();
        var Wa = b.___wasm_call_ctors = function () { return (Wa = b.___wasm_call_ctors = b.asm.g).apply(null, arguments); };
        ...
        }, Zg = b._emscripten_bind_btWheelInfoConstructionInfo_set_m_chassisConnectionCS_1 = function () { return (Zg = b._emscripten_bind_btWheelInfoConstructionInfo_set_m_chassisConnectionCS_1 = b.asm._e).apply(null, arguments); }, $g = b._emscripten_bind_btWheelInfoConstructionInfo_get_m_wheelDirectionCS_0 = function () {
        ...
        }, Mi = b._emscripten_bind_ClosestConvexResultCallback_get_m_collisionFilterGroup_0 = function () { return (Mi = b._emscripten_bind_ClosestConvexResultCallback_get_m_collisionFilterGroup_0 = b.asm.Mg).apply(null, arguments); }, Ni = b._emscripten_bind_ClosestConvexResultCallback_set_m_collisionFilterGroup_1 = function () {
        ...
        b.dynCall_vi = function () { return (b.dynCall_vi = b.asm.fy).apply(null, arguments); };
        b.dynCall_v = function () { return (b.dynCall_v = b.asm.gy).apply(null, arguments); };
        b.UTF8ToString = function (a, c) { if (a) {
            var d = a + c;
            for (c = a; za[c] && !(c >= d);)
                ++c;
        ...
        function CA() {
            function a() { if (!AA && (AA = !0, b.calledRun = !0, !va)) {
                Ka = !0;
                Fa(Ha);
                Fa(Ia);
                ba(b);
            ...
            if (!(0 < Ma)) {
                if (b.preRun)
                    for ("function" == typeof b.preRun && (b.preRun = [b.preRun]); b.preRun.length;)
                        La();
                Fa(Ga);
                0 < Ma || (b.setStatus ? (b.setStatus("Running..."), setTimeout(function () { setTimeout(function () { b.setStatus(""); }, 1); a(); }, 1)) :
                    a());
            }
        }
        b.run = CA;
        ...
        b.getCache = h;
        function k(a, c) { var d = h(c), e = d[a]; if (e)
            return e; e = Object.create((c || f).prototype); e.hy = a; return d[a] = e; }
        b.wrapPointer = k;
        b.castObject = function (a, c) { return k(a.hy, c); };
        b.NULL = k(0);
        b.destroy = function (a) { if (!a.__destroy__)
            throw "Error: Cannot destroy object. (Did you create it yourself?)"; a.__destroy__(); delete h(a.iy)[a.hy]; };
        b.compare = function (a, c) { return a.hy === c.hy; };
        b.getPointer = function (a) { return a.hy; };
        b.getClass = function (a) { return a.iy; };
        ...
        function KA(a, c, d) { d >>>= 0; switch (c.BYTES_PER_ELEMENT) {
            case 2:
                d >>>= 1;
                break;
            case 4:
        ...
        function MA(a) { if ("object" === typeof a) {
            var c = JA(a, Ba);
            KA(a, Ba, c);
            return c;
        } return a; }
        ...
        NA.prototype.getDispatcher = function () { return k($a(this.hy), OA); };
        NA.prototype.rayTest = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); ab(e, a, c, d); };
        NA.prototype.getPairCache = function () { return k(bb(this.hy), PA); };
        NA.prototype.getDispatchInfo = function () { return k(cb(this.hy), l); };
        NA.prototype.addCollisionObject = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? db(e, a) : void 0 === d ? eb(e, a, c) : fb(e, a, c, d); };
        NA.prototype.removeCollisionObject = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); gb(c, a); };
        NA.prototype.getBroadphase = function () { return k(hb(this.hy), QA); };
        NA.prototype.convexSweepTest = function (a, c, d, e, g) { var n = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); ib(n, a, c, d, e, g); };
        NA.prototype.contactPairTest = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); jb(e, a, c, d); };
        NA.prototype.contactTest = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); kb(d, a, c); };
        NA.prototype.updateSingleAabb = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); lb(c, a); };
        NA.prototype.setDebugDrawer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); mb(c, a); };
        NA.prototype.getDebugDrawer = function () { return k(nb(this.hy), RA); };
        NA.prototype.debugDrawWorld = function () { ob(this.hy); };
        NA.prototype.debugDrawObject = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); pb(e, a, c, d); };
        NA.prototype.__destroy__ = function () { qb(this.hy); };
        ...
        m.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); rb(c, a); };
        m.prototype.getLocalScaling = function () { return k(sb(this.hy), p); };
        m.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); tb(d, a, c); };
        m.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ub(c, a); };
        m.prototype.getMargin = function () { return vb(this.hy); };
        m.prototype.__destroy__ = function () { wb(this.hy); };
        ...
        q.prototype.setAnisotropicFriction = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); xb(d, a, c); };
        q.prototype.getCollisionShape = function () { return k(yb(this.hy), m); };
        q.prototype.setContactProcessingThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); zb(c, a); };
        q.prototype.setActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ab(c, a); };
        q.prototype.forceActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Bb(c, a); };
        q.prototype.activate = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); void 0 === a ? Cb(c) : Db(c, a); };
        q.prototype.isActive = function () { return !!Eb(this.hy); };
        q.prototype.isKinematicObject = function () { return !!Fb(this.hy); };
        q.prototype.isStaticObject = function () { return !!Gb(this.hy); };
        q.prototype.isStaticOrKinematicObject = function () { return !!Hb(this.hy); };
        q.prototype.getRestitution = function () { return Ib(this.hy); };
        q.prototype.getFriction = function () { return Jb(this.hy); };
        q.prototype.getRollingFriction = function () { return Kb(this.hy); };
        q.prototype.setRestitution = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Lb(c, a); };
        q.prototype.setFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Mb(c, a); };
        q.prototype.setRollingFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Nb(c, a); };
        q.prototype.getWorldTransform = function () { return k(Ob(this.hy), r); };
        q.prototype.getCollisionFlags = function () { return Pb(this.hy); };
        q.prototype.setCollisionFlags = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qb(c, a); };
        q.prototype.setWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Sb(c, a); };
        q.prototype.setCollisionShape = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Tb(c, a); };
        q.prototype.setCcdMotionThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ub(c, a); };
        q.prototype.setCcdSweptSphereRadius = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vb(c, a); };
        q.prototype.getUserIndex = function () { return Wb(this.hy); };
        q.prototype.setUserIndex = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xb(c, a); };
        q.prototype.getUserPointer = function () { return k(Yb(this.hy), SA); };
        q.prototype.setUserPointer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Zb(c, a); };
        q.prototype.getBroadphaseHandle = function () { return k($b(this.hy), t); };
        q.prototype.__destroy__ = function () { ac(this.hy); };
        ...
        u.jy = {};
        b.btDynamicsWorld = u;
        u.prototype.addAction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); bc(c, a); };
        u.prototype.removeAction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); cc(c, a); };
        u.prototype.getSolverInfo = function () { return k(dc(this.hy), v); };
        u.prototype.setInternalTickCallback = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? ec(e, a) : void 0 === d ? fc(e, a, c) : hc(e, a, c, d); };
        u.prototype.getDispatcher = function () { return k(ic(this.hy), OA); };
        u.prototype.rayTest = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); jc(e, a, c, d); };
        u.prototype.getPairCache = function () { return k(kc(this.hy), PA); };
        u.prototype.getDispatchInfo = function () { return k(lc(this.hy), l); };
        u.prototype.addCollisionObject = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? mc(e, a) : void 0 === d ? nc(e, a, c) : oc(e, a, c, d); };
        u.prototype.removeCollisionObject = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); pc(c, a); };
        u.prototype.getBroadphase = function () { return k(qc(this.hy), QA); };
        u.prototype.convexSweepTest = function (a, c, d, e, g) { var n = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); rc(n, a, c, d, e, g); };
        u.prototype.contactPairTest = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); sc(e, a, c, d); };
        u.prototype.contactTest = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); tc(d, a, c); };
        u.prototype.updateSingleAabb = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); uc(c, a); };
        u.prototype.setDebugDrawer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); vc(c, a); };
        u.prototype.getDebugDrawer = function () { return k(wc(this.hy), RA); };
        u.prototype.debugDrawWorld = function () { xc(this.hy); };
        u.prototype.debugDrawObject = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); yc(e, a, c, d); };
        u.prototype.__destroy__ = function () { zc(this.hy); };
        ...
        TA.prototype.enableFeedback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ac(c, a); };
        TA.prototype.getBreakingImpulseThreshold = function () { return Bc(this.hy); };
        TA.prototype.setBreakingImpulseThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Cc(c, a); };
        TA.prototype.getParam = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return Dc(d, a, c); };
        TA.prototype.setParam = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Ec(e, a, c, d); };
        TA.prototype.__destroy__ = function () { Fc(this.hy); };
        ...
        UA.jy = {};
        b.btConcaveShape = UA;
        UA.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Gc(c, a); };
        UA.prototype.getLocalScaling = function () { return k(Hc(this.hy), p); };
        UA.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Ic(d, a, c); };
        UA.prototype.__destroy__ = function () { Jc(this.hy); };
        ...
        VA.jy = {};
        b.btCapsuleShape = VA;
        VA.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Lc(c, a); };
        VA.prototype.getMargin = function () { return Mc(this.hy); };
        VA.prototype.getUpAxis = function () { return Nc(this.hy); };
        VA.prototype.getRadius = function () { return Oc(this.hy); };
        VA.prototype.getHalfHeight = function () { return Pc(this.hy); };
        VA.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qc(c, a); };
        VA.prototype.getLocalScaling = function () { return k(Rc(this.hy), p); };
        VA.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Sc(d, a, c); };
        VA.prototype.__destroy__ = function () { Tc(this.hy); };
        ...
        RA.jy = {};
        b.btIDebugDraw = RA;
        RA.prototype.drawLine = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Uc(e, a, c, d); };
        RA.prototype.drawContactPoint = function (a, c, d, e, g) { var n = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); Vc(n, a, c, d, e, g); };
        RA.prototype.reportErrorWarning = function (a) { var c = this.hy; IA(); a = a && "object" === typeof a ? a.hy : LA(a); Wc(c, a); };
        RA.prototype.draw3dText = function (a, c) { var d = this.hy; IA(); a && "object" === typeof a && (a = a.hy); c = c && "object" === typeof c ? c.hy : LA(c); Xc(d, a, c); };
        RA.prototype.setDebugMode = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Yc(c, a); };
        RA.prototype.getDebugMode = function () { return Zc(this.hy); };
        RA.prototype.__destroy__ = function () { $c(this.hy); };
        ...
        WA.prototype.__destroy__ = function () { cd(this.hy); };
        ...
        XA.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); dd(c, a); };
        XA.prototype.getLocalScaling = function () { return k(ed(this.hy), p); };
        XA.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); fd(d, a, c); };
        XA.prototype.__destroy__ = function () { gd(this.hy); };
        ...
        w.jy = {};
        b.btGhostObject = w;
        w.prototype.getNumOverlappingObjects = function () { return id(this.hy); };
        w.prototype.getOverlappingObject = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(jd(c, a), q); };
        w.prototype.setAnisotropicFriction = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); kd(d, a, c); };
        w.prototype.getCollisionShape = function () { return k(ld(this.hy), m); };
        w.prototype.setContactProcessingThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); md(c, a); };
        w.prototype.setActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); nd(c, a); };
        w.prototype.forceActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); od(c, a); };
        w.prototype.activate = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); void 0 === a ? pd(c) : qd(c, a); };
        w.prototype.isActive = function () { return !!rd(this.hy); };
        w.prototype.isKinematicObject = function () { return !!sd(this.hy); };
        w.prototype.isStaticObject = function () { return !!td(this.hy); };
        w.prototype.isStaticOrKinematicObject = function () { return !!ud(this.hy); };
        w.prototype.getRestitution = function () { return vd(this.hy); };
        w.prototype.getFriction = function () { return wd(this.hy); };
        w.prototype.getRollingFriction = function () { return xd(this.hy); };
        w.prototype.setRestitution = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yd(c, a); };
        w.prototype.setFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); zd(c, a); };
        w.prototype.setRollingFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ad(c, a); };
        w.prototype.getWorldTransform = function () { return k(Bd(this.hy), r); };
        w.prototype.getCollisionFlags = function () { return Cd(this.hy); };
        w.prototype.setCollisionFlags = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Dd(c, a); };
        w.prototype.setWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ed(c, a); };
        w.prototype.setCollisionShape = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Fd(c, a); };
        w.prototype.setCcdMotionThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Gd(c, a); };
        w.prototype.setCcdSweptSphereRadius = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Hd(c, a); };
        w.prototype.getUserIndex = function () { return Id(this.hy); };
        w.prototype.setUserIndex = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Jd(c, a); };
        w.prototype.getUserPointer = function () { return k(Kd(this.hy), SA); };
        w.prototype.setUserPointer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ld(c, a); };
        w.prototype.getBroadphaseHandle = function () { return k(Md(this.hy), t); };
        w.prototype.__destroy__ = function () { Nd(this.hy); };
        ...
        YA.jy = {};
        b.btConeShape = YA;
        YA.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pd(c, a); };
        YA.prototype.getLocalScaling = function () { return k(Qd(this.hy), p); };
        YA.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Rd(d, a, c); };
        YA.prototype.__destroy__ = function () { Sd(this.hy); };
        ...
        ZA.prototype.updateAction = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Td(d, a, c); };
        ZA.prototype.__destroy__ = function () { Ud(this.hy); };
        ...
        p.jy = {};
        b.btVector3 = p;
        p.prototype.length = p.prototype.length = function () { return Xd(this.hy); };
        p.prototype.x = p.prototype.x = function () { return Yd(this.hy); };
        p.prototype.y = p.prototype.y = function () { return Zd(this.hy); };
        p.prototype.z = p.prototype.z = function () { return $d(this.hy); };
        p.prototype.setX = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ae(c, a); };
        p.prototype.setY = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); be(c, a); };
        p.prototype.setZ = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ce(c, a); };
        p.prototype.setValue = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); de(e, a, c, d); };
        p.prototype.normalize = p.prototype.normalize = function () { ee(this.hy); };
        p.prototype.rotate = p.prototype.rotate = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return k(fe(d, a, c), p); };
        p.prototype.dot = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return ge(c, a); };
        p.prototype.op_mul = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(he(c, a), p); };
        p.prototype.op_add = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(ie(c, a), p); };
        p.prototype.op_sub = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(je(c, a), p); };
        p.prototype.__destroy__ = function () { ke(this.hy); };
        ...
        $A.prototype.castRay = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); le(e, a, c, d); };
        $A.prototype.__destroy__ = function () { me(this.hy); };
        ...
        aB.jy = {};
        b.btQuadWord = aB;
        aB.prototype.x = aB.prototype.x = function () { return ne(this.hy); };
        aB.prototype.y = aB.prototype.y = function () { return oe(this.hy); };
        aB.prototype.z = aB.prototype.z = function () { return pe(this.hy); };
        aB.prototype.w = function () { return qe(this.hy); };
        aB.prototype.setX = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); re(c, a); };
        aB.prototype.setY = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); se(c, a); };
        aB.prototype.setZ = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); te(c, a); };
        aB.prototype.setW = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ue(c, a); };
        aB.prototype.__destroy__ = function () { ve(this.hy); };
        ...
        bB.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); xe(c, a); };
        bB.prototype.getMargin = function () { return ye(this.hy); };
        bB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ze(c, a); };
        bB.prototype.getLocalScaling = function () { return k(Ae(this.hy), p); };
        bB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Be(d, a, c); };
        bB.prototype.__destroy__ = function () { Ce(this.hy); };
        ...
        x.prototype.setGravity = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ee(c, a); };
        x.prototype.getGravity = function () { return k(Fe(this.hy), p); };
        x.prototype.addRigidBody = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? Ge(e, a) : void 0 === d ? _emscripten_bind_btDiscreteDynamicsWorld_addRigidBody_2(e, a, c) : He(e, a, c, d); };
        x.prototype.removeRigidBody = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ie(c, a); };
        x.prototype.addConstraint = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); void 0 === c ? Je(d, a) : Ke(d, a, c); };
        x.prototype.removeConstraint = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Le(c, a); };
        x.prototype.stepSimulation = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); return void 0 === c ? Me(e, a) : void 0 === d ? Ne(e, a, c) : Oe(e, a, c, d); };
        x.prototype.setContactAddedCallback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pe(c, a); };
        x.prototype.setContactProcessedCallback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qe(c, a); };
        x.prototype.setContactDestroyedCallback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Re(c, a); };
        x.prototype.getDispatcher = function () { return k(Se(this.hy), OA); };
        x.prototype.rayTest = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Te(e, a, c, d); };
        x.prototype.getPairCache = function () { return k(Ue(this.hy), PA); };
        x.prototype.getDispatchInfo = function () { return k(Ve(this.hy), l); };
        x.prototype.addCollisionObject = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? We(e, a) : void 0 === d ? Xe(e, a, c) : Ye(e, a, c, d); };
        x.prototype.removeCollisionObject = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ze(c, a); };
        x.prototype.getBroadphase = function () { return k($e(this.hy), QA); };
        x.prototype.convexSweepTest = function (a, c, d, e, g) { var n = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); af(n, a, c, d, e, g); };
        x.prototype.contactPairTest = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); bf(e, a, c, d); };
        x.prototype.contactTest = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); cf(d, a, c); };
        x.prototype.updateSingleAabb = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); df(c, a); };
        x.prototype.setDebugDrawer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ef(c, a); };
        x.prototype.getDebugDrawer = function () { return k(ff(this.hy), RA); };
        x.prototype.debugDrawWorld = function () { gf(this.hy); };
        x.prototype.debugDrawObject = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); hf(e, a, c, d); };
        x.prototype.addAction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); jf(c, a); };
        x.prototype.removeAction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); kf(c, a); };
        x.prototype.getSolverInfo = function () { return k(lf(this.hy), v); };
        x.prototype.setInternalTickCallback = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? mf(e, a) : void 0 === d ? nf(e, a, c) : of(e, a, c, d); };
        x.prototype.__destroy__ = function () { pf(this.hy); };
        ...
        cB.jy = {};
        b.btConvexShape = cB;
        cB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); qf(c, a); };
        cB.prototype.getLocalScaling = function () { return k(rf(this.hy), p); };
        cB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); sf(d, a, c); };
        cB.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); tf(c, a); };
        cB.prototype.getMargin = function () { return uf(this.hy); };
        cB.prototype.__destroy__ = function () { vf(this.hy); };
        ...
        OA.jy = {};
        b.btDispatcher = OA;
        OA.prototype.getNumManifolds = function () { return wf(this.hy); };
        OA.prototype.getManifoldByIndexInternal = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(xf(c, a), dB); };
        OA.prototype.__destroy__ = function () { yf(this.hy); };
        ...
        eB.prototype.setLinearLowerLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Bf(c, a); };
        eB.prototype.setLinearUpperLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Cf(c, a); };
        eB.prototype.setAngularLowerLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Df(c, a); };
        eB.prototype.setAngularUpperLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ef(c, a); };
        eB.prototype.getFrameOffsetA = function () { return k(Ff(this.hy), r); };
        eB.prototype.enableFeedback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Gf(c, a); };
        eB.prototype.getBreakingImpulseThreshold = function () { return Hf(this.hy); };
        eB.prototype.setBreakingImpulseThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); If(c, a); };
        eB.prototype.getParam = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return Jf(d, a, c); };
        eB.prototype.setParam = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Kf(e, a, c, d); };
        eB.prototype.__destroy__ = function () { Lf(this.hy); };
        ...
        fB.prototype.setScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Mf(c, a); };
        fB.prototype.__destroy__ = function () { Nf(this.hy); };
        ...
        gB.jy = {};
        b.btMotionState = gB;
        gB.prototype.getWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Of(c, a); };
        gB.prototype.setWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pf(c, a); };
        gB.prototype.__destroy__ = function () { Qf(this.hy); };
        ...
        y.prototype.hasHit = function () { return !!Rf(this.hy); };
        y.prototype.get_m_collisionFilterGroup = y.prototype.ky = function () { return Sf(this.hy); };
        y.prototype.set_m_collisionFilterGroup = y.prototype.my = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Tf(c, a); };
        Object.defineProperty(y.prototype, "m_collisionFilterGroup", { get: y.prototype.ky, set: y.prototype.my });
        y.prototype.get_m_collisionFilterMask = y.prototype.ly = function () { return Uf(this.hy); };
        y.prototype.set_m_collisionFilterMask = y.prototype.ny = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vf(c, a); };
        Object.defineProperty(y.prototype, "m_collisionFilterMask", { get: y.prototype.ly, set: y.prototype.ny });
        y.prototype.get_m_closestHitFraction = y.prototype.oy = function () { return Wf(this.hy); };
        y.prototype.set_m_closestHitFraction = y.prototype.py = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xf(c, a); };
        Object.defineProperty(y.prototype, "m_closestHitFraction", { get: y.prototype.oy, set: y.prototype.py });
        y.prototype.__destroy__ = function () { Yf(this.hy); };
        ...
        hB.prototype.addSingleResult = function (a, c, d, e, g, n, F) { var aa = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); n && "object" === typeof n && (n = n.hy); F && "object" === typeof F && (F = F.hy); return Zf(aa, a, c, d, e, g, n, F); };
        hB.prototype.__destroy__ = function () { $f(this.hy); };
        ...
        iB.prototype.__destroy__ = function () { ag(this.hy); };
        ...
        z.prototype.hasHit = function () { return !!bg(this.hy); };
        z.prototype.get_m_collisionFilterGroup = z.prototype.ky = function () { return cg(this.hy); };
        z.prototype.set_m_collisionFilterGroup = z.prototype.my = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); dg(c, a); };
        Object.defineProperty(z.prototype, "m_collisionFilterGroup", { get: z.prototype.ky, set: z.prototype.my });
        z.prototype.get_m_collisionFilterMask = z.prototype.ly = function () { return eg(this.hy); };
        z.prototype.set_m_collisionFilterMask = z.prototype.ny = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); fg(c, a); };
        Object.defineProperty(z.prototype, "m_collisionFilterMask", { get: z.prototype.ly, set: z.prototype.ny });
        z.prototype.get_m_closestHitFraction = z.prototype.oy = function () { return gg(this.hy); };
        z.prototype.set_m_closestHitFraction = z.prototype.py = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); hg(c, a); };
        Object.defineProperty(z.prototype, "m_closestHitFraction", { get: z.prototype.oy, set: z.prototype.py });
        z.prototype.get_m_collisionObject = z.prototype.qy = function () { return k(ig(this.hy), q); };
        z.prototype.set_m_collisionObject = z.prototype.xy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); jg(c, a); };
        Object.defineProperty(z.prototype, "m_collisionObject", { get: z.prototype.qy, set: z.prototype.xy });
        z.prototype.__destroy__ = function () { kg(this.hy); };
        ...
        jB.jy = {};
        b.btMatrix3x3 = jB;
        jB.prototype.setEulerZYX = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); lg(e, a, c, d); };
        jB.prototype.getRotation = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); mg(c, a); };
        jB.prototype.getRow = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(ng(c, a), p); };
        jB.prototype.__destroy__ = function () { og(this.hy); };
        ...
        kB.jy = {};
        b.btScalarArray = kB;
        kB.prototype.size = kB.prototype.size = function () { return pg(this.hy); };
        kB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return qg(c, a); };
        kB.prototype.__destroy__ = function () { rg(this.hy); };
        ...
        A.jy = {};
        b.Material = A;
        A.prototype.get_m_kLST = A.prototype.vA = function () { return sg(this.hy); };
        A.prototype.set_m_kLST = A.prototype.bD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); tg(c, a); };
        Object.defineProperty(A.prototype, "m_kLST", { get: A.prototype.vA, set: A.prototype.bD });
        A.prototype.get_m_kAST = A.prototype.uA = function () { return ug(this.hy); };
        A.prototype.set_m_kAST = A.prototype.aD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); vg(c, a); };
        Object.defineProperty(A.prototype, "m_kAST", { get: A.prototype.uA, set: A.prototype.aD });
        A.prototype.get_m_kVST = A.prototype.wA = function () { return wg(this.hy); };
        A.prototype.set_m_kVST = A.prototype.cD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); xg(c, a); };
        Object.defineProperty(A.prototype, "m_kVST", { get: A.prototype.wA, set: A.prototype.cD });
        A.prototype.get_m_flags = A.prototype.cA = function () { return yg(this.hy); };
        A.prototype.set_m_flags = A.prototype.JC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); zg(c, a); };
        Object.defineProperty(A.prototype, "m_flags", { get: A.prototype.cA, set: A.prototype.JC });
        A.prototype.__destroy__ = function () { Ag(this.hy); };
        ...
        l.prototype.get_m_timeStep = l.prototype.jB = function () { return Bg(this.hy); };
        l.prototype.set_m_timeStep = l.prototype.QD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Cg(c, a); };
        Object.defineProperty(l.prototype, "m_timeStep", { get: l.prototype.jB, set: l.prototype.QD });
        l.prototype.get_m_stepCount = l.prototype.aB = function () { return Dg(this.hy); };
        l.prototype.set_m_stepCount = l.prototype.HD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Eg(c, a); };
        Object.defineProperty(l.prototype, "m_stepCount", { get: l.prototype.aB, set: l.prototype.HD });
        l.prototype.get_m_dispatchFunc = l.prototype.Wz = function () { return Fg(this.hy); };
        l.prototype.set_m_dispatchFunc = l.prototype.CC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Gg(c, a); };
        Object.defineProperty(l.prototype, "m_dispatchFunc", { get: l.prototype.Wz, set: l.prototype.CC });
        l.prototype.get_m_timeOfImpact = l.prototype.iB = function () { return Hg(this.hy); };
        l.prototype.set_m_timeOfImpact = l.prototype.PD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ig(c, a); };
        Object.defineProperty(l.prototype, "m_timeOfImpact", { get: l.prototype.iB, set: l.prototype.PD });
        l.prototype.get_m_useContinuous = l.prototype.lB = function () { return !!Jg(this.hy); };
        l.prototype.set_m_useContinuous = l.prototype.SD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Kg(c, a); };
        Object.defineProperty(l.prototype, "m_useContinuous", { get: l.prototype.lB, set: l.prototype.SD });
        l.prototype.get_m_enableSatConvex = l.prototype.$z = function () { return !!Lg(this.hy); };
        l.prototype.set_m_enableSatConvex = l.prototype.GC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Mg(c, a); };
        Object.defineProperty(l.prototype, "m_enableSatConvex", { get: l.prototype.$z, set: l.prototype.GC });
        l.prototype.get_m_enableSPU = l.prototype.Zz = function () { return !!Ng(this.hy); };
        l.prototype.set_m_enableSPU = l.prototype.FC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Og(c, a); };
        Object.defineProperty(l.prototype, "m_enableSPU", { get: l.prototype.Zz, set: l.prototype.FC });
        l.prototype.get_m_useEpa = l.prototype.nB = function () { return !!Pg(this.hy); };
        l.prototype.set_m_useEpa = l.prototype.UD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qg(c, a); };
        Object.defineProperty(l.prototype, "m_useEpa", { get: l.prototype.nB, set: l.prototype.UD });
        l.prototype.get_m_allowedCcdPenetration = l.prototype.zz = function () { return Rg(this.hy); };
        l.prototype.set_m_allowedCcdPenetration = l.prototype.fC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Sg(c, a); };
        Object.defineProperty(l.prototype, "m_allowedCcdPenetration", { get: l.prototype.zz, set: l.prototype.fC });
        l.prototype.get_m_useConvexConservativeDistanceUtil = l.prototype.mB = function () { return !!Tg(this.hy); };
        l.prototype.set_m_useConvexConservativeDistanceUtil = l.prototype.TD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ug(c, a); };
        Object.defineProperty(l.prototype, "m_useConvexConservativeDistanceUtil", { get: l.prototype.mB, set: l.prototype.TD });
        l.prototype.get_m_convexConservativeDistanceThreshold = l.prototype.Rz = function () { return Vg(this.hy); };
        l.prototype.set_m_convexConservativeDistanceThreshold = l.prototype.xC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wg(c, a); };
        Object.defineProperty(l.prototype, "m_convexConservativeDistanceThreshold", { get: l.prototype.Rz, set: l.prototype.xC });
        l.prototype.__destroy__ = function () { Xg(this.hy); };
        ...
        B.prototype.get_m_chassisConnectionCS = B.prototype.Lz = function () { return k(Yg(this.hy), p); };
        B.prototype.set_m_chassisConnectionCS = B.prototype.rC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Zg(c, a); };
        Object.defineProperty(B.prototype, "m_chassisConnectionCS", { get: B.prototype.Lz, set: B.prototype.rC });
        B.prototype.get_m_wheelDirectionCS = B.prototype.Ly = function () { return k($g(this.hy), p); };
        B.prototype.set_m_wheelDirectionCS = B.prototype.Uy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ah(c, a); };
        Object.defineProperty(B.prototype, "m_wheelDirectionCS", { get: B.prototype.Ly, set: B.prototype.Uy });
        B.prototype.get_m_wheelAxleCS = B.prototype.Ky = function () { return k(bh(this.hy), p); };
        B.prototype.set_m_wheelAxleCS = B.prototype.Ty = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ch(c, a); };
        Object.defineProperty(B.prototype, "m_wheelAxleCS", { get: B.prototype.Ky, set: B.prototype.Ty });
        B.prototype.get_m_suspensionRestLength = B.prototype.fB = function () { return dh(this.hy); };
        B.prototype.set_m_suspensionRestLength = B.prototype.MD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); eh(c, a); };
        Object.defineProperty(B.prototype, "m_suspensionRestLength", { get: B.prototype.fB, set: B.prototype.MD });
        B.prototype.get_m_maxSuspensionTravelCm = B.prototype.vy = function () { return fh(this.hy); };
        B.prototype.set_m_maxSuspensionTravelCm = B.prototype.Cy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); gh(c, a); };
        Object.defineProperty(B.prototype, "m_maxSuspensionTravelCm", { get: B.prototype.vy, set: B.prototype.Cy });
        B.prototype.get_m_wheelRadius = B.prototype.tB = function () { return hh(this.hy); };
        B.prototype.set_m_wheelRadius = B.prototype.$D = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ih(c, a); };
        Object.defineProperty(B.prototype, "m_wheelRadius", { get: B.prototype.tB, set: B.prototype.$D });
        B.prototype.get_m_suspensionStiffness = B.prototype.wy = function () { return jh(this.hy); };
        B.prototype.set_m_suspensionStiffness = B.prototype.Dy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); kh(c, a); };
        Object.defineProperty(B.prototype, "m_suspensionStiffness", { get: B.prototype.wy, set: B.prototype.Dy });
        B.prototype.get_m_wheelsDampingCompression = B.prototype.My = function () { return lh(this.hy); };
        B.prototype.set_m_wheelsDampingCompression = B.prototype.Vy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); mh(c, a); };
        Object.defineProperty(B.prototype, "m_wheelsDampingCompression", { get: B.prototype.My, set: B.prototype.Vy });
        B.prototype.get_m_wheelsDampingRelaxation = B.prototype.Ny = function () { return nh(this.hy); };
        B.prototype.set_m_wheelsDampingRelaxation = B.prototype.Wy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); oh(c, a); };
        Object.defineProperty(B.prototype, "m_wheelsDampingRelaxation", { get: B.prototype.Ny, set: B.prototype.Wy });
        B.prototype.get_m_frictionSlip = B.prototype.ry = function () { return ph(this.hy); };
        B.prototype.set_m_frictionSlip = B.prototype.yy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); qh(c, a); };
        Object.defineProperty(B.prototype, "m_frictionSlip", { get: B.prototype.ry, set: B.prototype.yy });
        B.prototype.get_m_maxSuspensionForce = B.prototype.uy = function () { return rh(this.hy); };
        B.prototype.set_m_maxSuspensionForce = B.prototype.By = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); sh(c, a); };
        Object.defineProperty(B.prototype, "m_maxSuspensionForce", { get: B.prototype.uy, set: B.prototype.By });
        B.prototype.get_m_bIsFrontWheel = B.prototype.Fy = function () { return !!th(this.hy); };
        B.prototype.set_m_bIsFrontWheel = B.prototype.Oy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); uh(c, a); };
        Object.defineProperty(B.prototype, "m_bIsFrontWheel", { get: B.prototype.Fy, set: B.prototype.Oy });
        B.prototype.__destroy__ = function () { vh(this.hy); };
        ...
        lB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yh(c, a); };
        lB.prototype.getLocalScaling = function () { return k(zh(this.hy), p); };
        lB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Ah(d, a, c); };
        lB.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Bh(c, a); };
        lB.prototype.getMargin = function () { return Ch(this.hy); };
        lB.prototype.__destroy__ = function () { Dh(this.hy); };
        ...
        QA.prototype.getOverlappingPairCache = function () { return k(Eh(this.hy), PA); };
        QA.prototype.__destroy__ = function () { Fh(this.hy); };
        ...
        C.prototype.get_m_linearDamping = C.prototype.xA = function () { return Ih(this.hy); };
        C.prototype.set_m_linearDamping = C.prototype.dD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Jh(c, a); };
        Object.defineProperty(C.prototype, "m_linearDamping", { get: C.prototype.xA, set: C.prototype.dD });
        C.prototype.get_m_angularDamping = C.prototype.Bz = function () { return Kh(this.hy); };
        C.prototype.set_m_angularDamping = C.prototype.hC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Lh(c, a); };
        Object.defineProperty(C.prototype, "m_angularDamping", { get: C.prototype.Bz, set: C.prototype.hC });
        C.prototype.get_m_friction = C.prototype.dA = function () { return Mh(this.hy); };
        C.prototype.set_m_friction = C.prototype.KC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Nh(c, a); };
        Object.defineProperty(C.prototype, "m_friction", { get: C.prototype.dA, set: C.prototype.KC });
        C.prototype.get_m_rollingFriction = C.prototype.TA = function () { return Oh(this.hy); };
        C.prototype.set_m_rollingFriction = C.prototype.zD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ph(c, a); };
        Object.defineProperty(C.prototype, "m_rollingFriction", { get: C.prototype.TA, set: C.prototype.zD });
        C.prototype.get_m_restitution = C.prototype.RA = function () { return Qh(this.hy); };
        C.prototype.set_m_restitution = C.prototype.xD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Rh(c, a); };
        Object.defineProperty(C.prototype, "m_restitution", { get: C.prototype.RA, set: C.prototype.xD });
        C.prototype.get_m_linearSleepingThreshold = C.prototype.yA = function () { return Sh(this.hy); };
        C.prototype.set_m_linearSleepingThreshold = C.prototype.eD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Th(c, a); };
        Object.defineProperty(C.prototype, "m_linearSleepingThreshold", { get: C.prototype.yA, set: C.prototype.eD });
        C.prototype.get_m_angularSleepingThreshold = C.prototype.Cz = function () { return Uh(this.hy); };
        C.prototype.set_m_angularSleepingThreshold = C.prototype.iC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vh(c, a); };
        Object.defineProperty(C.prototype, "m_angularSleepingThreshold", { get: C.prototype.Cz, set: C.prototype.iC });
        C.prototype.get_m_additionalDamping = C.prototype.wz = function () { return !!Wh(this.hy); };
        C.prototype.set_m_additionalDamping = C.prototype.cC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xh(c, a); };
        Object.defineProperty(C.prototype, "m_additionalDamping", { get: C.prototype.wz, set: C.prototype.cC });
        C.prototype.get_m_additionalDampingFactor = C.prototype.xz = function () { return Yh(this.hy); };
        C.prototype.set_m_additionalDampingFactor = C.prototype.dC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Zh(c, a); };
        Object.defineProperty(C.prototype, "m_additionalDampingFactor", { get: C.prototype.xz, set: C.prototype.dC });
        C.prototype.get_m_additionalLinearDampingThresholdSqr = C.prototype.yz = function () { return $h(this.hy); };
        C.prototype.set_m_additionalLinearDampingThresholdSqr = C.prototype.eC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ai(c, a); };
        Object.defineProperty(C.prototype, "m_additionalLinearDampingThresholdSqr", { get: C.prototype.yz, set: C.prototype.eC });
        C.prototype.get_m_additionalAngularDampingThresholdSqr = C.prototype.vz = function () { return bi(this.hy); };
        C.prototype.set_m_additionalAngularDampingThresholdSqr = C.prototype.bC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ci(c, a); };
        Object.defineProperty(C.prototype, "m_additionalAngularDampingThresholdSqr", { get: C.prototype.vz, set: C.prototype.bC });
        C.prototype.get_m_additionalAngularDampingFactor = C.prototype.uz = function () { return di(this.hy); };
        C.prototype.set_m_additionalAngularDampingFactor = C.prototype.aC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ei(c, a); };
        Object.defineProperty(C.prototype, "m_additionalAngularDampingFactor", { get: C.prototype.uz, set: C.prototype.aC });
        C.prototype.__destroy__ = function () { fi(this.hy); };
        ...
        mB.prototype.__destroy__ = function () { gi(this.hy); };
        ...
        dB.prototype.getBody0 = function () { return k(ii(this.hy), q); };
        dB.prototype.getBody1 = function () { return k(ji(this.hy), q); };
        dB.prototype.getNumContacts = function () { return ki(this.hy); };
        dB.prototype.getContactPoint = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(li(c, a), D); };
        dB.prototype.__destroy__ = function () { mi(this.hy); };
        ...
        nB.prototype.addChildShape = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); pi(d, a, c); };
        nB.prototype.removeChildShape = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); qi(c, a); };
        nB.prototype.removeChildShapeByIndex = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ri(c, a); };
        nB.prototype.getNumChildShapes = function () { return si(this.hy); };
        nB.prototype.getChildShape = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(ti(c, a), m); };
        nB.prototype.updateChildTransform = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === d ? ui(e, a, c) : vi(e, a, c, d); };
        nB.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); wi(c, a); };
        nB.prototype.getMargin = function () { return xi(this.hy); };
        nB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yi(c, a); };
        nB.prototype.getLocalScaling = function () { return k(zi(this.hy), p); };
        nB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Ai(d, a, c); };
        nB.prototype.__destroy__ = function () { Bi(this.hy); };
        ...
        E.prototype.hasHit = function () { return !!Di(this.hy); };
        E.prototype.get_m_convexFromWorld = E.prototype.Sz = function () { return k(Ei(this.hy), p); };
        E.prototype.set_m_convexFromWorld = E.prototype.yC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Fi(c, a); };
        Object.defineProperty(E.prototype, "m_convexFromWorld", { get: E.prototype.Sz, set: E.prototype.yC });
        E.prototype.get_m_convexToWorld = E.prototype.Tz = function () { return k(Gi(this.hy), p); };
        E.prototype.set_m_convexToWorld = E.prototype.zC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Hi(c, a); };
        Object.defineProperty(E.prototype, "m_convexToWorld", { get: E.prototype.Tz, set: E.prototype.zC });
        E.prototype.get_m_hitNormalWorld = E.prototype.sy = function () { return k(Ii(this.hy), p); };
        E.prototype.set_m_hitNormalWorld = E.prototype.zy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ji(c, a); };
        Object.defineProperty(E.prototype, "m_hitNormalWorld", { get: E.prototype.sy, set: E.prototype.zy });
        E.prototype.get_m_hitPointWorld = E.prototype.ty = function () { return k(Ki(this.hy), p); };
        E.prototype.set_m_hitPointWorld = E.prototype.Ay = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Li(c, a); };
        Object.defineProperty(E.prototype, "m_hitPointWorld", { get: E.prototype.ty, set: E.prototype.Ay });
        E.prototype.get_m_collisionFilterGroup = E.prototype.ky = function () { return Mi(this.hy); };
        E.prototype.set_m_collisionFilterGroup = E.prototype.my = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ni(c, a); };
        Object.defineProperty(E.prototype, "m_collisionFilterGroup", { get: E.prototype.ky, set: E.prototype.my });
        E.prototype.get_m_collisionFilterMask = E.prototype.ly = function () { return Oi(this.hy); };
        E.prototype.set_m_collisionFilterMask = E.prototype.ny = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pi(c, a); };
        Object.defineProperty(E.prototype, "m_collisionFilterMask", { get: E.prototype.ly, set: E.prototype.ny });
        E.prototype.get_m_closestHitFraction = E.prototype.oy = function () { return Qi(this.hy); };
        E.prototype.set_m_closestHitFraction = E.prototype.py = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ri(c, a); };
        Object.defineProperty(E.prototype, "m_closestHitFraction", { get: E.prototype.oy, set: E.prototype.py });
        E.prototype.__destroy__ = function () { Si(this.hy); };
        ...
        G.prototype.hasHit = function () { return !!Ui(this.hy); };
        G.prototype.get_m_collisionObjects = G.prototype.Oz = function () { return k(Vi(this.hy), oB); };
        G.prototype.set_m_collisionObjects = G.prototype.uC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wi(c, a); };
        Object.defineProperty(G.prototype, "m_collisionObjects", { get: G.prototype.Oz, set: G.prototype.uC });
        G.prototype.get_m_rayFromWorld = G.prototype.Iy = function () { return k(Xi(this.hy), p); };
        G.prototype.set_m_rayFromWorld = G.prototype.Ry = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Yi(c, a); };
        Object.defineProperty(G.prototype, "m_rayFromWorld", { get: G.prototype.Iy, set: G.prototype.Ry });
        G.prototype.get_m_rayToWorld = G.prototype.Jy = function () { return k(Zi(this.hy), p); };
        G.prototype.set_m_rayToWorld = G.prototype.Sy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); $i(c, a); };
        Object.defineProperty(G.prototype, "m_rayToWorld", { get: G.prototype.Jy, set: G.prototype.Sy });
        G.prototype.get_m_hitNormalWorld = G.prototype.sy = function () { return k(aj(this.hy), pB); };
        G.prototype.set_m_hitNormalWorld = G.prototype.zy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); bj(c, a); };
        Object.defineProperty(G.prototype, "m_hitNormalWorld", { get: G.prototype.sy, set: G.prototype.zy });
        G.prototype.get_m_hitPointWorld = G.prototype.ty = function () { return k(cj(this.hy), pB); };
        G.prototype.set_m_hitPointWorld = G.prototype.Ay = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); dj(c, a); };
        Object.defineProperty(G.prototype, "m_hitPointWorld", { get: G.prototype.ty, set: G.prototype.Ay });
        G.prototype.get_m_hitFractions = G.prototype.kA = function () { return k(ej(this.hy), kB); };
        G.prototype.set_m_hitFractions = G.prototype.RC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); fj(c, a); };
        Object.defineProperty(G.prototype, "m_hitFractions", { get: G.prototype.kA, set: G.prototype.RC });
        G.prototype.get_m_collisionFilterGroup = G.prototype.ky = function () { return gj(this.hy); };
        G.prototype.set_m_collisionFilterGroup = G.prototype.my = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); hj(c, a); };
        Object.defineProperty(G.prototype, "m_collisionFilterGroup", { get: G.prototype.ky, set: G.prototype.my });
        G.prototype.get_m_collisionFilterMask = G.prototype.ly = function () { return ij(this.hy); };
        G.prototype.set_m_collisionFilterMask = G.prototype.ny = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); jj(c, a); };
        Object.defineProperty(G.prototype, "m_collisionFilterMask", { get: G.prototype.ly, set: G.prototype.ny });
        G.prototype.get_m_closestHitFraction = G.prototype.oy = function () { return kj(this.hy); };
        G.prototype.set_m_closestHitFraction = G.prototype.py = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); lj(c, a); };
        Object.defineProperty(G.prototype, "m_closestHitFraction", { get: G.prototype.oy, set: G.prototype.py });
        G.prototype.get_m_collisionObject = G.prototype.qy = function () { return k(mj(this.hy), q); };
        G.prototype.set_m_collisionObject = G.prototype.xy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); nj(c, a); };
        Object.defineProperty(G.prototype, "m_collisionObject", { get: G.prototype.qy, set: G.prototype.xy });
        G.prototype.__destroy__ = function () { oj(this.hy); };
        ...
        qB.jy = {};
        b.tMaterialArray = qB;
        qB.prototype.size = qB.prototype.size = function () { return pj(this.hy); };
        qB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(qj(c, a), A); };
        qB.prototype.__destroy__ = function () { rj(this.hy); };
        ...
        rB.prototype.castRay = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); tj(e, a, c, d); };
        rB.prototype.__destroy__ = function () { uj(this.hy); };
        ...
        sB.jy = {};
        b.btEmptyShape = sB;
        sB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); wj(c, a); };
        sB.prototype.getLocalScaling = function () { return k(xj(this.hy), p); };
        sB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); yj(d, a, c); };
        sB.prototype.__destroy__ = function () { zj(this.hy); };
        ...
        H.prototype.get_m_tau = H.prototype.hB = function () { return Bj(this.hy); };
        H.prototype.set_m_tau = H.prototype.OD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Cj(c, a); };
        Object.defineProperty(H.prototype, "m_tau", { get: H.prototype.hB, set: H.prototype.OD });
        H.prototype.get_m_damping = H.prototype.Uz = function () { return Dj(this.hy); };
        H.prototype.set_m_damping = H.prototype.AC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ej(c, a); };
        Object.defineProperty(H.prototype, "m_damping", { get: H.prototype.Uz, set: H.prototype.AC });
        H.prototype.get_m_impulseClamp = H.prototype.qA = function () { return Fj(this.hy); };
        H.prototype.set_m_impulseClamp = H.prototype.XC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Gj(c, a); };
        Object.defineProperty(H.prototype, "m_impulseClamp", { get: H.prototype.qA, set: H.prototype.XC });
        H.prototype.__destroy__ = function () { Hj(this.hy); };
        ...
        tB.jy = {};
        b.LocalShapeInfo = tB;
        tB.prototype.get_m_shapePart = tB.prototype.WA = function () { return Ij(this.hy); };
        tB.prototype.set_m_shapePart = tB.prototype.CD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Jj(c, a); };
        Object.defineProperty(tB.prototype, "m_shapePart", { get: tB.prototype.WA, set: tB.prototype.CD });
        tB.prototype.get_m_triangleIndex = tB.prototype.kB = function () { return Kj(this.hy); };
        tB.prototype.set_m_triangleIndex = tB.prototype.RD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Lj(c, a); };
        Object.defineProperty(tB.prototype, "m_triangleIndex", { get: tB.prototype.kB, set: tB.prototype.RD });
        tB.prototype.__destroy__ = function () { Mj(this.hy); };
        ...
        I.jy = {};
        b.btRigidBody = I;
        I.prototype.getCenterOfMassTransform = function () { return k(Oj(this.hy), r); };
        I.prototype.setCenterOfMassTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pj(c, a); };
        I.prototype.setSleepingThresholds = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Qj(d, a, c); };
        I.prototype.getLinearDamping = function () { return Rj(this.hy); };
        I.prototype.getAngularDamping = function () { return Sj(this.hy); };
        I.prototype.setDamping = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Tj(d, a, c); };
        I.prototype.setMassProps = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Uj(d, a, c); };
        I.prototype.getLinearFactor = function () { return k(Vj(this.hy), p); };
        I.prototype.setLinearFactor = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wj(c, a); };
        I.prototype.applyTorque = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xj(c, a); };
        I.prototype.applyLocalTorque = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Yj(c, a); };
        I.prototype.applyForce = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Zj(d, a, c); };
        I.prototype.applyCentralForce = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ak(c, a); };
        I.prototype.applyCentralLocalForce = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); bk(c, a); };
        I.prototype.applyTorqueImpulse = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ck(c, a); };
        I.prototype.applyImpulse = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); dk(d, a, c); };
        I.prototype.applyCentralImpulse = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ek(c, a); };
        I.prototype.updateInertiaTensor = function () { fk(this.hy); };
        I.prototype.getLinearVelocity = function () { return k(gk(this.hy), p); };
        I.prototype.getAngularVelocity = function () { return k(hk(this.hy), p); };
        I.prototype.setLinearVelocity = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ik(c, a); };
        I.prototype.setAngularVelocity = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); jk(c, a); };
        I.prototype.getMotionState = function () { return k(kk(this.hy), gB); };
        I.prototype.setMotionState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); lk(c, a); };
        I.prototype.getAngularFactor = function () { return k(mk(this.hy), p); };
        I.prototype.setAngularFactor = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); nk(c, a); };
        I.prototype.upcast = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(ok(c, a), I); };
        I.prototype.getAabb = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); pk(d, a, c); };
        I.prototype.applyGravity = function () { qk(this.hy); };
        I.prototype.getGravity = function () { return k(rk(this.hy), p); };
        I.prototype.setGravity = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); sk(c, a); };
        I.prototype.getBroadphaseProxy = function () { return k(tk(this.hy), t); };
        I.prototype.clearForces = function () { uk(this.hy); };
        I.prototype.setAnisotropicFriction = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); vk(d, a, c); };
        I.prototype.getCollisionShape = function () { return k(wk(this.hy), m); };
        I.prototype.setContactProcessingThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); xk(c, a); };
        I.prototype.setActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yk(c, a); };
        I.prototype.forceActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); zk(c, a); };
        I.prototype.activate = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); void 0 === a ? Ak(c) : Bk(c, a); };
        I.prototype.isActive = function () { return !!Ck(this.hy); };
        I.prototype.isKinematicObject = function () { return !!Dk(this.hy); };
        I.prototype.isStaticObject = function () { return !!Ek(this.hy); };
        I.prototype.isStaticOrKinematicObject = function () { return !!Fk(this.hy); };
        I.prototype.getRestitution = function () { return Gk(this.hy); };
        I.prototype.getFriction = function () { return Hk(this.hy); };
        I.prototype.getRollingFriction = function () { return Ik(this.hy); };
        I.prototype.setRestitution = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Jk(c, a); };
        I.prototype.setFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Kk(c, a); };
        I.prototype.setRollingFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Lk(c, a); };
        I.prototype.getWorldTransform = function () { return k(Mk(this.hy), r); };
        I.prototype.getCollisionFlags = function () { return Nk(this.hy); };
        I.prototype.setCollisionFlags = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ok(c, a); };
        I.prototype.setWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pk(c, a); };
        I.prototype.setCollisionShape = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qk(c, a); };
        I.prototype.setCcdMotionThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Rk(c, a); };
        I.prototype.setCcdSweptSphereRadius = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Sk(c, a); };
        I.prototype.getUserIndex = function () { return Tk(this.hy); };
        I.prototype.setUserIndex = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Uk(c, a); };
        I.prototype.getUserPointer = function () { return k(Vk(this.hy), SA); };
        I.prototype.setUserPointer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wk(c, a); };
        I.prototype.getBroadphaseHandle = function () { return k(Xk(this.hy), t); };
        I.prototype.__destroy__ = function () { Yk(this.hy); };
        ...
        uB.prototype.size = uB.prototype.size = function () { return Zk(this.hy); };
        uB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k($k(c, a), vB); };
        uB.prototype.__destroy__ = function () { al(this.hy); };
        ...
        wB.prototype.__destroy__ = function () { cl(this.hy); };
        ...
        xB.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); el(c, a); };
        xB.prototype.getMargin = function () { return fl(this.hy); };
        xB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); gl(c, a); };
        xB.prototype.getLocalScaling = function () { return k(hl(this.hy), p); };
        xB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); il(d, a, c); };
        xB.prototype.__destroy__ = function () { jl(this.hy); };
        ...
        yB.prototype.__destroy__ = function () { ll(this.hy); };
        ...
        zB.prototype.getNumManifolds = function () { return nl(this.hy); };
        zB.prototype.getManifoldByIndexInternal = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(ol(c, a), dB); };
        zB.prototype.__destroy__ = function () { pl(this.hy); };
        ...
        AB.jy = {};
        b.btAxisSweep3 = AB;
        AB.prototype.__destroy__ = function () { ul(this.hy); };
        ...
        SA.jy = {};
        b.VoidPtr = SA;
        SA.prototype.__destroy__ = function () { vl(this.hy); };
        ...
        J.prototype.get_air_density = J.prototype.Yy = function () { return xl(this.hy); };
        J.prototype.set_air_density = J.prototype.FB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yl(c, a); };
        Object.defineProperty(J.prototype, "air_density", { get: J.prototype.Yy, set: J.prototype.FB });
        J.prototype.get_water_density = J.prototype.CB = function () { return zl(this.hy); };
        J.prototype.set_water_density = J.prototype.iE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Al(c, a); };
        Object.defineProperty(J.prototype, "water_density", { get: J.prototype.CB, set: J.prototype.iE });
        J.prototype.get_water_offset = J.prototype.EB = function () { return Bl(this.hy); };
        J.prototype.set_water_offset = J.prototype.kE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Cl(c, a); };
        Object.defineProperty(J.prototype, "water_offset", { get: J.prototype.EB, set: J.prototype.kE });
        J.prototype.get_m_maxDisplacement = J.prototype.EA = function () { return Dl(this.hy); };
        J.prototype.set_m_maxDisplacement = J.prototype.kD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); El(c, a); };
        Object.defineProperty(J.prototype, "m_maxDisplacement", { get: J.prototype.EA, set: J.prototype.kD });
        J.prototype.get_water_normal = J.prototype.DB = function () { return k(Fl(this.hy), p); };
        J.prototype.set_water_normal = J.prototype.jE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Gl(c, a); };
        Object.defineProperty(J.prototype, "water_normal", { get: J.prototype.DB, set: J.prototype.jE });
        J.prototype.get_m_broadphase = J.prototype.Gz = function () { return k(Hl(this.hy), QA); };
        J.prototype.set_m_broadphase = J.prototype.mC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Il(c, a); };
        Object.defineProperty(J.prototype, "m_broadphase", { get: J.prototype.Gz, set: J.prototype.mC });
        J.prototype.get_m_dispatcher = J.prototype.Xz = function () { return k(Jl(this.hy), OA); };
        J.prototype.set_m_dispatcher = J.prototype.DC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Kl(c, a); };
        Object.defineProperty(J.prototype, "m_dispatcher", { get: J.prototype.Xz, set: J.prototype.DC });
        J.prototype.get_m_gravity = J.prototype.fA = function () { return k(Ll(this.hy), p); };
        J.prototype.set_m_gravity = J.prototype.MC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ml(c, a); };
        Object.defineProperty(J.prototype, "m_gravity", { get: J.prototype.fA, set: J.prototype.MC });
        J.prototype.__destroy__ = function () { Nl(this.hy); };
        ...
        BB.prototype.setLimit = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Ql(d, a, c); };
        BB.prototype.setAngularOnly = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Rl(c, a); };
        BB.prototype.setDamping = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Sl(c, a); };
        BB.prototype.enableMotor = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Tl(c, a); };
        BB.prototype.setMaxMotorImpulse = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ul(c, a); };
        BB.prototype.setMaxMotorImpulseNormalized = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vl(c, a); };
        BB.prototype.setMotorTarget = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wl(c, a); };
        BB.prototype.setMotorTargetInConstraintSpace = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xl(c, a); };
        BB.prototype.enableFeedback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Yl(c, a); };
        BB.prototype.getBreakingImpulseThreshold = function () { return Zl(this.hy); };
        BB.prototype.setBreakingImpulseThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); $l(c, a); };
        BB.prototype.getParam = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return am(d, a, c); };
        BB.prototype.setParam = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); bm(e, a, c, d); };
        BB.prototype.__destroy__ = function () { cm(this.hy); };
        ...
        CB.prototype.setLimit = function (a, c, d, e, g) { var n = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); void 0 === g ? jm(n, a, c, d, e) : km(n, a, c, d, e, g); };
        CB.prototype.enableAngularMotor = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); lm(e, a, c, d); };
        CB.prototype.setAngularOnly = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); mm(c, a); };
        CB.prototype.enableMotor = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); nm(c, a); };
        CB.prototype.setMaxMotorImpulse = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); om(c, a); };
        CB.prototype.setMotorTarget = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); pm(d, a, c); };
        CB.prototype.enableFeedback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); qm(c, a); };
        CB.prototype.getBreakingImpulseThreshold = function () { return rm(this.hy); };
        CB.prototype.setBreakingImpulseThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); sm(c, a); };
        CB.prototype.getParam = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return tm(d, a, c); };
        CB.prototype.setParam = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); um(e, a, c, d); };
        CB.prototype.__destroy__ = function () { wm(this.hy); };
        ...
        DB.jy = {};
        b.btConeShapeZ = DB;
        DB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ym(c, a); };
        DB.prototype.getLocalScaling = function () { return k(zm(this.hy), p); };
        DB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Am(d, a, c); };
        DB.prototype.__destroy__ = function () { Bm(this.hy); };
        ...
        EB.jy = {};
        b.btConeShapeX = EB;
        EB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Dm(c, a); };
        EB.prototype.getLocalScaling = function () { return k(Em(this.hy), p); };
        EB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Fm(d, a, c); };
        EB.prototype.__destroy__ = function () { Gm(this.hy); };
        ...
        FB.jy = {};
        b.btTriangleMesh = FB;
        FB.prototype.addTriangle = function (a, c, d, e) { var g = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); void 0 === e ? Km(g, a, c, d) : Lm(g, a, c, d, e); };
        FB.prototype.findOrAddVertex = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return Mm(d, a, c); };
        FB.prototype.addIndex = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Nm(c, a); };
        FB.prototype.getIndexedMeshArray = function () { return k(Om(this.hy), uB); };
        FB.prototype.setScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pm(c, a); };
        FB.prototype.__destroy__ = function () { Qm(this.hy); };
        ...
        GB.prototype.addPoint = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); void 0 === c ? Um(d, a) : Vm(d, a, c); };
        GB.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wm(c, a); };
        GB.prototype.getMargin = function () { return Xm(this.hy); };
        GB.prototype.getNumVertices = function () { return Ym(this.hy); };
        GB.prototype.initializePolyhedralFeatures = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return !!Zm(c, a); };
        GB.prototype.recalcLocalAabb = function () { $m(this.hy); };
        GB.prototype.getConvexPolyhedron = function () { return k(an(this.hy), HB); };
        GB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); bn(c, a); };
        GB.prototype.getLocalScaling = function () { return k(cn(this.hy), p); };
        GB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); dn(d, a, c); };
        GB.prototype.__destroy__ = function () { en(this.hy); };
        ...
        K.jy = {};
        b.btVehicleTuning = K;
        K.prototype.get_m_suspensionStiffness = K.prototype.wy = function () { return gn(this.hy); };
        K.prototype.set_m_suspensionStiffness = K.prototype.Dy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); hn(c, a); };
        Object.defineProperty(K.prototype, "m_suspensionStiffness", { get: K.prototype.wy, set: K.prototype.Dy });
        K.prototype.get_m_suspensionCompression = K.prototype.bB = function () { return jn(this.hy); };
        K.prototype.set_m_suspensionCompression = K.prototype.ID = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); kn(c, a); };
        Object.defineProperty(K.prototype, "m_suspensionCompression", { get: K.prototype.bB, set: K.prototype.ID });
        K.prototype.get_m_suspensionDamping = K.prototype.cB = function () { return ln(this.hy); };
        K.prototype.set_m_suspensionDamping = K.prototype.JD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); mn(c, a); };
        Object.defineProperty(K.prototype, "m_suspensionDamping", { get: K.prototype.cB, set: K.prototype.JD });
        K.prototype.get_m_maxSuspensionTravelCm = K.prototype.vy = function () { return nn(this.hy); };
        K.prototype.set_m_maxSuspensionTravelCm = K.prototype.Cy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); on(c, a); };
        Object.defineProperty(K.prototype, "m_maxSuspensionTravelCm", { get: K.prototype.vy, set: K.prototype.Cy });
        K.prototype.get_m_frictionSlip = K.prototype.ry = function () { return pn(this.hy); };
        K.prototype.set_m_frictionSlip = K.prototype.yy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); qn(c, a); };
        Object.defineProperty(K.prototype, "m_frictionSlip", { get: K.prototype.ry, set: K.prototype.yy });
        K.prototype.get_m_maxSuspensionForce = K.prototype.uy = function () { return rn(this.hy); };
        K.prototype.set_m_maxSuspensionForce = K.prototype.By = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); sn(c, a); };
        ...
        IB.prototype.getWorldTransform = function () { return k(tn(this.hy), r); };
        IB.prototype.getCollisionObject = function () { return k(un(this.hy), q); };
        IB.prototype.getCollisionShape = function () { return k(vn(this.hy), m); };
        ...
        JB.jy = {};
        b.btShapeHull = JB;
        JB.prototype.buildHull = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return !!xn(c, a); };
        JB.prototype.numVertices = function () { return yn(this.hy); };
        JB.prototype.getVertexPointer = function () { return k(zn(this.hy), p); };
        JB.prototype.__destroy__ = function () { An(this.hy); };
        ...
        KB.prototype.getWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); En(c, a); };
        KB.prototype.setWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Fn(c, a); };
        KB.prototype.get_m_graphicsWorldTrans = KB.prototype.eA = function () { return k(Gn(this.hy), r); };
        KB.prototype.set_m_graphicsWorldTrans = KB.prototype.LC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Hn(c, a); };
        Object.defineProperty(KB.prototype, "m_graphicsWorldTrans", { get: KB.prototype.eA, set: KB.prototype.LC });
        KB.prototype.__destroy__ = function () { In(this.hy); };
        ...
        L.jy = {};
        b.btWheelInfo = L;
        L.prototype.getSuspensionRestLength = function () { return Kn(this.hy); };
        L.prototype.updateWheel = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Ln(d, a, c); };
        L.prototype.get_m_suspensionStiffness = L.prototype.wy = function () { return Mn(this.hy); };
        L.prototype.set_m_suspensionStiffness = L.prototype.Dy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Nn(c, a); };
        Object.defineProperty(L.prototype, "m_suspensionStiffness", { get: L.prototype.wy, set: L.prototype.Dy });
        L.prototype.get_m_frictionSlip = L.prototype.ry = function () { return On(this.hy); };
        L.prototype.set_m_frictionSlip = L.prototype.yy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pn(c, a); };
        Object.defineProperty(L.prototype, "m_frictionSlip", { get: L.prototype.ry, set: L.prototype.yy });
        L.prototype.get_m_engineForce = L.prototype.aA = function () { return Qn(this.hy); };
        L.prototype.set_m_engineForce = L.prototype.HC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Rn(c, a); };
        Object.defineProperty(L.prototype, "m_engineForce", { get: L.prototype.aA, set: L.prototype.HC });
        L.prototype.get_m_rollInfluence = L.prototype.SA = function () { return Sn(this.hy); };
        L.prototype.set_m_rollInfluence = L.prototype.yD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Tn(c, a); };
        Object.defineProperty(L.prototype, "m_rollInfluence", { get: L.prototype.SA, set: L.prototype.yD });
        L.prototype.get_m_suspensionRestLength1 = L.prototype.gB = function () { return Un(this.hy); };
        L.prototype.set_m_suspensionRestLength1 = L.prototype.ND = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vn(c, a); };
        Object.defineProperty(L.prototype, "m_suspensionRestLength1", { get: L.prototype.gB, set: L.prototype.ND });
        L.prototype.get_m_wheelsRadius = L.prototype.uB = function () { return Wn(this.hy); };
        L.prototype.set_m_wheelsRadius = L.prototype.aE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xn(c, a); };
        Object.defineProperty(L.prototype, "m_wheelsRadius", { get: L.prototype.uB, set: L.prototype.aE });
        L.prototype.get_m_wheelsDampingCompression = L.prototype.My = function () { return Yn(this.hy); };
        L.prototype.set_m_wheelsDampingCompression = L.prototype.Vy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Zn(c, a); };
        Object.defineProperty(L.prototype, "m_wheelsDampingCompression", { get: L.prototype.My, set: L.prototype.Vy });
        L.prototype.get_m_wheelsDampingRelaxation = L.prototype.Ny = function () { return $n(this.hy); };
        L.prototype.set_m_wheelsDampingRelaxation = L.prototype.Wy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ao(c, a); };
        Object.defineProperty(L.prototype, "m_wheelsDampingRelaxation", { get: L.prototype.Ny, set: L.prototype.Wy });
        L.prototype.get_m_steering = L.prototype.$A = function () { return bo(this.hy); };
        L.prototype.set_m_steering = L.prototype.GD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); co(c, a); };
        Object.defineProperty(L.prototype, "m_steering", { get: L.prototype.$A, set: L.prototype.GD });
        L.prototype.get_m_maxSuspensionForce = L.prototype.uy = function () { return eo(this.hy); };
        L.prototype.set_m_maxSuspensionForce = L.prototype.By = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); fo(c, a); };
        Object.defineProperty(L.prototype, "m_maxSuspensionForce", { get: L.prototype.uy, set: L.prototype.By });
        L.prototype.get_m_maxSuspensionTravelCm = L.prototype.vy = function () { return go(this.hy); };
        L.prototype.set_m_maxSuspensionTravelCm = L.prototype.Cy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ho(c, a); };
        Object.defineProperty(L.prototype, "m_maxSuspensionTravelCm", { get: L.prototype.vy, set: L.prototype.Cy });
        L.prototype.get_m_wheelsSuspensionForce = L.prototype.vB = function () { return io(this.hy); };
        L.prototype.set_m_wheelsSuspensionForce = L.prototype.bE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); jo(c, a); };
        Object.defineProperty(L.prototype, "m_wheelsSuspensionForce", { get: L.prototype.vB, set: L.prototype.bE });
        L.prototype.get_m_bIsFrontWheel = L.prototype.Fy = function () { return !!ko(this.hy); };
        L.prototype.set_m_bIsFrontWheel = L.prototype.Oy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); lo(c, a); };
        Object.defineProperty(L.prototype, "m_bIsFrontWheel", { get: L.prototype.Fy, set: L.prototype.Oy });
        L.prototype.get_m_raycastInfo = L.prototype.QA = function () { return k(mo(this.hy), M); };
        L.prototype.set_m_raycastInfo = L.prototype.wD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); no(c, a); };
        Object.defineProperty(L.prototype, "m_raycastInfo", { get: L.prototype.QA, set: L.prototype.wD });
        L.prototype.get_m_chassisConnectionPointCS = L.prototype.Mz = function () { return k(oo(this.hy), p); };
        L.prototype.set_m_chassisConnectionPointCS = L.prototype.sC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); po(c, a); };
        Object.defineProperty(L.prototype, "m_chassisConnectionPointCS", { get: L.prototype.Mz, set: L.prototype.sC });
        L.prototype.get_m_worldTransform = L.prototype.wB = function () { return k(qo(this.hy), r); };
        L.prototype.set_m_worldTransform = L.prototype.cE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ro(c, a); };
        Object.defineProperty(L.prototype, "m_worldTransform", { get: L.prototype.wB, set: L.prototype.cE });
        L.prototype.get_m_wheelDirectionCS = L.prototype.Ly = function () { return k(so(this.hy), p); };
        L.prototype.set_m_wheelDirectionCS = L.prototype.Uy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); to(c, a); };
        Object.defineProperty(L.prototype, "m_wheelDirectionCS", { get: L.prototype.Ly, set: L.prototype.Uy });
        L.prototype.get_m_wheelAxleCS = L.prototype.Ky = function () { return k(uo(this.hy), p); };
        L.prototype.set_m_wheelAxleCS = L.prototype.Ty = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); vo(c, a); };
        Object.defineProperty(L.prototype, "m_wheelAxleCS", { get: L.prototype.Ky, set: L.prototype.Ty });
        L.prototype.get_m_rotation = L.prototype.UA = function () { return wo(this.hy); };
        L.prototype.set_m_rotation = L.prototype.AD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); xo(c, a); };
        Object.defineProperty(L.prototype, "m_rotation", { get: L.prototype.UA, set: L.prototype.AD });
        L.prototype.get_m_deltaRotation = L.prototype.Vz = function () { return yo(this.hy); };
        L.prototype.set_m_deltaRotation = L.prototype.BC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); zo(c, a); };
        Object.defineProperty(L.prototype, "m_deltaRotation", { get: L.prototype.Vz, set: L.prototype.BC });
        L.prototype.get_m_brake = L.prototype.Fz = function () { return Ao(this.hy); };
        L.prototype.set_m_brake = L.prototype.lC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Bo(c, a); };
        Object.defineProperty(L.prototype, "m_brake", { get: L.prototype.Fz, set: L.prototype.lC });
        L.prototype.get_m_clippedInvContactDotSuspension = L.prototype.Nz = function () { return Co(this.hy); };
        L.prototype.set_m_clippedInvContactDotSuspension = L.prototype.tC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Do(c, a); };
        Object.defineProperty(L.prototype, "m_clippedInvContactDotSuspension", { get: L.prototype.Nz, set: L.prototype.tC });
        L.prototype.get_m_suspensionRelativeVelocity = L.prototype.eB = function () { return Eo(this.hy); };
        L.prototype.set_m_suspensionRelativeVelocity = L.prototype.LD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Fo(c, a); };
        Object.defineProperty(L.prototype, "m_suspensionRelativeVelocity", { get: L.prototype.eB, set: L.prototype.LD });
        L.prototype.get_m_skidInfo = L.prototype.XA = function () { return Go(this.hy); };
        L.prototype.set_m_skidInfo = L.prototype.DD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ho(c, a); };
        Object.defineProperty(L.prototype, "m_skidInfo", { get: L.prototype.XA, set: L.prototype.DD });
        L.prototype.__destroy__ = function () { Io(this.hy); };
        ...
        N.jy = {};
        b.btVector4 = N;
        N.prototype.w = function () { return Lo(this.hy); };
        N.prototype.setValue = function (a, c, d, e) { var g = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); Mo(g, a, c, d, e); };
        N.prototype.length = N.prototype.length = function () { return No(this.hy); };
        N.prototype.x = N.prototype.x = function () { return Oo(this.hy); };
        N.prototype.y = N.prototype.y = function () { return Po(this.hy); };
        N.prototype.z = N.prototype.z = function () { return Qo(this.hy); };
        N.prototype.setX = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ro(c, a); };
        N.prototype.setY = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); So(c, a); };
        N.prototype.setZ = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); To(c, a); };
        N.prototype.normalize = N.prototype.normalize = function () { Uo(this.hy); };
        N.prototype.rotate = N.prototype.rotate = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return k(Vo(d, a, c), p); };
        N.prototype.dot = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return Wo(c, a); };
        N.prototype.op_mul = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Xo(c, a), p); };
        N.prototype.op_add = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Yo(c, a), p); };
        N.prototype.op_sub = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Zo(c, a), p); };
        N.prototype.__destroy__ = function () { $o(this.hy); };
        ...
        LB.prototype.__destroy__ = function () { bp(this.hy); };
        ...
        O.jy = {};
        b.Anchor = O;
        O.prototype.get_m_node = O.prototype.FA = function () { return k(cp(this.hy), Node); };
        O.prototype.set_m_node = O.prototype.lD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); dp(c, a); };
        Object.defineProperty(O.prototype, "m_node", { get: O.prototype.FA, set: O.prototype.lD });
        O.prototype.get_m_local = O.prototype.zA = function () { return k(ep(this.hy), p); };
        O.prototype.set_m_local = O.prototype.fD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); fp(c, a); };
        Object.defineProperty(O.prototype, "m_local", { get: O.prototype.zA, set: O.prototype.fD });
        O.prototype.get_m_body = O.prototype.Ez = function () { return k(gp(this.hy), I); };
        O.prototype.set_m_body = O.prototype.kC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); hp(c, a); };
        Object.defineProperty(O.prototype, "m_body", { get: O.prototype.Ez, set: O.prototype.kC });
        O.prototype.get_m_influence = O.prototype.sA = function () { return ip(this.hy); };
        O.prototype.set_m_influence = O.prototype.ZC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); jp(c, a); };
        Object.defineProperty(O.prototype, "m_influence", { get: O.prototype.sA, set: O.prototype.ZC });
        O.prototype.get_m_c0 = O.prototype.Hz = function () { return k(kp(this.hy), jB); };
        O.prototype.set_m_c0 = O.prototype.nC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); lp(c, a); };
        Object.defineProperty(O.prototype, "m_c0", { get: O.prototype.Hz, set: O.prototype.nC });
        O.prototype.get_m_c1 = O.prototype.Iz = function () { return k(mp(this.hy), p); };
        O.prototype.set_m_c1 = O.prototype.oC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); np(c, a); };
        Object.defineProperty(O.prototype, "m_c1", { get: O.prototype.Iz, set: O.prototype.oC });
        O.prototype.get_m_c2 = O.prototype.Jz = function () { return op(this.hy); };
        O.prototype.set_m_c2 = O.prototype.pC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); pp(c, a); };
        Object.defineProperty(O.prototype, "m_c2", { get: O.prototype.Jz, set: O.prototype.pC });
        O.prototype.__destroy__ = function () { qp(this.hy); };
        ...
        P.prototype.get_m_hitPointInWorld = P.prototype.nA = function () { return k(rp(this.hy), p); };
        P.prototype.set_m_hitPointInWorld = P.prototype.UC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); sp(c, a); };
        Object.defineProperty(P.prototype, "m_hitPointInWorld", { get: P.prototype.nA, set: P.prototype.UC });
        P.prototype.get_m_hitNormalInWorld = P.prototype.lA = function () { return k(tp(this.hy), p); };
        P.prototype.set_m_hitNormalInWorld = P.prototype.SC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); up(c, a); };
        Object.defineProperty(P.prototype, "m_hitNormalInWorld", { get: P.prototype.lA, set: P.prototype.SC });
        P.prototype.get_m_distFraction = P.prototype.Yz = function () { return vp(this.hy); };
        P.prototype.set_m_distFraction = P.prototype.EC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); wp(c, a); };
        Object.defineProperty(P.prototype, "m_distFraction", { get: P.prototype.Yz, set: P.prototype.EC });
        P.prototype.__destroy__ = function () { xp(this.hy); };
        ...
        pB.jy = {};
        b.btVector3Array = pB;
        pB.prototype.size = pB.prototype.size = function () { return yp(this.hy); };
        pB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(zp(c, a), p); };
        pB.prototype.__destroy__ = function () { Ap(this.hy); };
        ...
        MB.prototype.__destroy__ = function () { Bp(this.hy); };
        ...
        Q.prototype.applyEngineForce = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Dp(d, a, c); };
        Q.prototype.setSteeringValue = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Ep(d, a, c); };
        Q.prototype.getWheelTransformWS = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Fp(c, a), r); };
        Q.prototype.updateWheelTransform = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Gp(d, a, c); };
        Q.prototype.addWheel = function (a, c, d, e, g, n, F) { var aa = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); n && "object" === typeof n && (n = n.hy); F && "object" === typeof F && (F = F.hy); return k(Hp(aa, a, c, d, e, g, n, F), L); };
        Q.prototype.getNumWheels = function () { return Ip(this.hy); };
        Q.prototype.getRigidBody = function () { return k(Jp(this.hy), I); };
        Q.prototype.getWheelInfo = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Kp(c, a), L); };
        Q.prototype.setBrake = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Lp(d, a, c); };
        Q.prototype.setCoordinateSystem = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Mp(e, a, c, d); };
        Q.prototype.getCurrentSpeedKmHour = function () { return Np(this.hy); };
        Q.prototype.getChassisWorldTransform = function () { return k(Op(this.hy), r); };
        Q.prototype.rayCast = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return Pp(c, a); };
        Q.prototype.updateVehicle = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qp(c, a); };
        Q.prototype.resetSuspension = function () { Rp(this.hy); };
        Q.prototype.getSteeringValue = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return Sp(c, a); };
        Q.prototype.updateWheelTransformsWS = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); void 0 === c ? Tp(d, a) : Up(d, a, c); };
        Q.prototype.setPitchControl = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vp(c, a); };
        Q.prototype.updateSuspension = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wp(c, a); };
        Q.prototype.updateFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xp(c, a); };
        Q.prototype.getRightAxis = function () { return Yp(this.hy); };
        Q.prototype.getUpAxis = function () { return Zp(this.hy); };
        Q.prototype.getForwardAxis = function () { return $p(this.hy); };
        Q.prototype.getForwardVector = function () { return k(aq(this.hy), p); };
        Q.prototype.getUserConstraintType = function () { return bq(this.hy); };
        Q.prototype.setUserConstraintType = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); cq(c, a); };
        Q.prototype.setUserConstraintId = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); dq(c, a); };
        Q.prototype.getUserConstraintId = function () { return eq(this.hy); };
        Q.prototype.updateAction = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); fq(d, a, c); };
        Q.prototype.__destroy__ = function () { gq(this.hy); };
        ...
        NB.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); iq(c, a); };
        NB.prototype.getMargin = function () { return jq(this.hy); };
        NB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); kq(c, a); };
        NB.prototype.getLocalScaling = function () { return k(lq(this.hy), p); };
        NB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); mq(d, a, c); };
        NB.prototype.__destroy__ = function () { nq(this.hy); };
        ...
        OB.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); pq(c, a); };
        OB.prototype.getMargin = function () { return qq(this.hy); };
        OB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); rq(c, a); };
        OB.prototype.getLocalScaling = function () { return k(sq(this.hy), p); };
        OB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); tq(d, a, c); };
        OB.prototype.__destroy__ = function () { uq(this.hy); };
        ...
        HB.prototype.get_m_vertices = HB.prototype.qB = function () { return k(vq(this.hy), pB); };
        HB.prototype.set_m_vertices = HB.prototype.XD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); wq(c, a); };
        Object.defineProperty(HB.prototype, "m_vertices", { get: HB.prototype.qB, set: HB.prototype.XD });
        HB.prototype.get_m_faces = HB.prototype.Gy = function () { return k(xq(this.hy), PB); };
        HB.prototype.set_m_faces = HB.prototype.Py = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yq(c, a); };
        Object.defineProperty(HB.prototype, "m_faces", { get: HB.prototype.Gy, set: HB.prototype.Py });
        HB.prototype.__destroy__ = function () { zq(this.hy); };
        ...
        QB.prototype.__destroy__ = function () { Bq(this.hy); };
        ...
        RB.jy = {};
        b.tAnchorArray = RB;
        RB.prototype.size = RB.prototype.size = function () { return Cq(this.hy); };
        RB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Dq(c, a), O); };
        RB.prototype.clear = RB.prototype.clear = function () { Eq(this.hy); };
        RB.prototype.push_back = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Fq(c, a); };
        RB.prototype.pop_back = function () { Gq(this.hy); };
        RB.prototype.__destroy__ = function () { Hq(this.hy); };
        ...
        M.jy = {};
        b.RaycastInfo = M;
        M.prototype.get_m_contactNormalWS = M.prototype.Pz = function () { return k(Iq(this.hy), p); };
        M.prototype.set_m_contactNormalWS = M.prototype.vC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Jq(c, a); };
        Object.defineProperty(M.prototype, "m_contactNormalWS", { get: M.prototype.Pz, set: M.prototype.vC });
        M.prototype.get_m_contactPointWS = M.prototype.Qz = function () { return k(Kq(this.hy), p); };
        M.prototype.set_m_contactPointWS = M.prototype.wC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Lq(c, a); };
        Object.defineProperty(M.prototype, "m_contactPointWS", { get: M.prototype.Qz, set: M.prototype.wC });
        M.prototype.get_m_suspensionLength = M.prototype.dB = function () { return Mq(this.hy); };
        M.prototype.set_m_suspensionLength = M.prototype.KD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Nq(c, a); };
        Object.defineProperty(M.prototype, "m_suspensionLength", { get: M.prototype.dB, set: M.prototype.KD });
        M.prototype.get_m_hardPointWS = M.prototype.hA = function () { return k(Oq(this.hy), p); };
        M.prototype.set_m_hardPointWS = M.prototype.OC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pq(c, a); };
        Object.defineProperty(M.prototype, "m_hardPointWS", { get: M.prototype.hA, set: M.prototype.OC });
        M.prototype.get_m_wheelDirectionWS = M.prototype.sB = function () { return k(Qq(this.hy), p); };
        M.prototype.set_m_wheelDirectionWS = M.prototype.ZD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Rq(c, a); };
        Object.defineProperty(M.prototype, "m_wheelDirectionWS", { get: M.prototype.sB, set: M.prototype.ZD });
        M.prototype.get_m_wheelAxleWS = M.prototype.rB = function () { return k(Sq(this.hy), p); };
        M.prototype.set_m_wheelAxleWS = M.prototype.YD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Tq(c, a); };
        Object.defineProperty(M.prototype, "m_wheelAxleWS", { get: M.prototype.rB, set: M.prototype.YD });
        M.prototype.get_m_isInContact = M.prototype.tA = function () { return !!Uq(this.hy); };
        M.prototype.set_m_isInContact = M.prototype.$C = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vq(c, a); };
        Object.defineProperty(M.prototype, "m_isInContact", { get: M.prototype.tA, set: M.prototype.$C });
        M.prototype.get_m_groundObject = M.prototype.gA = function () { return Wq(this.hy); };
        M.prototype.set_m_groundObject = M.prototype.NC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xq(c, a); };
        Object.defineProperty(M.prototype, "m_groundObject", { get: M.prototype.gA, set: M.prototype.NC });
        M.prototype.__destroy__ = function () { Yq(this.hy); };
        ...
        SB.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); $q(c, a); };
        SB.prototype.getLocalScaling = function () { return k(ar(this.hy), p); };
        SB.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); br(d, a, c); };
        SB.prototype.__destroy__ = function () { cr(this.hy); };
        ...
        R.jy = {};
        b.btSoftBody = R;
        R.prototype.checkLink = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return !!er(d, a, c); };
        R.prototype.checkFace = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); return !!fr(e, a, c, d); };
        R.prototype.appendMaterial = function () { return k(gr(this.hy), A); };
        R.prototype.appendNode = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); hr(d, a, c); };
        R.prototype.appendLink = function (a, c, d, e) { var g = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); ir(g, a, c, d, e); };
        R.prototype.appendFace = function (a, c, d, e) { var g = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); jr(g, a, c, d, e); };
        R.prototype.appendTetra = function (a, c, d, e, g) { var n = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); kr(n, a, c, d, e, g); };
        R.prototype.appendAnchor = function (a, c, d, e) { var g = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); lr(g, a, c, d, e); };
        R.prototype.addForce = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); void 0 === c ? mr(d, a) : nr(d, a, c); };
        R.prototype.addAeroForceToNode = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); or(d, a, c); };
        R.prototype.getTotalMass = function () { return pr(this.hy); };
        R.prototype.setTotalMass = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); qr(d, a, c); };
        R.prototype.setMass = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); rr(d, a, c); };
        R.prototype.transform = R.prototype.transform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); sr(c, a); };
        R.prototype.translate = R.prototype.translate = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); tr(c, a); };
        R.prototype.rotate = R.prototype.rotate = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ur(c, a); };
        R.prototype.scale = R.prototype.scale = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); vr(c, a); };
        R.prototype.generateClusters = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return void 0 === c ? wr(d, a) : xr(d, a, c); };
        R.prototype.generateBendingConstraints = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return yr(d, a, c); };
        R.prototype.upcast = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(zr(c, a), R); };
        R.prototype.setAnisotropicFriction = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Ar(d, a, c); };
        R.prototype.getCollisionShape = function () { return k(Br(this.hy), m); };
        R.prototype.setContactProcessingThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Cr(c, a); };
        R.prototype.setActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Dr(c, a); };
        R.prototype.forceActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Er(c, a); };
        R.prototype.activate = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); void 0 === a ? Fr(c) : Gr(c, a); };
        R.prototype.isActive = function () { return !!Hr(this.hy); };
        R.prototype.isKinematicObject = function () { return !!Ir(this.hy); };
        R.prototype.isStaticObject = function () { return !!Jr(this.hy); };
        R.prototype.isStaticOrKinematicObject = function () { return !!Kr(this.hy); };
        R.prototype.getRestitution = function () { return Lr(this.hy); };
        R.prototype.getFriction = function () { return Mr(this.hy); };
        R.prototype.getRollingFriction = function () { return Nr(this.hy); };
        R.prototype.setRestitution = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Or(c, a); };
        R.prototype.setFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pr(c, a); };
        R.prototype.setRollingFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qr(c, a); };
        R.prototype.getWorldTransform = function () { return k(Rr(this.hy), r); };
        R.prototype.getCollisionFlags = function () { return Sr(this.hy); };
        R.prototype.setCollisionFlags = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Tr(c, a); };
        R.prototype.setWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ur(c, a); };
        R.prototype.setCollisionShape = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vr(c, a); };
        R.prototype.setCcdMotionThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wr(c, a); };
        R.prototype.setCcdSweptSphereRadius = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Xr(c, a); };
        R.prototype.getUserIndex = function () { return Yr(this.hy); };
        R.prototype.setUserIndex = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Zr(c, a); };
        R.prototype.getUserPointer = function () { return k($r(this.hy), SA); };
        R.prototype.setUserPointer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); as(c, a); };
        R.prototype.getBroadphaseHandle = function () { return k(bs(this.hy), t); };
        R.prototype.get_m_cfg = R.prototype.Kz = function () { return k(cs(this.hy), S); };
        R.prototype.set_m_cfg = R.prototype.qC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ds(c, a); };
        Object.defineProperty(R.prototype, "m_cfg", { get: R.prototype.Kz, set: R.prototype.qC });
        R.prototype.get_m_nodes = R.prototype.GA = function () { return k(es(this.hy), TB); };
        R.prototype.set_m_nodes = R.prototype.mD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); gs(c, a); };
        Object.defineProperty(R.prototype, "m_nodes", { get: R.prototype.GA, set: R.prototype.mD });
        R.prototype.get_m_faces = R.prototype.Gy = function () { return k(hs(this.hy), UB); };
        R.prototype.set_m_faces = R.prototype.Py = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); is(c, a); };
        Object.defineProperty(R.prototype, "m_faces", { get: R.prototype.Gy, set: R.prototype.Py });
        R.prototype.get_m_materials = R.prototype.DA = function () { return k(js(this.hy), qB); };
        R.prototype.set_m_materials = R.prototype.jD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ks(c, a); };
        Object.defineProperty(R.prototype, "m_materials", { get: R.prototype.DA, set: R.prototype.jD });
        R.prototype.get_m_anchors = R.prototype.Az = function () { return k(ls(this.hy), RB); };
        R.prototype.set_m_anchors = R.prototype.gC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ms(c, a); };
        Object.defineProperty(R.prototype, "m_anchors", { get: R.prototype.Az, set: R.prototype.gC });
        R.prototype.__destroy__ = function () { ns(this.hy); };
        ...
        VB.jy = {};
        b.btIntArray = VB;
        VB.prototype.size = VB.prototype.size = function () { return ps(this.hy); };
        VB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return qs(c, a); };
        VB.prototype.__destroy__ = function () { rs(this.hy); };
        ...
        S.jy = {};
        b.Config = S;
        S.prototype.get_kVCF = S.prototype.sz = function () { return ss(this.hy); };
        S.prototype.set_kVCF = S.prototype.$B = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ts(c, a); };
        Object.defineProperty(S.prototype, "kVCF", { get: S.prototype.sz, set: S.prototype.$B });
        S.prototype.get_kDP = S.prototype.fz = function () { return us(this.hy); };
        S.prototype.set_kDP = S.prototype.NB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); vs(c, a); };
        Object.defineProperty(S.prototype, "kDP", { get: S.prototype.fz, set: S.prototype.NB });
        S.prototype.get_kDG = S.prototype.ez = function () { return xs(this.hy); };
        S.prototype.set_kDG = S.prototype.MB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ys(c, a); };
        Object.defineProperty(S.prototype, "kDG", { get: S.prototype.ez, set: S.prototype.MB });
        S.prototype.get_kLF = S.prototype.hz = function () { return zs(this.hy); };
        S.prototype.set_kLF = S.prototype.PB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); As(c, a); };
        Object.defineProperty(S.prototype, "kLF", { get: S.prototype.hz, set: S.prototype.PB });
        S.prototype.get_kPR = S.prototype.jz = function () { return Bs(this.hy); };
        S.prototype.set_kPR = S.prototype.RB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Cs(c, a); };
        Object.defineProperty(S.prototype, "kPR", { get: S.prototype.jz, set: S.prototype.RB });
        S.prototype.get_kVC = S.prototype.rz = function () { return Ds(this.hy); };
        S.prototype.set_kVC = S.prototype.ZB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Es(c, a); };
        Object.defineProperty(S.prototype, "kVC", { get: S.prototype.rz, set: S.prototype.ZB });
        S.prototype.get_kDF = S.prototype.dz = function () { return Fs(this.hy); };
        S.prototype.set_kDF = S.prototype.LB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Gs(c, a); };
        Object.defineProperty(S.prototype, "kDF", { get: S.prototype.dz, set: S.prototype.LB });
        S.prototype.get_kMT = S.prototype.iz = function () { return Hs(this.hy); };
        S.prototype.set_kMT = S.prototype.QB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Is(c, a); };
        Object.defineProperty(S.prototype, "kMT", { get: S.prototype.iz, set: S.prototype.QB });
        S.prototype.get_kCHR = S.prototype.cz = function () { return Js(this.hy); };
        S.prototype.set_kCHR = S.prototype.KB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ks(c, a); };
        Object.defineProperty(S.prototype, "kCHR", { get: S.prototype.cz, set: S.prototype.KB });
        S.prototype.get_kKHR = S.prototype.gz = function () { return Ls(this.hy); };
        S.prototype.set_kKHR = S.prototype.OB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ms(c, a); };
        Object.defineProperty(S.prototype, "kKHR", { get: S.prototype.gz, set: S.prototype.OB });
        S.prototype.get_kSHR = S.prototype.kz = function () { return Ns(this.hy); };
        S.prototype.set_kSHR = S.prototype.SB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Os(c, a); };
        Object.defineProperty(S.prototype, "kSHR", { get: S.prototype.kz, set: S.prototype.SB });
        S.prototype.get_kAHR = S.prototype.bz = function () { return Ps(this.hy); };
        S.prototype.set_kAHR = S.prototype.JB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qs(c, a); };
        Object.defineProperty(S.prototype, "kAHR", { get: S.prototype.bz, set: S.prototype.JB });
        S.prototype.get_kSRHR_CL = S.prototype.nz = function () { return Rs(this.hy); };
        S.prototype.set_kSRHR_CL = S.prototype.VB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ss(c, a); };
        Object.defineProperty(S.prototype, "kSRHR_CL", { get: S.prototype.nz, set: S.prototype.VB });
        S.prototype.get_kSKHR_CL = S.prototype.lz = function () { return Ts(this.hy); };
        S.prototype.set_kSKHR_CL = S.prototype.TB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Us(c, a); };
        Object.defineProperty(S.prototype, "kSKHR_CL", { get: S.prototype.lz, set: S.prototype.TB });
        S.prototype.get_kSSHR_CL = S.prototype.pz = function () { return Vs(this.hy); };
        S.prototype.set_kSSHR_CL = S.prototype.XB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ws(c, a); };
        Object.defineProperty(S.prototype, "kSSHR_CL", { get: S.prototype.pz, set: S.prototype.XB });
        S.prototype.get_kSR_SPLT_CL = S.prototype.oz = function () { return Xs(this.hy); };
        S.prototype.set_kSR_SPLT_CL = S.prototype.WB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ys(c, a); };
        Object.defineProperty(S.prototype, "kSR_SPLT_CL", { get: S.prototype.oz, set: S.prototype.WB });
        S.prototype.get_kSK_SPLT_CL = S.prototype.mz = function () { return Zs(this.hy); };
        S.prototype.set_kSK_SPLT_CL = S.prototype.UB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); $s(c, a); };
        Object.defineProperty(S.prototype, "kSK_SPLT_CL", { get: S.prototype.mz, set: S.prototype.UB });
        S.prototype.get_kSS_SPLT_CL = S.prototype.qz = function () { return at(this.hy); };
        S.prototype.set_kSS_SPLT_CL = S.prototype.YB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); bt(c, a); };
        Object.defineProperty(S.prototype, "kSS_SPLT_CL", { get: S.prototype.qz, set: S.prototype.YB });
        S.prototype.get_maxvolume = S.prototype.yB = function () { return ct(this.hy); };
        S.prototype.set_maxvolume = S.prototype.eE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); dt(c, a); };
        Object.defineProperty(S.prototype, "maxvolume", { get: S.prototype.yB, set: S.prototype.eE });
        S.prototype.get_timescale = S.prototype.AB = function () { return et(this.hy); };
        S.prototype.set_timescale = S.prototype.gE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ft(c, a); };
        Object.defineProperty(S.prototype, "timescale", { get: S.prototype.AB, set: S.prototype.gE });
        S.prototype.get_viterations = S.prototype.BB = function () { return gt(this.hy); };
        S.prototype.set_viterations = S.prototype.hE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ht(c, a); };
        Object.defineProperty(S.prototype, "viterations", { get: S.prototype.BB, set: S.prototype.hE });
        S.prototype.get_piterations = S.prototype.zB = function () { return it(this.hy); };
        S.prototype.set_piterations = S.prototype.fE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); jt(c, a); };
        Object.defineProperty(S.prototype, "piterations", { get: S.prototype.zB, set: S.prototype.fE });
        S.prototype.get_diterations = S.prototype.az = function () { return kt(this.hy); };
        S.prototype.set_diterations = S.prototype.IB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); lt(c, a); };
        Object.defineProperty(S.prototype, "diterations", { get: S.prototype.az, set: S.prototype.IB });
        S.prototype.get_citerations = S.prototype.Zy = function () { return mt(this.hy); };
        S.prototype.set_citerations = S.prototype.GB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); nt(c, a); };
        Object.defineProperty(S.prototype, "citerations", { get: S.prototype.Zy, set: S.prototype.GB });
        S.prototype.get_collisions = S.prototype.$y = function () { return ot(this.hy); };
        S.prototype.set_collisions = S.prototype.HB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); pt(c, a); };
        Object.defineProperty(S.prototype, "collisions", { get: S.prototype.$y, set: S.prototype.HB });
        S.prototype.__destroy__ = function () { qt(this.hy); };
        ...
        Node.jy = {};
        b.Node = Node;
        Node.prototype.get_m_x = Node.prototype.xB = function () { return k(rt(this.hy), p); };
        Node.prototype.set_m_x = Node.prototype.dE = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); st(c, a); };
        Object.defineProperty(Node.prototype, "m_x", { get: Node.prototype.xB, set: Node.prototype.dE });
        Node.prototype.get_m_q = Node.prototype.OA = function () { return k(tt(this.hy), p); };
        Node.prototype.set_m_q = Node.prototype.uD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ut(c, a); };
        Object.defineProperty(Node.prototype, "m_q", { get: Node.prototype.OA, set: Node.prototype.uD });
        Node.prototype.get_m_v = Node.prototype.pB = function () { return k(vt(this.hy), p); };
        Node.prototype.set_m_v = Node.prototype.WD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); wt(c, a); };
        Object.defineProperty(Node.prototype, "m_v", { get: Node.prototype.pB, set: Node.prototype.WD });
        Node.prototype.get_m_f = Node.prototype.bA = function () { return k(xt(this.hy), p); };
        Node.prototype.set_m_f = Node.prototype.IC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yt(c, a); };
        Object.defineProperty(Node.prototype, "m_f", { get: Node.prototype.bA, set: Node.prototype.IC });
        Node.prototype.get_m_n = Node.prototype.Hy = function () { return k(zt(this.hy), p); };
        Node.prototype.set_m_n = Node.prototype.Qy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); At(c, a); };
        Object.defineProperty(Node.prototype, "m_n", { get: Node.prototype.Hy, set: Node.prototype.Qy });
        Node.prototype.get_m_im = Node.prototype.pA = function () { return Bt(this.hy); };
        Node.prototype.set_m_im = Node.prototype.WC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ct(c, a); };
        Object.defineProperty(Node.prototype, "m_im", { get: Node.prototype.pA, set: Node.prototype.WC });
        Node.prototype.get_m_area = Node.prototype.Dz = function () { return Dt(this.hy); };
        Node.prototype.set_m_area = Node.prototype.jC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Et(c, a); };
        Object.defineProperty(Node.prototype, "m_area", { get: Node.prototype.Dz, set: Node.prototype.jC });
        Node.prototype.__destroy__ = function () { Ft(this.hy); };
        ...
        WB.prototype.__destroy__ = function () { Ht(this.hy); };
        ...
        XB.prototype.__destroy__ = function () { It(this.hy); };
        ...
        T.prototype.setUpAxis = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Lt(c, a); };
        T.prototype.setWalkDirection = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Mt(c, a); };
        T.prototype.setVelocityForTimeInterval = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Nt(d, a, c); };
        T.prototype.warp = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ot(c, a); };
        T.prototype.preStep = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pt(c, a); };
        T.prototype.playerStep = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Qt(d, a, c); };
        T.prototype.setFallSpeed = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Rt(c, a); };
        T.prototype.setJumpSpeed = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); St(c, a); };
        T.prototype.setMaxJumpHeight = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Tt(c, a); };
        T.prototype.canJump = function () { return !!Ut(this.hy); };
        T.prototype.jump = function () { Vt(this.hy); };
        T.prototype.setGravity = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wt(c, a); };
        T.prototype.getGravity = function () { return Xt(this.hy); };
        T.prototype.setMaxSlope = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Yt(c, a); };
        T.prototype.getMaxSlope = function () { return Zt(this.hy); };
        T.prototype.getGhostObject = function () { return k($t(this.hy), U); };
        T.prototype.setUseGhostSweepTest = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); au(c, a); };
        T.prototype.onGround = function () { return !!bu(this.hy); };
        T.prototype.setUpInterpolate = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); cu(c, a); };
        T.prototype.updateAction = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); du(d, a, c); };
        T.prototype.__destroy__ = function () { eu(this.hy); };
        ...
        YB.prototype.size = YB.prototype.size = function () { return fu(this.hy); };
        YB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(gu(c, a), R); };
        YB.prototype.__destroy__ = function () { hu(this.hy); };
        ...
        PB.jy = {};
        b.btFaceArray = PB;
        PB.prototype.size = PB.prototype.size = function () { return iu(this.hy); };
        PB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(ju(c, a), ZB); };
        PB.prototype.__destroy__ = function () { ku(this.hy); };
        ...
        $B.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); mu(c, a); };
        $B.prototype.getLocalScaling = function () { return k(nu(this.hy), p); };
        $B.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); ou(d, a, c); };
        $B.prototype.__destroy__ = function () { pu(this.hy); };
        ...
        PA.prototype.setInternalGhostPairCallback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); qu(c, a); };
        PA.prototype.getNumOverlappingPairs = function () { return ru(this.hy); };
        PA.prototype.__destroy__ = function () { su(this.hy); };
        ...
        vB.jy = {};
        b.btIndexedMesh = vB;
        vB.prototype.get_m_numTriangles = vB.prototype.KA = function () { return tu(this.hy); };
        vB.prototype.set_m_numTriangles = vB.prototype.qD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); uu(c, a); };
        Object.defineProperty(vB.prototype, "m_numTriangles", { get: vB.prototype.KA, set: vB.prototype.qD });
        vB.prototype.__destroy__ = function () { vu(this.hy); };
        ...
        V.prototype.addSoftBody = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); xu(e, a, c, d); };
        V.prototype.removeSoftBody = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yu(c, a); };
        V.prototype.removeCollisionObject = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); zu(c, a); };
        V.prototype.getWorldInfo = function () { return k(Au(this.hy), J); };
        V.prototype.getSoftBodyArray = function () { return k(Bu(this.hy), YB); };
        V.prototype.getDispatcher = function () { return k(Cu(this.hy), OA); };
        V.prototype.rayTest = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Du(e, a, c, d); };
        V.prototype.getPairCache = function () { return k(Eu(this.hy), PA); };
        V.prototype.getDispatchInfo = function () { return k(Fu(this.hy), l); };
        V.prototype.addCollisionObject = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? Gu(e, a) : void 0 === d ? Hu(e, a, c) : Iu(e, a, c, d); };
        V.prototype.getBroadphase = function () { return k(Ju(this.hy), QA); };
        V.prototype.convexSweepTest = function (a, c, d, e, g) { var n = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); Ku(n, a, c, d, e, g); };
        V.prototype.contactPairTest = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Lu(e, a, c, d); };
        V.prototype.contactTest = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Mu(d, a, c); };
        V.prototype.updateSingleAabb = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Nu(c, a); };
        V.prototype.setDebugDrawer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ou(c, a); };
        V.prototype.getDebugDrawer = function () { return k(Pu(this.hy), RA); };
        V.prototype.debugDrawWorld = function () { Qu(this.hy); };
        V.prototype.debugDrawObject = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Ru(e, a, c, d); };
        V.prototype.setGravity = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Su(c, a); };
        V.prototype.getGravity = function () { return k(Tu(this.hy), p); };
        V.prototype.addRigidBody = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? Uu(e, a) : void 0 === d ? _emscripten_bind_btSoftRigidDynamicsWorld_addRigidBody_2(e, a, c) : Vu(e, a, c, d); };
        V.prototype.removeRigidBody = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wu(c, a); };
        V.prototype.addConstraint = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); void 0 === c ? Xu(d, a) : Yu(d, a, c); };
        V.prototype.removeConstraint = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Zu(c, a); };
        V.prototype.stepSimulation = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); return void 0 === c ? $u(e, a) : void 0 === d ? av(e, a, c) : bv(e, a, c, d); };
        V.prototype.setContactAddedCallback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); cv(c, a); };
        V.prototype.setContactProcessedCallback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); dv(c, a); };
        V.prototype.setContactDestroyedCallback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ev(c, a); };
        V.prototype.addAction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); fv(c, a); };
        V.prototype.removeAction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); gv(c, a); };
        V.prototype.getSolverInfo = function () { return k(hv(this.hy), v); };
        V.prototype.setInternalTickCallback = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); void 0 === c ? iv(e, a) : void 0 === d ? jv(e, a, c) : kv(e, a, c, d); };
        V.prototype.__destroy__ = function () { lv(this.hy); };
        ...
        aC.prototype.enableFeedback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); nv(c, a); };
        aC.prototype.getBreakingImpulseThreshold = function () { return ov(this.hy); };
        aC.prototype.setBreakingImpulseThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); pv(c, a); };
        aC.prototype.getParam = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return qv(d, a, c); };
        aC.prototype.setParam = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); rv(e, a, c, d); };
        aC.prototype.__destroy__ = function () { sv(this.hy); };
        ...
        r.jy = {};
        b.btTransform = r;
        r.prototype.setIdentity = function () { vv(this.hy); };
        r.prototype.setOrigin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); wv(c, a); };
        r.prototype.setRotation = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); xv(c, a); };
        r.prototype.getOrigin = function () { return k(yv(this.hy), p); };
        r.prototype.getRotation = function () { return k(zv(this.hy), W); };
        r.prototype.getBasis = function () { return k(Av(this.hy), jB); };
        r.prototype.setFromOpenGLMatrix = function (a) { var c = this.hy; IA(); "object" == typeof a && (a = MA(a)); Bv(c, a); };
        r.prototype.inverse = r.prototype.inverse = function () { return k(Cv(this.hy), r); };
        r.prototype.op_mul = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Dv(c, a), r); };
        r.prototype.__destroy__ = function () { Ev(this.hy); };
        ...
        X.prototype.hasHit = function () { return !!Gv(this.hy); };
        X.prototype.get_m_rayFromWorld = X.prototype.Iy = function () { return k(Hv(this.hy), p); };
        X.prototype.set_m_rayFromWorld = X.prototype.Ry = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Iv(c, a); };
        Object.defineProperty(X.prototype, "m_rayFromWorld", { get: X.prototype.Iy, set: X.prototype.Ry });
        X.prototype.get_m_rayToWorld = X.prototype.Jy = function () { return k(Jv(this.hy), p); };
        X.prototype.set_m_rayToWorld = X.prototype.Sy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Kv(c, a); };
        Object.defineProperty(X.prototype, "m_rayToWorld", { get: X.prototype.Jy, set: X.prototype.Sy });
        X.prototype.get_m_hitNormalWorld = X.prototype.sy = function () { return k(Lv(this.hy), p); };
        X.prototype.set_m_hitNormalWorld = X.prototype.zy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Mv(c, a); };
        Object.defineProperty(X.prototype, "m_hitNormalWorld", { get: X.prototype.sy, set: X.prototype.zy });
        X.prototype.get_m_hitPointWorld = X.prototype.ty = function () { return k(Nv(this.hy), p); };
        X.prototype.set_m_hitPointWorld = X.prototype.Ay = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ov(c, a); };
        Object.defineProperty(X.prototype, "m_hitPointWorld", { get: X.prototype.ty, set: X.prototype.Ay });
        X.prototype.get_m_collisionFilterGroup = X.prototype.ky = function () { return Pv(this.hy); };
        X.prototype.set_m_collisionFilterGroup = X.prototype.my = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Qv(c, a); };
        Object.defineProperty(X.prototype, "m_collisionFilterGroup", { get: X.prototype.ky, set: X.prototype.my });
        X.prototype.get_m_collisionFilterMask = X.prototype.ly = function () { return Rv(this.hy); };
        X.prototype.set_m_collisionFilterMask = X.prototype.ny = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Sv(c, a); };
        Object.defineProperty(X.prototype, "m_collisionFilterMask", { get: X.prototype.ly, set: X.prototype.ny });
        X.prototype.get_m_closestHitFraction = X.prototype.oy = function () { return Tv(this.hy); };
        X.prototype.set_m_closestHitFraction = X.prototype.py = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Uv(c, a); };
        Object.defineProperty(X.prototype, "m_closestHitFraction", { get: X.prototype.oy, set: X.prototype.py });
        X.prototype.get_m_collisionObject = X.prototype.qy = function () { return k(Vv(this.hy), q); };
        X.prototype.set_m_collisionObject = X.prototype.xy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Wv(c, a); };
        Object.defineProperty(X.prototype, "m_collisionObject", { get: X.prototype.qy, set: X.prototype.xy });
        X.prototype.__destroy__ = function () { Xv(this.hy); };
        ...
        bC.prototype.__destroy__ = function () { $v(this.hy); };
        ...
        cC.prototype.addSingleResult = function (a, c, d, e, g, n, F) { var aa = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); n && "object" === typeof n && (n = n.hy); F && "object" === typeof F && (F = F.hy); return bw(aa, a, c, d, e, g, n, F); };
        cC.prototype.__destroy__ = function () { cw(this.hy); };
        ...
        dC.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); fw(c, a); };
        dC.prototype.getLocalScaling = function () { return k(gw(this.hy), p); };
        dC.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); hw(d, a, c); };
        dC.prototype.__destroy__ = function () { iw(this.hy); };
        ...
        oB.prototype.size = oB.prototype.size = function () { return jw(this.hy); };
        oB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(kw(c, a), q); };
        oB.prototype.__destroy__ = function () { lw(this.hy); };
        ...
        eC.prototype.setLowerLinLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ow(c, a); };
        eC.prototype.setUpperLinLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); pw(c, a); };
        eC.prototype.setLowerAngLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); qw(c, a); };
        eC.prototype.setUpperAngLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); rw(c, a); };
        eC.prototype.enableFeedback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); sw(c, a); };
        eC.prototype.getBreakingImpulseThreshold = function () { return tw(this.hy); };
        eC.prototype.setBreakingImpulseThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); uw(c, a); };
        eC.prototype.getParam = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return vw(d, a, c); };
        eC.prototype.setParam = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); ww(e, a, c, d); };
        eC.prototype.__destroy__ = function () { xw(this.hy); };
        ...
        U.prototype.setAnisotropicFriction = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); zw(d, a, c); };
        U.prototype.getCollisionShape = function () { return k(Aw(this.hy), m); };
        U.prototype.setContactProcessingThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Bw(c, a); };
        U.prototype.setActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Cw(c, a); };
        U.prototype.forceActivationState = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Dw(c, a); };
        U.prototype.activate = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); void 0 === a ? Ew(c) : Fw(c, a); };
        U.prototype.isActive = function () { return !!Gw(this.hy); };
        U.prototype.isKinematicObject = function () { return !!Hw(this.hy); };
        U.prototype.isStaticObject = function () { return !!Iw(this.hy); };
        U.prototype.isStaticOrKinematicObject = function () { return !!Jw(this.hy); };
        U.prototype.getRestitution = function () { return Kw(this.hy); };
        U.prototype.getFriction = function () { return Lw(this.hy); };
        U.prototype.getRollingFriction = function () { return Mw(this.hy); };
        U.prototype.setRestitution = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Nw(c, a); };
        U.prototype.setFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ow(c, a); };
        U.prototype.setRollingFriction = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pw(c, a); };
        U.prototype.getWorldTransform = function () { return k(Qw(this.hy), r); };
        U.prototype.getCollisionFlags = function () { return Rw(this.hy); };
        U.prototype.setCollisionFlags = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Sw(c, a); };
        U.prototype.setWorldTransform = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Tw(c, a); };
        U.prototype.setCollisionShape = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Uw(c, a); };
        U.prototype.setCcdMotionThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Vw(c, a); };
        U.prototype.setCcdSweptSphereRadius = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ww(c, a); };
        U.prototype.getUserIndex = function () { return Xw(this.hy); };
        U.prototype.setUserIndex = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Yw(c, a); };
        U.prototype.getUserPointer = function () { return k(Zw(this.hy), SA); };
        U.prototype.setUserPointer = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); $w(c, a); };
        U.prototype.getBroadphaseHandle = function () { return k(ax(this.hy), t); };
        U.prototype.getNumOverlappingObjects = function () { return bx(this.hy); };
        U.prototype.getOverlappingObject = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(cx(c, a), q); };
        U.prototype.__destroy__ = function () { dx(this.hy); };
        ...
        D.jy = {};
        b.btManifoldPoint = D;
        D.prototype.getPositionWorldOnA = function () { return k(ex(this.hy), p); };
        D.prototype.getPositionWorldOnB = function () { return k(fx(this.hy), p); };
        D.prototype.getAppliedImpulse = function () { return gx(this.hy); };
        D.prototype.getDistance = function () { return hx(this.hy); };
        D.prototype.get_m_localPointA = D.prototype.AA = function () { return k(ix(this.hy), p); };
        D.prototype.set_m_localPointA = D.prototype.gD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); jx(c, a); };
        Object.defineProperty(D.prototype, "m_localPointA", { get: D.prototype.AA, set: D.prototype.gD });
        D.prototype.get_m_localPointB = D.prototype.BA = function () { return k(kx(this.hy), p); };
        D.prototype.set_m_localPointB = D.prototype.hD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); lx(c, a); };
        Object.defineProperty(D.prototype, "m_localPointB", { get: D.prototype.BA, set: D.prototype.hD });
        D.prototype.get_m_positionWorldOnB = D.prototype.NA = function () { return k(mx(this.hy), p); };
        D.prototype.set_m_positionWorldOnB = D.prototype.tD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); nx(c, a); };
        Object.defineProperty(D.prototype, "m_positionWorldOnB", { get: D.prototype.NA, set: D.prototype.tD });
        D.prototype.get_m_positionWorldOnA = D.prototype.MA = function () { return k(ox(this.hy), p); };
        D.prototype.set_m_positionWorldOnA = D.prototype.sD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); px(c, a); };
        Object.defineProperty(D.prototype, "m_positionWorldOnA", { get: D.prototype.MA, set: D.prototype.sD });
        D.prototype.get_m_normalWorldOnB = D.prototype.IA = function () { return k(qx(this.hy), p); };
        D.prototype.set_m_normalWorldOnB = D.prototype.oD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); rx(c, a); };
        Object.defineProperty(D.prototype, "m_normalWorldOnB", { get: D.prototype.IA, set: D.prototype.oD });
        D.prototype.get_m_userPersistentData = D.prototype.oB = function () { return sx(this.hy); };
        D.prototype.set_m_userPersistentData = D.prototype.VD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); tx(c, a); };
        Object.defineProperty(D.prototype, "m_userPersistentData", { get: D.prototype.oB, set: D.prototype.VD });
        D.prototype.__destroy__ = function () { ux(this.hy); };
        ...
        fC.prototype.setPivotA = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); xx(c, a); };
        fC.prototype.setPivotB = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yx(c, a); };
        fC.prototype.getPivotInA = function () { return k(zx(this.hy), p); };
        fC.prototype.getPivotInB = function () { return k(Ax(this.hy), p); };
        fC.prototype.enableFeedback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Bx(c, a); };
        fC.prototype.getBreakingImpulseThreshold = function () { return Cx(this.hy); };
        fC.prototype.setBreakingImpulseThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Dx(c, a); };
        fC.prototype.getParam = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return Ex(d, a, c); };
        fC.prototype.setParam = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Fx(e, a, c, d); };
        fC.prototype.get_m_setting = fC.prototype.VA = function () { return k(Gx(this.hy), H); };
        fC.prototype.set_m_setting = fC.prototype.BD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Hx(c, a); };
        Object.defineProperty(fC.prototype, "m_setting", { get: fC.prototype.VA, set: fC.prototype.BD });
        fC.prototype.__destroy__ = function () { Ix(this.hy); };
        ...
        gC.prototype.CreateFromTriMesh = function (a, c, d, e, g) { var n = this.hy; IA(); a && "object" === typeof a && (a = a.hy); "object" == typeof c && (c = MA(c)); if ("object" == typeof d && "object" === typeof d) {
            var F = JA(d, Aa);
            KA(d, Aa, F);
            d = F;
        } e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); return k(Ox(n, a, c, d, e, g), R); };
        gC.prototype.CreateFromConvexHull = function (a, c, d, e) { var g = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); return k(Px(g, a, c, d, e), R); };
        gC.prototype.__destroy__ = function () { Qx(this.hy); };
        ...
        t.prototype.get_m_collisionFilterGroup = t.prototype.ky = function () { return Rx(this.hy); };
        t.prototype.set_m_collisionFilterGroup = t.prototype.my = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Sx(c, a); };
        Object.defineProperty(t.prototype, "m_collisionFilterGroup", { get: t.prototype.ky, set: t.prototype.my });
        t.prototype.get_m_collisionFilterMask = t.prototype.ly = function () { return Tx(this.hy); };
        t.prototype.set_m_collisionFilterMask = t.prototype.ny = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ux(c, a); };
        Object.defineProperty(t.prototype, "m_collisionFilterMask", { get: t.prototype.ly, set: t.prototype.ny });
        t.prototype.__destroy__ = function () { Vx(this.hy); };
        ...
        TB.jy = {};
        b.tNodeArray = TB;
        TB.prototype.size = TB.prototype.size = function () { return Wx(this.hy); };
        TB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Xx(c, a), Node); };
        TB.prototype.__destroy__ = function () { Yx(this.hy); };
        ...
        hC.jy = {};
        b.btBoxShape = hC;
        hC.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); $x(c, a); };
        hC.prototype.getMargin = function () { return ay(this.hy); };
        hC.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); by(c, a); };
        hC.prototype.getLocalScaling = function () { return k(cy(this.hy), p); };
        hC.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); dy(d, a, c); };
        hC.prototype.__destroy__ = function () { ey(this.hy); };
        ...
        ZB.jy = {};
        b.btFace = ZB;
        ZB.prototype.get_m_indices = ZB.prototype.rA = function () { return k(fy(this.hy), VB); };
        ZB.prototype.set_m_indices = ZB.prototype.YC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); gy(c, a); };
        Object.defineProperty(ZB.prototype, "m_indices", { get: ZB.prototype.rA, set: ZB.prototype.YC });
        ZB.prototype.get_m_plane = ZB.prototype.LA = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return hy(c, a); };
        ZB.prototype.set_m_plane = ZB.prototype.rD = function (a, c) { var d = this.hy; IA(); a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); iy(d, a, c); };
        Object.defineProperty(ZB.prototype, "m_plane", { get: ZB.prototype.LA, set: ZB.prototype.rD });
        ZB.prototype.__destroy__ = function () { jy(this.hy); };
        ...
        iC.jy = {};
        b.DebugDrawer = iC;
        iC.prototype.drawLine = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); ly(e, a, c, d); };
        iC.prototype.drawContactPoint = function (a, c, d, e, g) { var n = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); g && "object" === typeof g && (g = g.hy); my(n, a, c, d, e, g); };
        iC.prototype.reportErrorWarning = function (a) { var c = this.hy; IA(); a = a && "object" === typeof a ? a.hy : LA(a); ny(c, a); };
        iC.prototype.draw3dText = function (a, c) { var d = this.hy; IA(); a && "object" === typeof a && (a = a.hy); c = c && "object" === typeof c ? c.hy : LA(c); oy(d, a, c); };
        iC.prototype.setDebugMode = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); py(c, a); };
        iC.prototype.getDebugMode = function () { return qy(this.hy); };
        iC.prototype.__destroy__ = function () { ry(this.hy); };
        ...
        jC.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); ty(c, a); };
        jC.prototype.getMargin = function () { return uy(this.hy); };
        jC.prototype.getUpAxis = function () { return vy(this.hy); };
        jC.prototype.getRadius = function () { return wy(this.hy); };
        jC.prototype.getHalfHeight = function () { return xy(this.hy); };
        jC.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); yy(c, a); };
        jC.prototype.getLocalScaling = function () { return k(zy(this.hy), p); };
        jC.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Ay(d, a, c); };
        jC.prototype.__destroy__ = function () { By(this.hy); };
        ...
        W.jy = {};
        b.btQuaternion = W;
        W.prototype.setValue = function (a, c, d, e) { var g = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); e && "object" === typeof e && (e = e.hy); Dy(g, a, c, d, e); };
        W.prototype.setEulerZYX = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Ey(e, a, c, d); };
        W.prototype.setRotation = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Fy(d, a, c); };
        W.prototype.normalize = W.prototype.normalize = function () { Gy(this.hy); };
        W.prototype.length2 = function () { return Hy(this.hy); };
        W.prototype.length = W.prototype.length = function () { return Iy(this.hy); };
        W.prototype.dot = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return Jy(c, a); };
        W.prototype.normalized = function () { return k(Ky(this.hy), W); };
        W.prototype.getAxis = function () { return k(Ly(this.hy), p); };
        W.prototype.inverse = W.prototype.inverse = function () { return k(My(this.hy), W); };
        W.prototype.getAngle = function () { return Ny(this.hy); };
        W.prototype.getAngleShortestPath = function () { return Oy(this.hy); };
        W.prototype.angle = W.prototype.angle = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return Py(c, a); };
        W.prototype.angleShortestPath = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return Qy(c, a); };
        W.prototype.op_add = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Ry(c, a), W); };
        W.prototype.op_sub = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Sy(c, a), W); };
        W.prototype.op_mul = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Ty(c, a), W); };
        W.prototype.op_mulq = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Uy(c, a), W); };
        W.prototype.op_div = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Vy(c, a), W); };
        W.prototype.x = W.prototype.x = function () { return Wy(this.hy); };
        W.prototype.y = W.prototype.y = function () { return Xy(this.hy); };
        W.prototype.z = W.prototype.z = function () { return Yy(this.hy); };
        W.prototype.w = function () { return Zy(this.hy); };
        W.prototype.setX = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); $y(c, a); };
        W.prototype.setY = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); az(c, a); };
        W.prototype.setZ = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); bz(c, a); };
        W.prototype.setW = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); cz(c, a); };
        W.prototype.__destroy__ = function () { dz(this.hy); };
        ...
        kC.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); fz(c, a); };
        kC.prototype.getMargin = function () { return gz(this.hy); };
        kC.prototype.getUpAxis = function () { return hz(this.hy); };
        kC.prototype.getRadius = function () { return iz(this.hy); };
        kC.prototype.getHalfHeight = function () { return jz(this.hy); };
        kC.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); kz(c, a); };
        kC.prototype.getLocalScaling = function () { return k(lz(this.hy), p); };
        kC.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); mz(d, a, c); };
        kC.prototype.__destroy__ = function () { nz(this.hy); };
        ...
        v.prototype.get_m_splitImpulse = v.prototype.YA = function () { return !!oz(this.hy); };
        v.prototype.set_m_splitImpulse = v.prototype.ED = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); pz(c, a); };
        Object.defineProperty(v.prototype, "m_splitImpulse", { get: v.prototype.YA, set: v.prototype.ED });
        v.prototype.get_m_splitImpulsePenetrationThreshold = v.prototype.ZA = function () { return qz(this.hy); };
        v.prototype.set_m_splitImpulsePenetrationThreshold = v.prototype.FD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); rz(c, a); };
        Object.defineProperty(v.prototype, "m_splitImpulsePenetrationThreshold", { get: v.prototype.ZA, set: v.prototype.FD });
        v.prototype.get_m_numIterations = v.prototype.JA = function () { return sz(this.hy); };
        v.prototype.set_m_numIterations = v.prototype.pD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); tz(c, a); };
        Object.defineProperty(v.prototype, "m_numIterations", { get: v.prototype.JA, set: v.prototype.pD });
        v.prototype.__destroy__ = function () { uz(this.hy); };
        ...
        lC.prototype.enableSpring = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); xz(d, a, c); };
        lC.prototype.setStiffness = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); yz(d, a, c); };
        lC.prototype.setDamping = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); zz(d, a, c); };
        lC.prototype.setEquilibriumPoint = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); void 0 === a ? Az(d) : void 0 === c ? Bz(d, a) : Cz(d, a, c); };
        lC.prototype.setLinearLowerLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Dz(c, a); };
        lC.prototype.setLinearUpperLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Ez(c, a); };
        lC.prototype.setAngularLowerLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Fz(c, a); };
        lC.prototype.setAngularUpperLimit = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Gz(c, a); };
        lC.prototype.getFrameOffsetA = function () { return k(Hz(this.hy), r); };
        lC.prototype.enableFeedback = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Iz(c, a); };
        lC.prototype.getBreakingImpulseThreshold = function () { return Jz(this.hy); };
        lC.prototype.setBreakingImpulseThreshold = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Kz(c, a); };
        lC.prototype.getParam = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); return Lz(d, a, c); };
        lC.prototype.setParam = function (a, c, d) { var e = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); d && "object" === typeof d && (d = d.hy); Mz(e, a, c, d); };
        lC.prototype.__destroy__ = function () { Nz(this.hy); };
        ...
        mC.jy = {};
        b.btSphereShape = mC;
        mC.prototype.setMargin = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Pz(c, a); };
        mC.prototype.getMargin = function () { return Qz(this.hy); };
        mC.prototype.setLocalScaling = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Rz(c, a); };
        mC.prototype.getLocalScaling = function () { return k(Sz(this.hy), p); };
        mC.prototype.calculateLocalInertia = function (a, c) { var d = this.hy; a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Tz(d, a, c); };
        mC.prototype.__destroy__ = function () { Uz(this.hy); };
        ...
        Y.jy = {};
        b.Face = Y;
        Y.prototype.get_m_n = Y.prototype.Hy = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(Vz(c, a), Node); };
        Y.prototype.set_m_n = Y.prototype.Qy = function (a, c) { var d = this.hy; IA(); a && "object" === typeof a && (a = a.hy); c && "object" === typeof c && (c = c.hy); Wz(d, a, c); };
        Object.defineProperty(Y.prototype, "m_n", { get: Y.prototype.Hy, set: Y.prototype.Qy });
        Y.prototype.get_m_normal = Y.prototype.HA = function () { return k(Xz(this.hy), p); };
        Y.prototype.set_m_normal = Y.prototype.nD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); Yz(c, a); };
        Object.defineProperty(Y.prototype, "m_normal", { get: Y.prototype.HA, set: Y.prototype.nD });
        Y.prototype.get_m_ra = Y.prototype.PA = function () { return Zz(this.hy); };
        Y.prototype.set_m_ra = Y.prototype.vD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); $z(c, a); };
        Object.defineProperty(Y.prototype, "m_ra", { get: Y.prototype.PA, set: Y.prototype.vD });
        Y.prototype.__destroy__ = function () { aA(this.hy); };
        ...
        UB.jy = {};
        b.tFaceArray = UB;
        UB.prototype.size = UB.prototype.size = function () { return bA(this.hy); };
        UB.prototype.at = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); return k(cA(c, a), Y); };
        UB.prototype.__destroy__ = function () { dA(this.hy); };
        ...
        Z.prototype.get_m_hitCollisionObject = Z.prototype.iA = function () { return k(fA(this.hy), q); };
        Z.prototype.set_m_hitCollisionObject = Z.prototype.PC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); gA(c, a); };
        Object.defineProperty(Z.prototype, "m_hitCollisionObject", { get: Z.prototype.iA, set: Z.prototype.PC });
        Z.prototype.get_m_localShapeInfo = Z.prototype.CA = function () { return k(hA(this.hy), tB); };
        Z.prototype.set_m_localShapeInfo = Z.prototype.iD = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); iA(c, a); };
        Object.defineProperty(Z.prototype, "m_localShapeInfo", { get: Z.prototype.CA, set: Z.prototype.iD });
        Z.prototype.get_m_hitNormalLocal = Z.prototype.mA = function () { return k(jA(this.hy), p); };
        Z.prototype.set_m_hitNormalLocal = Z.prototype.TC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); kA(c, a); };
        Object.defineProperty(Z.prototype, "m_hitNormalLocal", { get: Z.prototype.mA, set: Z.prototype.TC });
        Z.prototype.get_m_hitPointLocal = Z.prototype.oA = function () { return k(lA(this.hy), p); };
        Z.prototype.set_m_hitPointLocal = Z.prototype.VC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); mA(c, a); };
        Object.defineProperty(Z.prototype, "m_hitPointLocal", { get: Z.prototype.oA, set: Z.prototype.VC });
        Z.prototype.get_m_hitFraction = Z.prototype.jA = function () { return nA(this.hy); };
        Z.prototype.set_m_hitFraction = Z.prototype.QC = function (a) { var c = this.hy; a && "object" === typeof a && (a = a.hy); oA(c, a); };
        Object.defineProperty(Z.prototype, "m_hitFraction", { get: Z.prototype.jA, set: Z.prototype.QC });
        Z.prototype.__destroy__ = function () { pA(this.hy); };
...
if (typeof exports === 'object' && typeof module === 'object')
    ...
    exports["Ammo"] = Ammo;
//# sourceMappingURL=ammo.wasm.js.map