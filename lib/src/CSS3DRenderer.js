define(["require", "exports", "three"], function (require, exports, three_1) {
    ...
    //
    const _position = new three_1.Vector3();
    const _quaternion = new three_1.Quaternion();
    const _scale = new three_1.Vector3();
    class CSS3DObject extends three_1.Object3D {
    ...
    const _matrix2 = new three_1.Matrix4();
    class CSS3DRenderer {
        constructor(parameters = {}) {
            ...
            this.render = function (scene, camera) {
                ...
                const billboardMatrix = new three_1.Matrix4().copy(camera.matrixWorldInverse).transpose();
