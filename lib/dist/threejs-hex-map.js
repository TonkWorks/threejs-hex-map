define("threejs-hex-map", ["three"], function (__WEBPACK_EXTERNAL_MODULE_4__) {
    return /******/ (function (modules) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(1), __webpack_require__(17), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, MapMesh_1, DefaultMapViewController_1, Grid_1) {
                "use strict";
        ...
        /***/ (function (module, exports, __webpack_require__) {
            var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
            !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, util_1) {
                "use strict";
                Object.defineProperty(exports, "__esModule", { value: true });
                class Grid {
                    ...
                    neighbors(q, r, range = 1) {
                        return (range == 1 ? Grid.NEIGHBOR_QRS : util_1.qrRange(range)).map(qr => {
            ...
            !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(4), __webpack_require__(6), __webpack_require__(7), __webpack_require__(5), __webpack_require__(13), __webpack_require__(14), __webpack_require__(15)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, three_1, Grid_1, util_1, coords_1, trees_vertex_1, trees_fragment_1, map_generator_1) {
                ...
                class Trees extends three_1.Object3D {
                    ...
                    createGeometry() {
                        ...
                        // tree positions
                        const positions = util_1.flatMap(this._tiles, (tile, j) => {
                            ...
                            for (let i = 0; i < treesPerForest; i++) {
                                const tilePos = coords_1.qrToWorld(tile.q, tile.r, mapScale);
                                const localPos = map_generator_1.randomPointOnCoastTile(map_generator_1.waterAdjacency(this._globalGrid, tile), mapScale);
	...
	`;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
            !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(5), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, coords_1, three_1) {
                "use strict";
                Object.defineProperty(exports, "__esModule", { value: true });
                class Animation {
                    /**
                ...
                class Controller {
                    constructor() {
                        ...
                        this.onMouseDown = (e) => {
                            ...
                            this.mouseDownPos = coords_1.screenToWorld(e.clientX, e.clientY, this.pickingCamera);
                        ...
                        this.onMouseMove = (e) => {
                            ...
                            if (this.mouseDownPos) {
                                const mousePos = coords_1.screenToWorld(e.clientX, e.clientY, this.pickingCamera);
                        ...
                        this.onMouseUpMini = (e) => {
                            if (!this.lastDrag || this.lastDrag.length() < 0.1) {
                                const mousePos = coords_1.screenToWorldMiniMap(e.clientX, e.clientY, this.controls.getMiniMapCamera());
                                const tile = this.controls.pickTile(mousePos);
...
;
//# sourceMappingURL=threejs-hex-map.js.map