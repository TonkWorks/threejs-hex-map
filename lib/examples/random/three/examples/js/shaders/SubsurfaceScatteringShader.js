...
THREE.SubsurfaceScatteringShader = {
    ...
    fragmentShader: [
        ...
        "}",
        meshphong_frag_body.replace("#include <lights_fragment_begin>", replaceAll(THREE.ShaderChunk['lights_fragment_begin'], 'RE_Direct( directLight, geometry, material, reflectedLight );', [
