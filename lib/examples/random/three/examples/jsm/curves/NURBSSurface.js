define(["require", "exports", "../../../build/three.module.js", "../curves/NURBSUtils.js"], function (require, exports, three_module_js_1, NURBSUtils_js_1) {
    ...
    var NURBSSurface = function (degree1, degree2, knots1, knots2 /* arrays of reals */, controlPoints /* array^2 of Vector(2|3|4) */) {
        ...
        for (var i = 0; i < len1; ++i) {
            ...
            for (var j = 0; j < len2; ++j) {
                ...
                this.controlPoints[i][j] = new three_module_js_1.Vector4(point.x, point.y, point.z, point.w);
            }
        }
    };
    ...
    NURBSSurface.prototype = {
        ...
        getPoint: function (t1, t2, target) {
            ...
            NURBSUtils_js_1.NURBSUtils.calcSurfacePoint(this.degree1, this.degree2, this.knots1, this.knots2, this.controlPoints, u, v, target);
        }
    };
});
