define(["require", "exports", "../../../build/three.module.js", "../libs/mmdparser.module.js"], function (require, exports, three_module_js_1, mmdparser_module_js_1) {
    "use strict";
    ...
    var MMDExporter = function () {
        ...
        function unicodeToShiftjis(str) {
            if (u2sTable === undefined) {
                var encoder = new mmdparser_module_js_1.MMDParser.CharsetEncoder(); // eslint-disable-line no-undef
        ...
        */
        ...
        this.parseVpd = function (skin, outputShiftJis, useOriginalBones) {
            ...
            var quaternion2 = new three_module_js_1.Quaternion();
