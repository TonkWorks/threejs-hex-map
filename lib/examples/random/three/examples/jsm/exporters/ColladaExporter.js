    ...
    ColladaExporter.prototype = {
        ...
        parse: function (object, onDone, options) {
            ...
            function getTransform(o) {
                ...
                o.updateMatrix();
                transMat = transMat || new three_module_js_1.Matrix4();
            ...
            function processGeometry(g) {
                ...
                if (!info) {
                    ...
                    if (bufferGeometry instanceof three_module_js_1.Geometry) {
                        bufferGeometry = (new three_module_js_1.BufferGeometry()).fromGeometry(bufferGeometry);
                    }
                    var meshid = `Mesh${libraryGeometries.length + 1}`;
                    var indexCount = bufferGeometry.index ?
                        bufferGeometry.index.count * bufferGeometry.index.itemSize :
                        bufferGeometry.attributes.position.count;
                    var groups = bufferGeometry.groups != null && bufferGeometry.groups.length !== 0 ?
            ...
            function processMaterial(m) {
                ...
                if (matid == null) {
                    ...
                    var type = 'phong';
                    if (m instanceof three_module_js_1.MeshLambertMaterial) {
                        type = 'lambert';
                    }
                    else if (m instanceof three_module_js_1.MeshBasicMaterial) {
                        type = 'constant';
                        if (m.map !== null) {
                    ...
                    var emissive = m.emissive ? m.emissive : new three_module_js_1.Color(0, 0, 0);
                    var diffuse = m.color ? m.color : new three_module_js_1.Color(0, 0, 0);
                    var specular = m.specular ? m.specular : new three_module_js_1.Color(1, 1, 1);
                    ...
                    var effectnode = `<effect id="${matid}-effect">` +
                        ...
                        (m.normalMap ?
                            ...
                            '') +
                        techniqueNode +
                        (m.side === three_module_js_1.DoubleSide ?
            ...
            function processObject(o) {
                ...
                node += getTransform(o);
                if (o instanceof three_module_js_1.Mesh && o.geometry != null) {
                    ...
                    // the materials.
                    var mat = o.material || new three_module_js_1.MeshBasicMaterial();
                        ...
                        `<instance_geometry url="#${meshid}">` +
                            (matids != null ?
                                '<bind_material><technique_common>' +
                                    matids.map((id, i) => `<instance_material symbol="MESH_MATERIAL_${i}" target="#${id}" >` +
                                        '<bind_vertex_input semantic="TEXCOORD" input_semantic="TEXCOORD" input_set="0" />' +
                                        '</instance_material>').join('') +
