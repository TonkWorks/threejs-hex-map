...
define(["require", "exports", "../../../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    MeshReceiver.prototype = {
        ...
        buildMeshes: function (meshPayload) {
            ...
            const bufferGeometry = new three_module_js_1.BufferGeometry();
            if (buffers.vertices !== undefined && buffers.vertices !== null) {
                bufferGeometry.setAttribute('position', new three_module_js_1.BufferAttribute(new Float32Array(buffers.vertices), 3));
            }
            if (buffers.indices !== undefined && buffers.indices !== null) {
                bufferGeometry.setIndex(new three_module_js_1.BufferAttribute(new Uint32Array(buffers.indices), 1));
            }
            if (buffers.colors !== undefined && buffers.colors !== null) {
                bufferGeometry.setAttribute('color', new three_module_js_1.BufferAttribute(new Float32Array(buffers.colors), 3));
            }
            if (buffers.normals !== undefined && buffers.normals !== null) {
                bufferGeometry.setAttribute('normal', new three_module_js_1.BufferAttribute(new Float32Array(buffers.normals), 3));
            }
            else {
                bufferGeometry.computeVertexNormals();
            }
            if (buffers.uvs !== undefined && buffers.uvs !== null) {
                bufferGeometry.setAttribute('uv', new three_module_js_1.BufferAttribute(new Float32Array(buffers.uvs), 2));
            }
            if (buffers.skinIndex !== undefined && buffers.skinIndex !== null) {
                bufferGeometry.setAttribute('skinIndex', new three_module_js_1.BufferAttribute(new Uint16Array(buffers.skinIndex), 4));
            }
            if (buffers.skinWeight !== undefined && buffers.skinWeight !== null) {
                bufferGeometry.setAttribute('skinWeight', new three_module_js_1.BufferAttribute(new Float32Array(buffers.skinWeight), 4));
            }
            ...
            if (useOrgMesh) {
                ...
                if (geometryType === 0) {
                    mesh = new three_module_js_1.Mesh(bufferGeometry, material);
                }
                else if (geometryType === 1) {
                    mesh = new three_module_js_1.LineSegments(bufferGeometry, material);
                }
                else {
                    mesh = new three_module_js_1.Points(bufferGeometry, material);
                }
                mesh.name = meshName;
                meshes.push(mesh);
            }
...
//# sourceMappingURL=MeshReceiver.js.map