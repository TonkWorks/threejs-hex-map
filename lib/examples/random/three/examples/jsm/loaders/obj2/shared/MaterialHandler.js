...
define(["require", "exports", "../../../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    MaterialHandler.prototype = {
        ...
        createDefaultMaterials: function (overrideExisting) {
            const defaultMaterial = new three_module_js_1.MeshStandardMaterial({ color: 0xDCF1FF });
            defaultMaterial.name = 'defaultMaterial';
            const defaultVertexColorMaterial = new three_module_js_1.MeshStandardMaterial({ color: 0xDCF1FF });
            defaultVertexColorMaterial.name = 'defaultVertexColorMaterial';
            defaultVertexColorMaterial.vertexColors = true;
            const defaultLineMaterial = new three_module_js_1.LineBasicMaterial();
            defaultLineMaterial.name = 'defaultLineMaterial';
            const defaultPointMaterial = new three_module_js_1.PointsMaterial({ size: 0.1 });
        ...
        addPayloadMaterials: function (materialPayload) {
            ...
            if (materials !== undefined && materials !== null && Object.keys(materials).length > 0) {
                const loader = new three_module_js_1.MaterialLoader();
                let materialJson;
...
//# sourceMappingURL=MaterialHandler.js.map