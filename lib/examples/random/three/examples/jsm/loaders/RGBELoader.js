define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    RGBELoader.prototype = Object.assign(Object.create(three_module_js_1.DataTextureLoader.prototype), {
                ...
                if (RGBE_RETURN_FAILURE !== image_rgba_data) {
                    switch (this.type) {
                        case three_module_js_1.UnsignedByteType:
                            ...
                            var format = three_module_js_1.RGBEFormat; // handled as THREE.RGBAFormat in shaders
                            var type = three_module_js_1.UnsignedByteType;
                            break;
                        case three_module_js_1.FloatType:
                            ...
                            var data = floatArray;
                            var format = three_module_js_1.RGBFormat;
                            var type = three_module_js_1.FloatType;
                            break;
                        case three_module_js_1.HalfFloatType:
                            ...
                            var data = halfArray;
                            var format = three_module_js_1.RGBFormat;
                            var type = three_module_js_1.HalfFloatType;
                            break;
                        default:
