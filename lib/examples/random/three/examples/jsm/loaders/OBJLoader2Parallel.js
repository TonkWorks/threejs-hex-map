 ...
 */
define(["require", "exports", "../../../build/three.module.js", "./obj2/worker/main/WorkerExecutionSupport.js", "./obj2/utils/CodeSerializer.js", "./OBJLoader2.js", "./obj2/OBJLoader2Parser.js", "./obj2/worker/parallel/WorkerRunner.js"], function (require, exports, three_module_js_1, WorkerExecutionSupport_js_1, CodeSerializer_js_1, OBJLoader2_js_1, OBJLoader2Parser_js_1, WorkerRunner_js_1) {
    "use strict";
    ...
    const OBJLoader2Parallel = function (manager) {
        OBJLoader2_js_1.OBJLoader2.call(this, manager);
        this.preferJsmWorker = false;
        this.jsmWorkerUrl = null;
        this.executeParallel = true;
        this.workerExecutionSupport = new WorkerExecutionSupport_js_1.WorkerExecutionSupport();
    };
    ...
    OBJLoader2Parallel.prototype = Object.assign(Object.create(OBJLoader2_js_1.OBJLoader2.prototype), {
        ...
        buildWorkerCode: function () {
            const codeBuilderInstructions = new WorkerExecutionSupport_js_1.CodeBuilderInstructions(true, true, this.preferJsmWorker);
            ...
            if (codeBuilderInstructions.isSupportsStandardWorker()) {
                const objectManipulator = new WorkerRunner_js_1.ObjectManipulator();
                const defaultWorkerPayloadHandler = new WorkerRunner_js_1.DefaultWorkerPayloadHandler(this.parser);
                const workerRunner = new WorkerRunner_js_1.WorkerRunner({});
                codeBuilderInstructions.addCodeFragment(CodeSerializer_js_1.CodeSerializer.serializeClass(OBJLoader2Parser_js_1.OBJLoader2Parser, this.parser));
                codeBuilderInstructions.addCodeFragment(CodeSerializer_js_1.CodeSerializer.serializeClass(WorkerRunner_js_1.ObjectManipulator, objectManipulator));
                codeBuilderInstructions.addCodeFragment(CodeSerializer_js_1.CodeSerializer.serializeClass(WorkerRunner_js_1.DefaultWorkerPayloadHandler, defaultWorkerPayloadHandler));
                codeBuilderInstructions.addCodeFragment(CodeSerializer_js_1.CodeSerializer.serializeClass(WorkerRunner_js_1.WorkerRunner, workerRunner));
        ...
        load: function (content, onLoad, onFileLoadProgress, onError, onMeshAlter) {
            ...
            OBJLoader2_js_1.OBJLoader2.prototype.load.call(this, content, interceptOnLoad, onFileLoadProgress, onError, onMeshAlter);
        },
        /**
        ...
        parse: function (content) {
            if (this.executeParallel) {
                ...
                const dummy = new three_module_js_1.Object3D();
                dummy.name = 'OBJLoader2ParallelDummy';
                return dummy;
            }
            else {
                return OBJLoader2_js_1.OBJLoader2.prototype.parse.call(this, content);
            }
        },
    });
});
//# sourceMappingURL=OBJLoader2Parallel.js.map