define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    MD2Loader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
        ...
        parse: (function () {
            ...
            return function (buffer) {
                ...
                // frames
                var translation = new three_module_js_1.Vector3();
                ...
                for (var i = 0, l = frames.length; i < l; i++) {
                    ...
                    if (frame.vertices.length > 0) {
                        ...
                        var positionAttribute = new three_module_js_1.Float32BufferAttribute(positions, 3);
                    ...
                    if (frame.normals.length > 0) {
                        ...
                        var normalAttribute = new three_module_js_1.Float32BufferAttribute(normals, 3);
                ...
                geometry.animations = three_module_js_1.AnimationClip.CreateClipsFromMorphTargetSequences(frames, 10);
                return geometry;
            };
        })()
    });
