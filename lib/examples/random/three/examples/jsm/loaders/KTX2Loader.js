...
define(["require", "exports", "../../../build/three.module.js", "../libs/zstddec.module.js"], function (require, exports, three_module_js_1, zstddec_module_js_1) {
    "use strict";
    ...
    //
    class KTX2Loader extends three_module_js_1.CompressedTextureLoader {
        constructor(manager) {
            super(manager);
        ...
        load(url, onLoad, onProgress, onError) {
            var scope = this;
            var texture = new three_module_js_1.CompressedTexture();
        ...
        parse(buffer, onLoad, onError) {
            ...
            ktx.initMipmaps(transcoder, this.transcoderConfig)
                .then(function () {
                var texture = new three_module_js_1.CompressedTexture(ktx.mipmaps, ktx.getWidth(), ktx.getHeight(), ktx.transcodedFormat, three_module_js_1.UnsignedByteType);
                texture.encoding = ktx.getEncoding();
                texture.premultiplyAlpha = ktx.getPremultiplyAlpha();
                texture.minFilter = ktx.mipmaps.length === 1 ? three_module_js_1.LinearFilter : three_module_js_1.LinearMipmapLinearFilter;
    ...
    class KTX2Container {
        constructor(basisModule, arrayBuffer) {
            ...
            this.zstd = new zstddec_module_js_1.ZSTDDecoder();
            this.zstd.init();
            this.mipmaps = null;
        ...
        initMipmaps(transcoder, config) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var pvrtcTranscodable = three_module_js_1.MathUtils.isPowerOfTwo(width) && three_module_js_1.MathUtils.isPowerOfTwo(height);
                ...
                if (config.astcSupported) {
                    ...
                    this.transcodedFormat = three_module_js_1.RGBA_ASTC_4x4_Format;
                }
                else if (config.bptcSupported && texFormat === TextureFormat.UASTC4x4) {
                    targetFormat = TranscodeTarget.BC7_M5_RGBA;
                    this.transcodedFormat = three_module_js_1.RGBA_BPTC_Format;
                }
                else if (config.dxtSupported) {
                    targetFormat = hasAlpha ? TranscodeTarget.BC3_RGBA : TranscodeTarget.BC1_RGB;
                    this.transcodedFormat = hasAlpha ? three_module_js_1.RGBA_S3TC_DXT5_Format : three_module_js_1.RGB_S3TC_DXT1_Format;
                }
                    ...
                    this.transcodedFormat = hasAlpha ? three_module_js_1.RGBA_PVRTC_4BPPV1_Format : three_module_js_1.RGB_PVRTC_4BPPV1_Format;
                }
                else if (config.etc2Supported) {
                    targetFormat = hasAlpha ? TranscodeTarget.ETC2_RGBA : TranscodeTarget.ETC1_RGB /* subset of ETC2 */;
                    this.transcodedFormat = hasAlpha ? three_module_js_1.RGBA_ETC2_EAC_Format : three_module_js_1.RGB_ETC2_Format;
                }
                else if (config.etc1Supported) {
                    targetFormat = TranscodeTarget.ETC1_RGB;
                    this.transcodedFormat = three_module_js_1.RGB_ETC1_Format;
                }
                else {
                    console.warn('THREE.KTX2Loader: No suitable compressed texture format found. Decoding to RGBA32.');
                    targetFormat = TranscodeTarget.RGBA32;
                    this.transcodedFormat = three_module_js_1.RGBAFormat;
                }
        ...
        getEncoding() {
            return this.dfd.transferFunction === 2 /* KHR_DF_TRANSFER_SRGB */
                ? three_module_js_1.sRGBEncoding
                : three_module_js_1.LinearEncoding;
        }
        getTexFormat() {
            var TextureFormat = this.basisModule.TextureFormat;
