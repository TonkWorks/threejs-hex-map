define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    BasisTextureLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
            ...
            var texturePending = this._allocateWorker(taskCost)
                ...
                switch (format) {
                    case BasisTextureLoader.BASIS_FORMAT.cTFASTC_4x4:
                        texture = new three_module_js_1.CompressedTexture(mipmaps, width, height, three_module_js_1.RGBA_ASTC_4x4_Format);
                        break;
                    case BasisTextureLoader.BASIS_FORMAT.cTFBC7_M5:
                        texture = new three_module_js_1.CompressedTexture(mipmaps, width, height, three_module_js_1.RGBA_BPTC_Format);
                        break;
                    case BasisTextureLoader.BASIS_FORMAT.cTFBC1:
                    case BasisTextureLoader.BASIS_FORMAT.cTFBC3:
                        texture = new three_module_js_1.CompressedTexture(mipmaps, width, height, BasisTextureLoader.DXT_FORMAT_MAP[config.format], three_module_js_1.UnsignedByteType);
                        break;
                    case BasisTextureLoader.BASIS_FORMAT.cTFETC1:
                        texture = new three_module_js_1.CompressedTexture(mipmaps, width, height, three_module_js_1.RGB_ETC1_Format);
                        break;
                    case BasisTextureLoader.BASIS_FORMAT.cTFPVRTC1_4_RGB:
                        texture = new three_module_js_1.CompressedTexture(mipmaps, width, height, three_module_js_1.RGB_PVRTC_4BPPV1_Format);
                        break;
                    case BasisTextureLoader.BASIS_FORMAT.cTFPVRTC1_4_RGBA:
                        texture = new three_module_js_1.CompressedTexture(mipmaps, width, height, three_module_js_1.RGBA_PVRTC_4BPPV1_Format);
                        break;
                    default:
                        throw new Error('THREE.BasisTextureLoader: No supported format available.');
                }
                texture.minFilter = mipmaps.length === 1 ? three_module_js_1.LinearFilter : three_module_js_1.LinearMipmapLinearFilter;
