define(["require", "exports", "../../../build/three.module.js", "../loaders/TGALoader.js", "../libs/mmdparser.module.js"], function (require, exports, three_module_js_1, TGALoader_js_1, mmdparser_module_js_1) {
    "use strict";
    ...
    var MMDLoader = (function () {
        ...
        function MMDLoader(manager) {
            ...
            this.loader = new three_module_js_1.FileLoader(this.manager);
            this.parser = null; // lazy generation
            this.meshBuilder = new MeshBuilder(this.manager);
            this.animationBuilder = new AnimationBuilder();
        }
        MMDLoader.prototype = Object.assign(Object.create(three_module_js_1.Loader.prototype), {
            ...
            _getParser: function () {
                if (this.parser === null) {
                    if (typeof mmdparser_module_js_1.MMDParser === 'undefined') {
                        throw new Error('THREE.MMDLoader: Import MMDParser https://github.com/takahirox/mmd-parser');
                    }
                    this.parser = new mmdparser_module_js_1.MMDParser.Parser(); // eslint-disable-line no-undef
                }
                return this.parser;
            }
        });
        ...
        MeshBuilder.prototype = {
            ...
            build: function (data, resourcePath, onProgress, onError) {
                ...
                var mesh = new three_module_js_1.SkinnedMesh(geometry, material);
                var skeleton = new three_module_js_1.Skeleton(initBones(mesh));
                mesh.bind(skeleton);
        ...
        GeometryBuilder.prototype = {
            ...
            build: function (data) {
                    ...
                    for (var i = 0; i < data.metadata.ikCount; i++) {
                        ...
                        for (var j = 0, jl = ik.links.length; j < jl; j++) {
                            ...
                            if (data.bones[link.index].name.indexOf('ひざ') >= 0) {
                                link.limitation = new three_module_js_1.Vector3(1.0, 0.0, 0.0);
                            }
                    ...
                    for (var i = 0; i < data.metadata.boneCount; i++) {
                        ...
                        for (var j = 0, jl = ik.links.length; j < jl; j++) {
                            ...
                            if (ik.links[j].angleLimitation === 1) {
                                ...
                                rotationMin[0] = tmp1;
                                rotationMin[1] = tmp2;
                                link.rotationMin = new three_module_js_1.Vector3().fromArray(rotationMin);
                                link.rotationMax = new three_module_js_1.Vector3().fromArray(rotationMax);
                            }
                            param.links.push(link);
                        }
                        iks.push(param);
                ...
                for (var i = 0; i < data.metadata.morphCount; i++) {
                    ...
                    var attribute = new three_module_js_1.Float32BufferAttribute(data.metadata.vertexCount * 3, 3);
                ...
                geometry.setAttribute('normal', new three_module_js_1.Float32BufferAttribute(normals, 3));
                geometry.setAttribute('uv', new three_module_js_1.Float32BufferAttribute(uvs, 2));
                geometry.setAttribute('skinIndex', new three_module_js_1.Uint16BufferAttribute(skinIndices, 4));
                geometry.setAttribute('skinWeight', new three_module_js_1.Float32BufferAttribute(skinWeights, 4));
        ...
        function MaterialBuilder(manager) {
            ...
            this.textureLoader = new three_module_js_1.TextureLoader(this.manager);
        ...
        MaterialBuilder.prototype = {
            ...
            build: function (data, geometry /*, onProgress, onError */) {
                ...
                for (var i = 0; i < data.metadata.materialCount; i++) {
                     ...
                     */
                    params.color = new three_module_js_1.Color().fromArray(material.diffuse);
                    params.opacity = material.diffuse[3];
                    params.emissive = new three_module_js_1.Color().fromArray(material.ambient);
                    ...
                    params.fog = true;
                    // blend
                    params.blending = three_module_js_1.CustomBlending;
                    params.blendSrc = three_module_js_1.SrcAlphaFactor;
                    params.blendDst = three_module_js_1.OneMinusSrcAlphaFactor;
                    params.blendSrcAlpha = three_module_js_1.SrcAlphaFactor;
                    params.blendDstAlpha = three_module_js_1.DstAlphaFactor;
                    // side
                    if (data.metadata.format === 'pmx' && (material.flag & 0x1) === 1) {
                        params.side = three_module_js_1.DoubleSide;
                    }
                    else {
                        params.side = params.opacity === 1.0 ? three_module_js_1.FrontSide : three_module_js_1.DoubleSide;
                    }
                    if (data.metadata.format === 'pmd') {
                        // map, envMap
                        if (material.fileName) {
                            ...
                            if (fileNames.length > 1) {
                                ...
                                params.combine = extension === '.sph'
                                    ? three_module_js_1.MultiplyOperation
                                    : three_module_js_1.AddOperation;
                            }
                        }
                        // gradientMap
                    ...
                    materials.push(new three_module_js_1.MeshToonMaterial(params));
                }
                if (data.metadata.format === 'pmx') {
            ...
            _getTGALoader: function () {
                if (this.tgaLoader === null) {
                    if (TGALoader_js_1.TGALoader === undefined) {
                        throw new Error('THREE.MMDLoader: Import TGALoader');
                    }
                    this.tgaLoader = new TGALoader_js_1.TGALoader(this.manager);
                }
            ...
            _loadTexture: function (filePath, textures, params, onProgress, onError) {
                ...
                var texture = loader.load(fullPath, function (t) {
                    ...
                    if (params.isToonTexture === true) {
                        ...
                        t.magFilter = three_module_js_1.NearestFilter;
                        t.minFilter = three_module_js_1.NearestFilter;
                    }
                    t.flipY = false;
                    t.wrapS = three_module_js_1.RepeatWrapping;
                    t.wrapT = three_module_js_1.RepeatWrapping;
        ...
        AnimationBuilder.prototype = {
            ...
            build: function (vmd, mesh) {
                ...
                return new three_module_js_1.AnimationClip('', -1, tracks);
            },
            /**
             * @param {Object} vmd - parsed VMD data
             * @param {SkinnedMesh} mesh - tracks will be fitting to mesh
            ...
            buildSkeletalAnimation: function (vmd, mesh) {
                ...
                for (var key in motions) {
                    ...
                    tracks.push(this._createTrack(targetName + '.position', three_module_js_1.VectorKeyframeTrack, times, positions, pInterpolations));
                    tracks.push(this._createTrack(targetName + '.quaternion', three_module_js_1.QuaternionKeyframeTrack, times, rotations, rInterpolations));
                }
                return new three_module_js_1.AnimationClip('', -1, tracks);
            },
            /**
            ...
            buildMorphAnimation: function (vmd, mesh) {
                ...
                for (var key in morphs) {
                    ...
                    tracks.push(new three_module_js_1.NumberKeyframeTrack('.morphTargetInfluences[' + morphTargetDictionary[key] + ']', times, values));
                }
                return new three_module_js_1.AnimationClip('', -1, tracks);
            },
            /**
            ...
            buildCameraAnimation: function (vmd) {
                ...
                var center = new three_module_js_1.Vector3();
                ...
                tracks.push(this._createTrack('target.position', three_module_js_1.VectorKeyframeTrack, times, centers, cInterpolations));
                tracks.push(this._createTrack('.quaternion', three_module_js_1.QuaternionKeyframeTrack, times, quaternions, qInterpolations));
                tracks.push(this._createTrack('.position', three_module_js_1.VectorKeyframeTrack, times, positions, pInterpolations));
                tracks.push(this._createTrack('.fov', three_module_js_1.NumberKeyframeTrack, times, fovs, fInterpolations));
                return new three_module_js_1.AnimationClip('', -1, tracks);
            },
            // private method
        ...
        CubicBezierInterpolation.prototype = Object.assign(Object.create(three_module_js_1.Interpolant.prototype), {
            ...
            interpolate_: function (i1, t0, t, t1) {
                ...
                if (stride === 4) { // Quaternion
                    ...
                    three_module_js_1.Quaternion.slerpFlat(result, 0, values, offset0, values, offset1, ratio);
                }
