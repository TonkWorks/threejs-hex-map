define(["require", "exports", "../../../build/three.module.js", "../postprocessing/Pass.js", "../shaders/CopyShader.js"], function (require, exports, three_module_js_1, Pass_js_1, CopyShader_js_1) {
    ...
    */
    var SSAARenderPass = function (scene, camera, clearColor, clearAlpha) {
        ...
        this.fsQuad = new Pass_js_1.Pass.FullScreenQuad(this.copyMaterial);
    };
    exports.SSAARenderPass = SSAARenderPass;
    SSAARenderPass.prototype = Object.assign(Object.create(Pass_js_1.Pass.prototype), {
        ...
        render: function (renderer, writeBuffer, readBuffer) {
            if (!this.sampleRenderTarget) {
                this.sampleRenderTarget = new three_module_js_1.WebGLRenderTarget(readBuffer.width, readBuffer.height, { minFilter: three_module_js_1.LinearFilter, magFilter: three_module_js_1.LinearFilter, format: three_module_js_1.RGBAFormat });
