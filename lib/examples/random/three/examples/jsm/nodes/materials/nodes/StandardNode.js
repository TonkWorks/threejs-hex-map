define(["require", "exports", "../../../../../build/three.module.js", "../../core/Node.js", "../../core/ExpressionNode.js", "../../inputs/ColorNode.js", "../../inputs/FloatNode.js", "../../utils/SpecularMIPLevelNode.js"], function (require, exports, three_module_js_1, Node_js_1, ExpressionNode_js_1, ColorNode_js_1, FloatNode_js_1, SpecularMIPLevelNode_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function StandardNode() {
        Node_js_1.Node.call(this);
        this.color = new ColorNode_js_1.ColorNode(0xFFFFFF);
        this.roughness = new FloatNode_js_1.FloatNode(1);
        this.metalness = new FloatNode_js_1.FloatNode(0);
    }
    exports.StandardNode = StandardNode;
    StandardNode.prototype = Object.create(Node_js_1.Node.prototype);
    ...
    StandardNode.prototype.build = function (builder) {
        ...
        if (builder.isShader('vertex')) {
            ...
            builder.mergeUniform(three_module_js_1.UniformsUtils.merge([
                three_module_js_1.UniformsLib.fog,
                three_module_js_1.UniformsLib.lights
            ]));
            if (three_module_js_1.UniformsLib.LTC_1) {
            ...
            var specularRoughness = new ExpressionNode_js_1.ExpressionNode('material.specularRoughness', 'f');
            var clearcoatRoughness = new ExpressionNode_js_1.ExpressionNode('material.clearcoatRoughness', 'f');
            var contextEnvironment = {
                roughness: specularRoughness,
                bias: new SpecularMIPLevelNode_js_1.SpecularMIPLevelNode(specularRoughness),
                viewNormal: new ExpressionNode_js_1.ExpressionNode('normal', 'v3'),
                worldNormal: new ExpressionNode_js_1.ExpressionNode('inverseTransformDirection( geometry.normal, viewMatrix )', 'v3'),
                gamma: true
            };
            ...
            var contextClearcoatEnvironment = {
                ...
                bias: new SpecularMIPLevelNode_js_1.SpecularMIPLevelNode(clearcoatRoughness),
                viewNormal: new ExpressionNode_js_1.ExpressionNode('clearcoatNormal', 'v3'),
                worldNormal: new ExpressionNode_js_1.ExpressionNode('inverseTransformDirection( geometry.clearcoatNormal, viewMatrix )', 'v3'),
                gamma: true
            };
...
//# sourceMappingURL=StandardNode.js.map