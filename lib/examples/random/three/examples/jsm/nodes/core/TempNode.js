define(["require", "exports", "../../../../build/three.module.js", "./Node.js"], function (require, exports, three_module_js_1, Node_js_1) {
    "use strict";
    ...
    TempNode.prototype = Object.create(Node_js_1.Node.prototype);
    ...
    TempNode.prototype.build = function (builder, output, uuid, ns) {
        ...
        if (this.getShared(builder, output)) {
            ...
            if (isUnique && this.constructor.uuid === undefined) {
                this.constructor.uuid = three_module_js_1.MathUtils.generateUUID();
            }
            ...
            if (builder.analyzing) {
                ...
                return Node_js_1.Node.prototype.build.call(this, builder, output, uuid);
            }
            else if (isUnique) {
                data.name = data.name || Node_js_1.Node.prototype.build.call(this, builder, output, uuid);
                return data.name;
            }
...
//# sourceMappingURL=TempNode.js.map