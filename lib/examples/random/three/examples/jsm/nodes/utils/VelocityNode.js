define(["require", "exports", "../../../../build/three.module.js", "../inputs/Vector3Node.js"], function (require, exports, three_module_js_1, Vector3Node_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function VelocityNode(target, params) {
        Vector3Node_js_1.Vector3Node.call(this);
        this.params = {};
        this.velocity = new three_module_js_1.Vector3();
        this.setTarget(target);
        this.setParams(params);
    }
    exports.VelocityNode = VelocityNode;
    VelocityNode.prototype = Object.create(Vector3Node_js_1.Vector3Node.prototype);
    ...
    VelocityNode.prototype.setParams = function (params) {
        ...
        switch (this.params.type) {
            case "elastic":
                this.moment = new three_module_js_1.Vector3();
                this.speed = new three_module_js_1.Vector3();
                this.springVelocity = new three_module_js_1.Vector3();
                this.lastVelocity = new three_module_js_1.Vector3();
                break;
        }
    };
    VelocityNode.prototype.setTarget = function (target) {
        ...
        this.target = target;
        if (target) {
            this.position = target.getWorldPosition(this.position || new three_module_js_1.Vector3());
            this.oldPosition = this.position.clone();
        }
    };
    VelocityNode.prototype.updateFrameVelocity = function ( /*frame*/) {
        if (this.target) {
            this.position = this.target.getWorldPosition(this.position || new three_module_js_1.Vector3());
    ...
    VelocityNode.prototype.copy = function (source) {
        Vector3Node_js_1.Vector3Node.prototype.copy.call(this, source);
        if (source.target)
