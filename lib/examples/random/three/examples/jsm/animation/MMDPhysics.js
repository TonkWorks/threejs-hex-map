define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var MMDPhysics = (function () {
        ...
        function MMDPhysics(mesh, rigidBodyParams, constraintParams, params) {
            ...
            this.gravity = new three_module_js_1.Vector3(0, -9.8 * 10, 0);
        ...
        ResourceManager.prototype = {
            ...
            allocThreeQuaternion: function () {
                return (this.threeQuaternions.length > 0)
                    ...
                    : new three_module_js_1.Quaternion();
            },
        ...
        function MMDPhysicsHelper(mesh, physics) {
            ...
            this.materials = [];
            this.materials.push(new three_module_js_1.MeshBasicMaterial({
        ...
        MMDPhysicsHelper.prototype = Object.assign(Object.create(three_module_js_1.Object3D.prototype), {
            ...
            updateMatrixWorld: function () {
                ...
                var matrixWorldInv = new three_module_js_1.Matrix4();
                    ...
                    if (this.visible) {
                        ...
                        for (var i = 0, il = bodies.length; i < il; i++) {
                            ...
                            child.quaternion
                                ...
                                .multiply(quaternion.set(rotation.x(), rotation.y(), rotation.z(), rotation.w()));
                        }
                    }
                    this.matrix
                        .copy(mesh.matrixWorld)
            ...
            _init: function () {
                ...
                function createGeometry(param) {
                    switch (param.shapeType) {
                        case 0:
                            return new three_module_js_1.SphereBufferGeometry(param.width, 16, 8);
                        case 1:
                            return new three_module_js_1.BoxBufferGeometry(param.width * 2, param.height * 2, param.depth * 2, 8, 8, 8);
                        case 2:
                ...
                function createCapsuleGeometry(radius, cylinderHeight, segmentsRadius, segmentsHeight) {
                    var geometry = new three_module_js_1.CylinderBufferGeometry(radius, radius, cylinderHeight, segmentsRadius, segmentsHeight, true);
                    var upperSphere = new three_module_js_1.Mesh(new three_module_js_1.SphereBufferGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, 0, Math.PI / 2));
                    var lowerSphere = new three_module_js_1.Mesh(new three_module_js_1.SphereBufferGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, Math.PI / 2, Math.PI / 2));
                ...
                for (var i = 0, il = bodies.length; i < il; i++) {
                    ...
                    this.add(new three_module_js_1.Mesh(createGeometry(param), this.materials[param.type]));
                }
            }
        });
        return MMDPhysics;
