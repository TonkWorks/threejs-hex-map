define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    var ShadowMesh = function (mesh) {
        var shadowMaterial = new three_module_js_1.MeshBasicMaterial({
            color: 0x000000,
            transparent: true,
            opacity: 0.6,
            depthWrite: false
        });
        three_module_js_1.Mesh.call(this, mesh.geometry, shadowMaterial);
        this.meshMatrix = mesh.matrixWorld;
        this.frustumCulled = false;
        this.matrixAutoUpdate = false;
    };
    exports.ShadowMesh = ShadowMesh;
    ShadowMesh.prototype = Object.create(three_module_js_1.Mesh.prototype);
    ShadowMesh.prototype.constructor = ShadowMesh;
    ShadowMesh.prototype.update = function () {
        var shadowMatrix = new three_module_js_1.Matrix4();
