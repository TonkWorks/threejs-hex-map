define(["require", "exports", "../../../build/three.module.js", "../misc/VolumeSlice.js"], function (require, exports, three_module_js_1, VolumeSlice_js_1) {
    "use strict";
    ...
    var Volume = function (xLength, yLength, zLength, type, arrayBuffer) {
         ...
         */
        this.matrix = new three_module_js_1.Matrix3();
    ...
    Volume.prototype = {
        ...
        extractPerpendicularPlane: function (axis, RASIndex) {
            var iLength, jLength, sliceAccess, planeMatrix = (new three_module_js_1.Matrix4()).identity(), volume = this, planeWidth, planeHeight, firstSpacing, secondSpacing, positionOffset, IJKIndex;
            var axisInIJK = new three_module_js_1.Vector3(), firstDirection = new three_module_js_1.Vector3(), secondDirection = new three_module_js_1.Vector3();
            var dimensions = new three_module_js_1.Vector3(this.xLength, this.yLength, this.zLength);
            switch (axis) {
                case 'x':
                    axisInIJK.set(1, 0, 0);
                    ...
                    IJKIndex = new three_module_js_1.Vector3(RASIndex, 0, 0);
                    planeMatrix.multiply((new three_module_js_1.Matrix4()).makeRotationY(Math.PI / 2));
                    positionOffset = (volume.RASDimensions[0] - 1) / 2;
                    planeMatrix.setPosition(new three_module_js_1.Vector3(RASIndex - positionOffset, 0, 0));
                    break;
                case 'y':
                    axisInIJK.set(0, 1, 0);
                    ...
                    IJKIndex = new three_module_js_1.Vector3(0, RASIndex, 0);
                    planeMatrix.multiply((new three_module_js_1.Matrix4()).makeRotationX(-Math.PI / 2));
                    positionOffset = (volume.RASDimensions[1] - 1) / 2;
                    planeMatrix.setPosition(new three_module_js_1.Vector3(0, RASIndex - positionOffset, 0));
                    break;
                case 'z':
                default:
                    axisInIJK.set(0, 0, 1);
                    ...
                    firstSpacing = this.spacing[0];
                    secondSpacing = this.spacing[1];
                    IJKIndex = new three_module_js_1.Vector3(0, 0, RASIndex);
                    positionOffset = (volume.RASDimensions[2] - 1) / 2;
                    planeMatrix.setPosition(new three_module_js_1.Vector3(0, 0, RASIndex - positionOffset));
                    break;
            }
            ...
            var base = [new three_module_js_1.Vector3(1, 0, 0), new three_module_js_1.Vector3(0, 1, 0), new three_module_js_1.Vector3(0, 0, 1)];
        ...
        extractSlice: function (axis, index) {
            var slice = new VolumeSlice_js_1.VolumeSlice(this, index, axis);
