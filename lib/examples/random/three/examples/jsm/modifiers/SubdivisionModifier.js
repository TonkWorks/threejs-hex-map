define(["require", "exports", "../../../build/three.module.js"], function (require, exports, three_module_js_1) {
    ...
    (function () {
        ...
        function newFace(newFaces, a, b, c, materialIndex) {
            newFaces.push(new three_module_js_1.Face3(a, b, c, undefined, undefined, materialIndex));
        }
        ...
        SubdivisionModifier.prototype.smooth = function (geometry) {
            var tmp = new three_module_js_1.Vector3();
            ...
            for (i in sourceEdges) {
                ...
                newEdge = new three_module_js_1.Vector3();
            ...
            newFaces = [];
            var uv, x0, x1, x2;
            var x3 = new three_module_js_1.Vector2();
            var x4 = new three_module_js_1.Vector2();
            var x5 = new three_module_js_1.Vector2();
