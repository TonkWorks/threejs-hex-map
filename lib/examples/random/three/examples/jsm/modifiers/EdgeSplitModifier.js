define(["require", "exports", "../../../build/three.module.js", "../utils/BufferGeometryUtils.js"], function (require, exports, three_module_js_1, BufferGeometryUtils_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function EdgeSplitModifier() {
        const A = new three_module_js_1.Vector3();
        const B = new three_module_js_1.Vector3();
        const C = new three_module_js_1.Vector3();
        ...
        this.modify = function (geometry, cutOffAngle) {
            if (!geometry.isBufferGeometry) {
                geometry = new three_module_js_1.BufferGeometry().fromGeometry(geometry);
            }
            if (geometry.index == null)
                geometry = BufferGeometryUtils_js_1.BufferGeometryUtils.mergeVertices(geometry);
            ...
            geometry = new three_module_js_1.BufferGeometry();
            geometry.setAttribute('position', new three_module_js_1.BufferAttribute(newPositions, 3, true));
            geometry.setIndex(new three_module_js_1.BufferAttribute(newIndexes, 1));
            return geometry;
        };
    }
