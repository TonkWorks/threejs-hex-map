define(["require", "exports", "../core/Curve.js", "../core/Interpolations.js", "../../math/Vector2.js"], function (require, exports, Curve_js_1, Interpolations_js_1, Vector2_js_1) {
    ...
    QuadraticBezierCurve.prototype = Object.create(Curve_js_1.Curve.prototype);
    QuadraticBezierCurve.prototype.constructor = QuadraticBezierCurve;
    QuadraticBezierCurve.prototype.isQuadraticBezierCurve = true;
    QuadraticBezierCurve.prototype.getPoint = function (t, optionalTarget) {
        const point = optionalTarget || new Vector2_js_1.Vector2();
        const v0 = this.v0, v1 = this.v1, v2 = this.v2;
        point.set(Interpolations_js_1.QuadraticBezier(t, v0.x, v1.x, v2.x), Interpolations_js_1.QuadraticBezier(t, v0.y, v1.y, v2.y));
        return point;
    };
