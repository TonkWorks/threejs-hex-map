...
define(["require", "exports", "../math/Color.js", "../math/Vector2.js", "../math/Vector3.js", "../math/Vector4.js", "../math/Matrix3.js", "../math/Matrix4.js", "./FileLoader.js", "./Loader.js", "../materials/Materials.js"], function (require, exports, Color_js_1, Vector2_js_1, Vector3_js_1, Vector4_js_1, Matrix3_js_1, Matrix4_js_1, FileLoader_js_1, Loader_js_1, Materials) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Materials = __importStar(Materials);
    function MaterialLoader(manager) {
        Loader_js_1.Loader.call(this, manager);
        this.textures = {};
    }
    exports.MaterialLoader = MaterialLoader;
    MaterialLoader.prototype = Object.assign(Object.create(Loader_js_1.Loader.prototype), {
        ...
        parse: function (json) {
            ...
            if (json.sheen !== undefined)
                material.sheen = new Color_js_1.Color().setHex(json.sheen);
                ...
                for (const name in json.uniforms) {
                    ...
                    switch (uniform.type) {
                        case 't':
                            ...
                            break;
                        case 'c':
                            material.uniforms[name].value = new Color_js_1.Color().setHex(uniform.value);
                            break;
                        case 'v2':
                            material.uniforms[name].value = new Vector2_js_1.Vector2().fromArray(uniform.value);
                            break;
                        case 'v3':
                            material.uniforms[name].value = new Vector3_js_1.Vector3().fromArray(uniform.value);
                            break;
                        case 'v4':
                            material.uniforms[name].value = new Vector4_js_1.Vector4().fromArray(uniform.value);
                            break;
                        case 'm3':
                            material.uniforms[name].value = new Matrix3_js_1.Matrix3().fromArray(uniform.value);
                            break;
                        case 'm4':
                            material.uniforms[name].value = new Matrix4_js_1.Matrix4().fromArray(uniform.value);
                            break;
                        default:
            ...
            if (json.normalScale !== undefined) {
                ...
                material.normalScale = new Vector2_js_1.Vector2().fromArray(normalScale);
            }
            ...
            if (json.clearcoatNormalScale !== undefined)
                material.clearcoatNormalScale = new Vector2_js_1.Vector2().fromArray(json.clearcoatNormalScale);
