define(["require", "exports", "./util", "../../src/MapView", "../../src/Units"], function (require, exports, util_1, MapView_1, Units_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.initInput = initInput;
    function initInput(mapView) {
        const keyActions = {
            [util_1.KEY_CODES.ESC]: {
                up: () => (0, MapView_1.CloseMenu)()
            },
            ...
            [util_1.KEY_CODES.A]: {
                down: () => {
                    ...
                    const unit = (0, Units_1.CreateRifleman)(player);
            ...
            [util_1.KEY_CODES.Z]: {
                down: () => {
                    const player = mapView.getPlayer("USA");
                    const improvement = (0, Units_1.CreateCity)(player);
                    const tile = mapView.selectedTile;
